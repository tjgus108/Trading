...
| E (실행) | ✅ | PaperTrader KellySizer 통합 + Tiered Slippage(BTC 0.05%, mid 0.2%, small 1.0%) |
| SIM | ✅ | 66개 모두 FAIL, value_area ETH Sharpe 0.92 최근접 |
| F (리서치) | ✅ | ML봇 프로덕션 배포 사례, 파라미터 5개↑ 과적합, ADWIN 재학습 트리거 |
