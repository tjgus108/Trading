...
_Last updated: 2026-04-20 (Cycle 163)_
...
- **테스트**: 7,300+ passed (risk 93+5, feed 93, exchange 98, trainer 49, FR/OI 24+25, kelly 77, feature_builder 29 포함)
...
| 카테고리 | 상태 | 주요 변경 |
|---------|------|----------|
| E (실행) | ✅ | max_loss_pct 50% 자동 중단 구현, min_accuracy 0.55 상향, 37 PASS |
| A (품질) | ✅ | FeatureBuilder 테스트 29개 추가, 7,057 PASS |
| F (리서치) | ✅ | ML 드리프트 대응 (PSI, 다시간 앙상블), 소자본 운영 현실 |
...
- 다음 우선: XGBoost 다시간 앙상블, PSI 드리프트 모니터, live 7일 테스트, 수수료 현실화
