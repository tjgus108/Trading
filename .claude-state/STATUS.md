...
_Last updated: 2026-05-26 (Cycle 210)_
...
| 카테고리 | 상태 | 주요 변경 |
|---------|------|----------|
| D (ML) | ✅ | WFE+fold_pass_rate+is_robust 속성, 파라미터 5개↑ WARNING |
| E (실행) | ✅ | PaperTrader 3모듈 통합 E2E 11t + PerformanceTracker 일간 리포트 |
| SIM | ✅ | seed 다양화 확인(3심볼 분화), 0/22 PASS, cmf/PAM 실데이터 검증 대상 |
| F (리서치) | ✅ | fold당 30+ trades 필요, 4h→1h 이동 권장, WFE>0.7 실데이터만 |
