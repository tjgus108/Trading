...
_Last updated: 2026-05-28 (Cycle 229)_
...
| 카테고리 | 상태 | 주요 변경 |
|---------|------|----------|
| C (데이터) | ✅ | get_order_book_depth() + WebSocket 동적 타임아웃 + validate_timeout |
| B (리스크) | ✅ | paper_simulation --mc-p-threshold 옵션 추가, VaR 소표본 임계값 적절 확인 |
