...
_Generated: 2026-06-13T05:10:11.232458Z_
...
_Generated: 2026-06-13T05:11:33.174835Z_
_Symbol: BTC/USDT_
...
|---|------|-----------|-----------|-------|-------|-----------|--------|-------------|------|
| 1 | `price_cluster` | +7.81% | 3.76 | 52.1% | 2.07 | 13 | 4.6% | 2/8 | FAIL |
...
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `price_cluster` | 73.8 | p100 | 3.76 | 2.46 | 2.07 | 13 | 4.6% | 2/8 | FAIL |
| 2 | `momentum_quality` | 62.5 | p95 | 1.48 | 3.81 | 1.33 | 22 | 5.1% | 1/8 | FAIL |
| 3 | `cmf` | 55.9 | p90 | 0.59 | 3.08 | 1.16 | 23 | 6.9% | 1/8 | FAIL |
| 4 | `relative_volume` | 52.0 | p85 | 0.97 | 3.66 | 1.35 | 18 | 4.8% | 0/8 | FAIL |
| 5 | `lob_maker` | 51.5 | p80 | 0.50 | 3.60 | 1.23 | 21 | 7.6% | 1/8 | FAIL |
| 6 | `linear_channel_rev` | 45.8 | p76 | 1.23 | 3.30 | 2.01 | 6 | 2.3% | 0/8 | FAIL |
| 7 | `supertrend_multi` | 43.8 | p71 | 1.84 | 2.92 | 1.14 | 8 | 2.7% | 1/8 | FAIL |
| 8 | `order_flow_imbalance_v2` | 43.7 | p66 | -1.25 | 6.24 | 1.16 | 19 | 7.6% | 3/8 | FAIL |
| 9 | `value_area` | 42.9 | p61 | -0.50 | 3.63 | 1.10 | 16 | 5.2% | 1/8 | FAIL |
| 10 | `price_action_momentum` | 39.2 | p57 | -1.66 | 5.42 | 0.98 | 24 | 7.7% | 1/8 | FAIL |
| 11 | `htf_ema` | 38.4 | p52 | -0.60 | 4.36 | 1.55 | 11 | 5.0% | 0/8 | FAIL |
| 12 | `positional_scaling` | 34.9 | p47 | -1.15 | 5.73 | 1.67 | 10 | 4.5% | 0/8 | FAIL |
| 13 | `volatility_cluster` | 32.8 | p42 | -1.21 | 5.37 | 1.14 | 14 | 5.5% | 0/8 | FAIL |
| 14 | `elder_impulse` | 32.7 | p38 | -1.56 | 6.42 | 1.48 | 14 | 6.5% | 0/8 | FAIL |
| 15 | `volume_breakout` | 29.6 | p33 | -2.40 | 5.40 | 0.91 | 18 | 7.7% | 1/8 | FAIL |

## 전체 결과

| Name | AvgReturn | AvgSharpe | AvgPF | AvgTrades | Consistency | Pass |
|------|-----------|-----------|-------|-----------|-------------|------|
| `price_cluster` | +7.81% | 3.76 | 2.07 | 13 | 2/8 | FAIL |
...
|----------|-----------------------------------|
| `price_cluster` | trades 12 < 15 (x2), trades 13 < 15 (x2), trades 10 < 15 (x1) |
...
- **전체 22개 균등배분**: -0.12% -> $9,988
- **Top 5 균등배분**: +3.87% -> $10,387
...
_Generated: 2026-06-13T05:12:51.593939Z_
_Symbol: ETH/USDT_
...
| 9 | `price_cluster` | -3.10% | -3.23 | 24.2% | 0.62 | 7 | 5.2% | 0/8 | FAIL |
...
| `price_cluster` | -3.10% | -3.23 | 0.62 | 7 | 0/8 | FAIL |
...
| `price_cluster` | trades 6 < 15 (x2), trades 5 < 15 (x2), trades 7 < 15 (x2) |
...
_Generated: 2026-06-13T05:14:10.047714Z_
_Symbol: SOL/USDT_
...
| 9 | `price_cluster` | -2.81% | -3.62 | 23.3% | 0.62 | 6 | 4.7% | 0/8 | FAIL |
...
| `price_cluster` | -2.81% | -3.62 | 0.62 | 6 | 0/8 | FAIL |
...
| `price_cluster` | trades 9 < 15 (x3), profit_factor 0.00 < 1.5 (x2), sharpe -1.74 < 1.0 (x1) |
...
| trades 5 < 15 | 7 |
| trades 8 < 15 | 7 |
| profit_factor 0.00 < 1.5 | 7 |
| trades 10 < 15 | 7 |
| profit_factor 0.52 < 1.5 | 6 |

## 포트폴리오 가상 배분

- **전체 22개 균등배분**: -3.85% -> $9,615
