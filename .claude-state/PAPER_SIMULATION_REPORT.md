...
_Generated: 2026-06-18T15:15:15.041214Z_
...
_Generated: 2026-06-18T15:19:44.617115Z_
_Symbol: BTC/USDT_
...
| 3 | `frama` | -0.92% | -0.22 | 38.9% | 1.02 | 42 | 9.8% | 0/8 | FAIL |
| 4 | `roc_ma_cross` | -1.10% | -0.69 | 36.8% | 1.11 | 33 | 9.6% | 1/8 | FAIL |
...
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `price_cluster` | 74.7 | p100 | 0.34 | 1.42 | 1.11 | 45 | 11.7% | 1/8 | FAIL |
| 2 | `positional_scaling` | 68.6 | p94 | 0.00 | 2.87 | 1.18 | 36 | 9.7% | 1/8 | FAIL |
| 3 | `price_action_momentum` | 64.6 | p89 | -0.88 | 3.03 | 1.01 | 82 | 17.8% | 1/8 | FAIL |
| 4 | `acceleration_band` | 62.3 | p84 | -0.63 | 2.20 | 1.00 | 45 | 12.8% | 1/8 | FAIL |
| 5 | `volume_breakout` | 61.6 | p78 | -0.44 | 2.41 | 1.01 | 78 | 15.8% | 0/8 | FAIL |
| 6 | `roc_ma_cross` | 59.8 | p73 | -0.69 | 3.19 | 1.11 | 33 | 9.6% | 1/8 | FAIL |
| 7 | `frama` | 58.0 | p68 | -0.22 | 1.40 | 1.02 | 42 | 9.8% | 0/8 | FAIL |
| 8 | `narrow_range` | 57.9 | p63 | -0.42 | 1.39 | 0.99 | 50 | 11.6% | 0/8 | FAIL |
| 9 | `htf_ema` | 57.1 | p52 | -0.35 | 1.14 | 0.98 | 45 | 11.4% | 0/8 | FAIL |
| 10 | `momentum_quality` | 57.1 | p57 | -1.31 | 3.52 | 0.96 | 77 | 18.1% | 1/8 | FAIL |
| 11 | `order_flow_imbalance_v2` | 56.7 | p47 | -0.83 | 2.13 | 0.95 | 73 | 15.8% | 0/8 | FAIL |
| 12 | `lob_maker` | 56.3 | p42 | -0.91 | 1.91 | 0.94 | 84 | 19.7% | 0/8 | FAIL |
...
| `roc_ma_cross` | -1.10% | -0.69 | 1.11 | 33 | 1/8 | FAIL |
...
| `roc_ma_cross` | profit_factor 1.26 < 1.5 (x1), mc_p_value 0.291 > 0.1 (우연 가능성) (x1), sharpe -5.09 < 1.0 (x1) |
...
| mc_p_value 0.998 > 0.1 (우연 가능성) | 4 |
| mc_p_value 0.990 > 0.1 (우연 가능성) | 4 |
...
_Generated: 2026-06-18T15:24:22.341131Z_
_Symbol: ETH/USDT_
...
| 7 | `roc_ma_cross` | -3.19% | -0.91 | 38.9% | 0.89 | 27 | 8.2% | 0/8 | FAIL |
| 8 | `cmf` | -3.48% | -0.94 | 37.4% | 0.94 | 56 | 15.2% | 1/8 | FAIL |
| 9 | `engulfing_zone` | -3.80% | -1.84 | 36.8% | 0.90 | 27 | 11.3% | 1/8 | FAIL |
| 10 | `linear_channel_rev` | -3.99% | -1.25 | 36.0% | 0.78 | 28 | 7.1% | 0/8 | FAIL |
...
| 7 | `roc_ma_cross` | 37.5 | p68 | -0.91 | 1.40 | 0.89 | 27 | 8.2% | 0/8 | FAIL |
...
| `roc_ma_cross` | -3.19% | -0.91 | 0.89 | 27 | 0/8 | FAIL |
...
| `roc_ma_cross` | profit_factor 0.79 < 1.5 (x2), sharpe -1.39 < 1.0 (x1), profit_factor 0.74 < 1.5 (x1) |
...
| `roc_ma_cross` | 0 | 88 | 128 | 59.3% |
| `positional_scaling` | 0 | 121 | 176 | 59.3% |

## 포트폴리오 가상 배분

- **전체 20개 균등배분**: -5.32% -> $9,468
...
_Generated: 2026-06-18T15:28:41.730535Z_
_Symbol: SOL/USDT_
...
| 9 | `roc_ma_cross` | -2.50% | -0.89 | 38.5% | 0.89 | 26 | 6.8% | 0/8 | FAIL |
...
| 8 | `acceleration_band` | 46.6 | p63 | -0.44 | 1.91 | 1.22 | 7 | 3.8% | 0/8 | FAIL |
| 9 | `relative_volume` | 45.7 | p57 | -2.06 | 1.19 | 0.76 | 73 | 16.5% | 0/8 | FAIL |
| 10 | `volume_breakout` | 44.9 | p52 | -1.41 | 2.47 | 0.86 | 58 | 15.2% | 0/8 | FAIL |
| 11 | `roc_ma_cross` | 44.7 | p47 | -0.89 | 1.87 | 0.89 | 26 | 6.8% | 0/8 | FAIL |
...
| `roc_ma_cross` | -2.50% | -0.89 | 0.89 | 26 | 0/8 | FAIL |
...
| `roc_ma_cross` | sharpe -3.57 < 1.0 (x1), profit_factor 0.46 < 1.5 (x1), mc_p_value 0.961 > 0.1 (우연 가능성) (x1) |
