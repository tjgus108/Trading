...
_Generated: 2026-07-02T15:21:51.973105Z_
...
_Generated: 2026-07-02T15:25:46.231608Z_
_Symbol: BTC/USDT_
...
|---|------|-----------|-----------|-------|-------|-----------|--------|-------------|------|
| 1 | `price_cluster` | +6.86% | 1.21 | 38.5% | 1.27 | 38 | 7.5% | 1/8 | FAIL |
...
| 2 | `price_cluster` | 53.5 | p94 | 1.21 | 0.92 | 1.27 | 38 | 7.5% | 1/8 | FAIL |
...
|------|-----------|-----------|-------|-----------|-------------|------|
| `price_cluster` | +6.86% | 1.21 | 1.27 | 38 | 1/8 | FAIL |
...
|----------|-----------------------------------|
| `price_cluster` | profit_factor 1.21 < 1.5 (x2), sharpe -0.39 < 1.0 (x1), profit_factor 0.95 < 1.5 (x1) |
...
_Generated: 2026-07-02T15:29:24.026222Z_
_Symbol: ETH/USDT_
...
| 3 | `price_cluster` | +2.07% | 0.14 | 39.5% | 1.26 | 29 | 8.8% | 1/8 | FAIL |
...
| Rank | Name | Score | Pctl | AvgSharpe | SharpeStd | AvgPF | AvgTrades | AvgMDD | Consist | Pass |
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `engulfing_zone` | 68.4 | p100 | 0.44 | 2.56 | 1.30 | 24 | 7.0% | 2/8 | FAIL |
| 2 | `frama` | 67.2 | p94 | 0.51 | 1.55 | 1.18 | 33 | 8.4% | 1/8 | FAIL |
| 3 | `price_cluster` | 61.7 | p88 | 0.14 | 2.64 | 1.26 | 29 | 8.8% | 1/8 | FAIL |
| 4 | `volume_breakout` | 56.5 | p83 | -0.87 | 1.49 | 0.91 | 61 | 12.5% | 0/8 | FAIL |
| 5 | `lob_maker` | 49.3 | p77 | -0.90 | 1.82 | 0.92 | 58 | 15.6% | 0/8 | FAIL |
| 6 | `cmf` | 47.1 | p72 | -1.14 | 1.40 | 0.85 | 46 | 11.8% | 0/8 | FAIL |
| 7 | `order_flow_imbalance_v2` | 45.9 | p66 | -1.02 | 2.50 | 0.94 | 55 | 14.5% | 0/8 | FAIL |
| 8 | `volatility_cluster` | 44.0 | p61 | -1.49 | 1.44 | 0.81 | 42 | 9.4% | 0/8 | FAIL |
...
| `price_cluster` | +2.07% | 0.14 | 1.26 | 29 | 1/8 | FAIL |
...
| `price_cluster` | sharpe -0.46 < 1.0 (x1), profit_factor 0.92 < 1.5 (x1), mc_p_value 0.595 > 0.1 (우연 가능성) (x1) |
...
- **전체 19개 균등배분**: -5.17% -> $9,483
- **Top 5 균등배분**: +0.56% -> $10,056
...
_Generated: 2026-07-02T15:32:48.232875Z_
_Symbol: SOL/USDT_
...
| `price_cluster` | -7.15% | -1.98 | 0.69 | 28 | 0/8 | FAIL |
...
| `price_cluster` | sharpe -4.79 < 1.0 (x1), profit_factor 0.38 < 1.5 (x1), mc_p_value 0.994 > 0.1 (우연 가능성) (x1) |
