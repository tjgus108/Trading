...
_Generated: 2026-06-20T15:11:42.433335Z_
...
_Generated: 2026-06-20T15:18:21.584243Z_
_Symbol: BTC/USDT_
...
| 6 | `order_flow_imbalance_v2` | -1.60% | -0.64 | 37.5% | 1.04 | 70 | 16.6% | 1/8 | FAIL |
...
| 5 | `order_flow_imbalance_v2` | 60.1 | p78 | -0.64 | 3.18 | 1.04 | 70 | 16.6% | 1/8 | FAIL |
| 6 | `price_action_momentum` | 59.6 | p73 | -0.88 | 3.03 | 1.01 | 82 | 17.8% | 1/8 | FAIL |
| 7 | `frama` | 58.0 | p68 | -0.22 | 1.40 | 1.02 | 42 | 9.8% | 0/8 | FAIL |
| 8 | `narrow_range` | 57.9 | p63 | -0.42 | 1.39 | 0.99 | 50 | 11.6% | 0/8 | FAIL |
| 9 | `acceleration_band` | 57.3 | p57 | -0.63 | 2.20 | 1.00 | 45 | 12.8% | 1/8 | FAIL |
| 10 | `htf_ema` | 57.1 | p52 | -0.35 | 1.14 | 0.98 | 45 | 11.4% | 0/8 | FAIL |
...
| `order_flow_imbalance_v2` | -1.60% | -0.64 | 1.04 | 70 | 1/8 | FAIL |
...
| `order_flow_imbalance_v2` | profit_factor 1.30 < 1.5 (x1), mc_p_value 0.159 > 0.1 (우연 가능성) (x1), sharpe 0.13 < 1.0 (x1) |
...
_Generated: 2026-06-20T15:25:05.608290Z_
_Symbol: ETH/USDT_
...
| Rank | Name | Score | Pctl | AvgSharpe | SharpeStd | AvgPF | AvgTrades | AvgMDD | Consist | Pass |
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `momentum_quality` | 56.6 | p100 | -0.45 | 1.19 | 0.97 | 73 | 12.3% | 0/8 | FAIL |
| 2 | `volatility_cluster` | 56.5 | p94 | 0.12 | 1.37 | 1.07 | 51 | 9.1% | 0/8 | FAIL |
| 3 | `dema_cross` | 55.6 | p89 | 0.73 | 2.06 | 1.67 | 14 | 3.5% | 0/8 | FAIL |
| 4 | `narrow_range` | 55.4 | p84 | 0.06 | 1.46 | 1.06 | 51 | 9.9% | 0/8 | FAIL |
| 5 | `price_action_momentum` | 53.0 | p78 | -0.08 | 1.42 | 1.03 | 51 | 11.3% | 0/8 | FAIL |
| 6 | `cmf` | 51.9 | p73 | -0.94 | 2.43 | 0.94 | 56 | 15.2% | 1/8 | FAIL |
| 7 | `roc_ma_cross` | 37.4 | p68 | -1.07 | 0.82 | 0.83 | 35 | 9.6% | 0/8 | FAIL |
| 8 | `engulfing_zone` | 35.2 | p63 | -1.84 | 3.67 | 0.90 | 27 | 11.3% | 1/8 | FAIL |
| 9 | `relative_volume` | 34.8 | p57 | -2.01 | 2.34 | 0.81 | 70 | 15.6% | 0/8 | FAIL |
| 10 | `elder_impulse` | 34.6 | p52 | -1.52 | 1.81 | 0.81 | 46 | 12.5% | 0/8 | FAIL |
| 11 | `lob_maker` | 34.4 | p47 | -1.92 | 1.43 | 0.79 | 70 | 20.8% | 0/8 | FAIL |
| 12 | `linear_channel_rev` | 33.0 | p42 | -1.25 | 0.72 | 0.78 | 28 | 7.1% | 0/8 | FAIL |
| 13 | `htf_ema` | 31.2 | p36 | -1.43 | 1.68 | 0.78 | 31 | 9.8% | 0/8 | FAIL |
| 14 | `price_cluster` | 29.9 | p31 | -1.43 | 1.92 | 0.81 | 28 | 10.7% | 0/8 | FAIL |
| 15 | `order_flow_imbalance_v2` | 28.2 | p26 | -2.40 | 1.90 | 0.74 | 68 | 20.0% | 0/8 | FAIL |
...
| `order_flow_imbalance_v2` | -13.38% | -2.40 | 0.74 | 68 | 0/8 | FAIL |
...
| `order_flow_imbalance_v2` | sharpe -1.34 < 1.0 (x1), profit_factor 0.82 < 1.5 (x1), mc_p_value 0.779 > 0.1 (우연 가능성) (x1) |
...
| `order_flow_imbalance_v2` | 0 | 219 | 325 | 59.7% |
| `positional_scaling` | 0 | 121 | 176 | 59.3% |

## 포트폴리오 가상 배분

- **전체 20개 균등배분**: -5.24% -> $9,476
...
_Generated: 2026-06-20T15:31:21.448370Z_
_Symbol: SOL/USDT_
...
| 2 | `order_flow_imbalance_v2` | +1.31% | 0.01 | 37.5% | 1.04 | 69 | 12.6% | 0/8 | FAIL |
...
| Rank | Name | Score | Pctl | AvgSharpe | SharpeStd | AvgPF | AvgTrades | AvgMDD | Consist | Pass |
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `price_action_momentum` | 66.7 | p100 | -0.36 | 2.50 | 1.05 | 48 | 9.3% | 1/8 | FAIL |
| 2 | `elder_impulse` | 66.5 | p94 | 0.34 | 0.86 | 1.07 | 47 | 8.6% | 0/8 | FAIL |
| 3 | `order_flow_imbalance_v2` | 64.6 | p89 | 0.01 | 2.16 | 1.04 | 69 | 12.6% | 0/8 | FAIL |
...
| `order_flow_imbalance_v2` | +1.31% | 0.01 | 1.04 | 69 | 0/8 | FAIL |
...
| `order_flow_imbalance_v2` | sharpe -3.93 < 1.0 (x1), profit_factor 0.57 < 1.5 (x1), mc_p_value 0.965 > 0.1 (우연 가능성) (x1) |
...
- **전체 20개 균등배분**: -4.30% -> $9,570
- **Top 5 균등배분**: +0.79% -> $10,079
