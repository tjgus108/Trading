...
_Generated: 2026-07-06T00:17:48.071578Z_
...
_Generated: 2026-07-06T00:21:50.300049Z_
_Symbol: BTC/USDT_
...
| 4 | `frama` | +2.30% | 0.44 | 34.5% | 1.11 | 65 | 9.5% | 0/8 | FAIL |
...
| 2 | `frama` | 54.2 | p94 | 0.44 | 1.23 | 1.11 | 65 | 9.5% | 0/8 | FAIL |
| 3 | `price_cluster` | 52.5 | p88 | 1.06 | 1.67 | 1.32 | 35 | 7.7% | 2/8 | FAIL |
| 4 | `dema_cross` | 48.2 | p83 | 0.85 | 1.85 | 1.38 | 26 | 6.1% | 2/8 | FAIL |
| 5 | `lob_maker` | 43.6 | p77 | -0.04 | 1.99 | 1.05 | 75 | 17.0% | 0/8 | FAIL |
...
| `frama` | +2.30% | 0.44 | 1.11 | 65 | 0/8 | FAIL |
...
| `frama` | profit_factor 1.00 < 1.5 (x2), sharpe -1.01 < 1.0 (x1), profit_factor 0.89 < 1.5 (x1) |
...
- **전체 19개 균등배분**: -2.30% -> $9,770
- **PASS 1개 균등배분**: +6.54% -> $10,654
- **Top 5 균등배분**: +3.69% -> $10,369
...
_Generated: 2026-07-06T00:25:36.201096Z_
_Symbol: ETH/USDT_
...
| 2 | `frama` | +2.39% | 0.37 | 38.4% | 1.13 | 48 | 8.7% | 1/8 | FAIL |
...
| Rank | Name | Score | Pctl | AvgSharpe | SharpeStd | AvgPF | AvgTrades | AvgMDD | Consist | Pass |
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `frama` | 72.2 | p100 | 0.37 | 1.77 | 1.13 | 48 | 8.7% | 1/8 | FAIL |
| 2 | `engulfing_zone` | 68.7 | p94 | 0.44 | 2.56 | 1.30 | 24 | 7.0% | 2/8 | FAIL |
| 3 | `volume_breakout` | 56.6 | p88 | -0.87 | 1.49 | 0.91 | 61 | 12.5% | 0/8 | FAIL |
| 4 | `price_cluster` | 49.7 | p83 | -0.70 | 2.34 | 1.02 | 28 | 9.8% | 1/8 | FAIL |
| 5 | `lob_maker` | 49.4 | p77 | -0.90 | 1.82 | 0.92 | 58 | 15.6% | 0/8 | FAIL |
| 6 | `cmf` | 47.4 | p72 | -1.14 | 1.40 | 0.85 | 46 | 11.8% | 0/8 | FAIL |
| 7 | `order_flow_imbalance_v2` | 45.8 | p66 | -1.02 | 2.50 | 0.94 | 55 | 14.5% | 0/8 | FAIL |
| 8 | `volatility_cluster` | 44.2 | p61 | -1.49 | 1.44 | 0.81 | 42 | 9.4% | 0/8 | FAIL |
| 9 | `relative_volume` | 43.3 | p55 | -1.53 | 2.34 | 0.87 | 54 | 12.7% | 0/8 | FAIL |
| 10 | `elder_impulse` | 40.2 | p50 | -1.60 | 0.86 | 0.76 | 36 | 10.7% | 0/8 | FAIL |
| 11 | `momentum_quality` | 39.6 | p44 | -2.48 | 0.88 | 0.71 | 58 | 14.5% | 0/8 | FAIL |
| 12 | `price_action_momentum` | 35.3 | p38 | -2.32 | 1.51 | 0.71 | 48 | 12.6% | 0/8 | FAIL |
| 13 | `roc_ma_cross` | 34.7 | p33 | -0.79 | 1.51 | 0.90 | 9 | 4.1% | 0/8 | FAIL |
...
| `frama` | +2.39% | 0.37 | 1.13 | 48 | 1/8 | FAIL |
...
| `frama` | sharpe -0.23 < 1.0 (x1), profit_factor 0.97 < 1.5 (x1), mc_p_value 0.535 > 0.1 (우연 가능성) (x1) |
...
_Generated: 2026-07-06T00:29:18.478483Z_
_Symbol: SOL/USDT_
...
| 최저 수익률 | -8.09% (price_action_momentum) |
...
| 7 | `frama` | -4.17% | -0.82 | 35.1% | 0.89 | 52 | 11.1% | 0/8 | FAIL |
...
| 4 | `frama` | 48.1 | p83 | -0.82 | 0.99 | 0.89 | 52 | 11.1% | 0/8 | FAIL |
| 5 | `relative_volume` | 47.8 | p77 | -0.61 | 2.05 | 0.97 | 50 | 10.7% | 0/8 | FAIL |
| 6 | `momentum_quality` | 46.7 | p72 | -1.18 | 0.96 | 0.85 | 56 | 10.5% | 0/8 | FAIL |
| 7 | `order_flow_imbalance_v2` | 44.0 | p66 | -1.22 | 0.78 | 0.84 | 55 | 12.0% | 0/8 | FAIL |
| 8 | `cmf` | 38.4 | p61 | -1.28 | 0.94 | 0.82 | 44 | 10.3% | 0/8 | FAIL |
| 9 | `volume_breakout` | 37.5 | p55 | -1.45 | 1.33 | 0.82 | 58 | 14.2% | 0/8 | FAIL |
| 10 | `positional_scaling` | 32.6 | p50 | -1.12 | 2.17 | 0.87 | 32 | 8.8% | 0/8 | FAIL |
| 11 | `elder_impulse` | 30.8 | p44 | -1.91 | 3.14 | 0.82 | 36 | 11.6% | 1/8 | FAIL |
| 12 | `price_action_momentum` | 30.0 | p38 | -1.88 | 0.97 | 0.75 | 47 | 12.3% | 0/8 | FAIL |
| 13 | `acceleration_band` | 29.6 | p33 | -0.80 | 1.82 | 1.00 | 11 | 4.7% | 0/8 | FAIL |
| 14 | `htf_ema` | 27.0 | p27 | -1.45 | 1.94 | 0.80 | 30 | 9.0% | 0/8 | FAIL |
| 15 | `roc_ma_cross` | 24.1 | p22 | -0.94 | 1.65 | 0.85 | 11 | 5.2% | 0/8 | FAIL |
...
| `frama` | -4.17% | -0.82 | 0.89 | 52 | 0/8 | FAIL |
...
| `frama` | profit_factor 0.93 < 1.5 (x2), sharpe -1.79 < 1.0 (x1), profit_factor 0.76 < 1.5 (x1) |
