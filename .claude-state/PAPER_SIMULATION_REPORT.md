...
_Generated: 2026-06-26T10:38:41.303171Z_
...
_Generated: 2026-06-26T10:42:41.909952Z_
_Symbol: BTC/USDT_
...
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `dema_cross` | 74.0 | p100 | 0.47 | 2.69 | 1.23 | 48 | 9.7% | 2/8 | FAIL |
| 2 | `price_cluster` | 71.2 | p94 | 0.87 | 1.10 | 1.20 | 41 | 9.8% | 1/8 | FAIL |
| 3 | `frama` | 62.0 | p88 | 0.24 | 1.60 | 1.12 | 40 | 9.4% | 1/8 | FAIL |
| 4 | `lob_maker` | 56.3 | p83 | -0.04 | 1.99 | 1.05 | 75 | 17.0% | 0/8 | FAIL |
| 5 | `positional_scaling` | 49.9 | p77 | -0.38 | 2.82 | 1.09 | 34 | 9.2% | 1/8 | FAIL |
| 6 | `volume_breakout` | 48.4 | p72 | -0.74 | 2.18 | 0.96 | 72 | 15.4% | 0/8 | FAIL |
| 7 | `narrow_range` | 48.0 | p66 | -0.51 | 1.48 | 0.97 | 46 | 10.1% | 0/8 | FAIL |
| 8 | `order_flow_imbalance_v2` | 47.0 | p61 | -0.77 | 2.05 | 0.95 | 67 | 15.0% | 0/8 | FAIL |
| 9 | `relative_volume` | 47.0 | p55 | -0.99 | 1.72 | 0.92 | 64 | 13.2% | 0/8 | FAIL |
| 10 | `price_action_momentum` | 46.6 | p50 | -1.08 | 2.79 | 0.97 | 73 | 16.7% | 1/8 | FAIL |
| 11 | `momentum_quality` | 44.2 | p44 | -1.19 | 3.29 | 0.96 | 71 | 15.8% | 1/8 | FAIL |
| 12 | `htf_ema` | 43.1 | p38 | -0.72 | 0.71 | 0.91 | 43 | 11.2% | 0/8 | FAIL |
| 13 | `acceleration_band` | 42.9 | p33 | -0.94 | 2.58 | 0.98 | 44 | 13.0% | 1/8 | FAIL |
| 14 | `cmf` | 41.3 | p27 | -1.23 | 1.29 | 0.88 | 68 | 16.3% | 0/8 | FAIL |
| 15 | `elder_impulse` | 35.4 | p22 | -1.15 | 1.14 | 0.85 | 42 | 11.5% | 0/8 | FAIL |
...
| `roc_ma_cross` | -5.04% | -1.93 | 0.87 | 36 | 1/8 | FAIL |
...
| `roc_ma_cross` | mc_p_value 0.998 > 0.1 (우연 가능성) (x2), mc_p_value 0.110 > 0.1 (우연 가능성) (x1), sharpe -5.57 < 1.0 (x1) |
...
| `roc_ma_cross` | 0 | 282 | 2 | 0.7% |
| `price_action_momentum` | 0 | 582 | 4 | 0.7% |
| `frama` | 0 | 321 | 2 | 0.6% |

## 포트폴리오 가상 배분

- **전체 19개 균등배분**: -3.00% -> $9,700
- **Top 5 균등배분**: +2.10% -> $10,210
...
_Generated: 2026-06-26T10:46:24.297801Z_
_Symbol: ETH/USDT_
...
| 4 | `dema_cross` | -2.95% | -0.89 | 33.2% | 0.91 | 40 | 9.2% | 0/8 | FAIL |
...
| 6 | `dema_cross` | 49.2 | p72 | -0.89 | 1.89 | 0.91 | 40 | 9.2% | 0/8 | FAIL |
| 7 | `cmf` | 47.7 | p66 | -1.14 | 1.40 | 0.85 | 46 | 11.8% | 0/8 | FAIL |
| 8 | `order_flow_imbalance_v2` | 46.8 | p61 | -1.02 | 2.50 | 0.94 | 55 | 14.5% | 0/8 | FAIL |
| 9 | `volatility_cluster` | 44.9 | p55 | -1.49 | 1.44 | 0.81 | 42 | 9.4% | 0/8 | FAIL |
| 10 | `relative_volume` | 44.6 | p50 | -1.53 | 2.34 | 0.87 | 54 | 12.7% | 0/8 | FAIL |
| 11 | `elder_impulse` | 40.1 | p44 | -1.60 | 0.86 | 0.76 | 36 | 10.7% | 0/8 | FAIL |
| 12 | `momentum_quality` | 39.7 | p38 | -2.48 | 0.88 | 0.71 | 58 | 14.5% | 0/8 | FAIL |
| 13 | `price_action_momentum` | 35.9 | p33 | -2.32 | 1.51 | 0.71 | 48 | 12.6% | 0/8 | FAIL |
| 14 | `linear_channel_rev` | 24.3 | p27 | -2.33 | 1.19 | 0.60 | 23 | 7.9% | 0/8 | FAIL |
| 15 | `roc_ma_cross` | 23.0 | p22 | -2.83 | 1.66 | 0.60 | 32 | 10.8% | 0/8 | FAIL |
...
| `dema_cross` | -2.95% | -0.89 | 0.91 | 40 | 0/8 | FAIL |
...
| `roc_ma_cross` | -8.42% | -2.83 | 0.60 | 32 | 0/8 | FAIL |
...
| `dema_cross` | sharpe 0.81 < 1.0 (x1), profit_factor 1.18 < 1.5 (x1), mc_p_value 0.300 > 0.1 (우연 가능성) (x1) |
...
| `roc_ma_cross` | mc_p_value 0.973 > 0.1 (우연 가능성) (x2), sharpe -1.53 < 1.0 (x1), profit_factor 0.75 < 1.5 (x1) |
...
_Generated: 2026-06-26T10:49:55.920560Z_
_Symbol: SOL/USDT_
...
| 2 | `volatility_cluster` | 56.4 | p94 | -0.12 | 1.16 | 1.02 | 41 | 8.7% | 0/8 | FAIL |
| 3 | `lob_maker` | 51.9 | p88 | -0.73 | 0.95 | 0.90 | 56 | 13.0% | 0/8 | FAIL |
| 4 | `relative_volume` | 50.8 | p83 | -0.61 | 2.05 | 0.97 | 50 | 10.7% | 0/8 | FAIL |
| 5 | `momentum_quality` | 50.6 | p77 | -1.18 | 0.96 | 0.85 | 56 | 10.5% | 0/8 | FAIL |
| 6 | `order_flow_imbalance_v2` | 48.1 | p72 | -1.22 | 0.78 | 0.84 | 55 | 12.0% | 0/8 | FAIL |
| 7 | `cmf` | 42.8 | p66 | -1.28 | 0.94 | 0.82 | 44 | 10.3% | 0/8 | FAIL |
| 8 | `volume_breakout` | 42.1 | p61 | -1.45 | 1.33 | 0.82 | 58 | 14.2% | 0/8 | FAIL |
| 9 | `positional_scaling` | 37.0 | p55 | -1.12 | 2.17 | 0.87 | 32 | 8.8% | 0/8 | FAIL |
| 10 | `elder_impulse` | 36.9 | p50 | -1.91 | 3.14 | 0.82 | 36 | 11.6% | 1/8 | FAIL |
| 11 | `price_action_momentum` | 35.7 | p44 | -1.88 | 0.97 | 0.75 | 47 | 12.3% | 0/8 | FAIL |
| 12 | `acceleration_band` | 33.2 | p38 | -0.80 | 1.82 | 1.00 | 11 | 4.7% | 0/8 | FAIL |
| 13 | `htf_ema` | 32.1 | p33 | -1.45 | 1.94 | 0.80 | 30 | 9.0% | 0/8 | FAIL |
| 14 | `frama` | 29.6 | p27 | -1.94 | 1.83 | 0.74 | 42 | 12.6% | 0/8 | FAIL |
| 15 | `dema_cross` | 28.2 | p22 | -2.14 | 1.95 | 0.72 | 40 | 11.0% | 0/8 | FAIL |
...
| `dema_cross` | -6.91% | -2.14 | 0.72 | 40 | 0/8 | FAIL |
...
| `roc_ma_cross` | -9.46% | -3.16 | 0.55 | 33 | 0/8 | FAIL |
...
| `dema_cross` | sharpe -6.54 < 1.0 (x1), profit_factor 0.33 < 1.5 (x1), mc_p_value 0.998 > 0.1 (우연 가능성) (x1) |
...
| `roc_ma_cross` | sharpe -1.41 < 1.0 (x1), profit_factor 0.76 < 1.5 (x1), mc_p_value 0.758 > 0.1 (우연 가능성) (x1) |
