...
_Generated: 2026-07-02T05:13:31.942702Z_
...
_Generated: 2026-07-02T05:18:12.212262Z_
_Symbol: BTC/USDT_
...
|---|------|-----------|-----------|-------|-------|-----------|--------|-------------|------|
| 1 | `price_cluster` | +6.81% | 1.17 | 37.7% | 1.25 | 44 | 9.5% | 1/8 | FAIL |
...
| 2 | `price_cluster` | 54.8 | p94 | 1.17 | 0.75 | 1.25 | 44 | 9.5% | 1/8 | FAIL |
...
|------|-----------|-----------|-------|-----------|-------------|------|
| `price_cluster` | +6.81% | 1.17 | 1.25 | 44 | 1/8 | FAIL |
...
|----------|-----------------------------------|
| `price_cluster` | profit_factor 1.30 < 1.5 (x2), sharpe 0.50 < 1.0 (x1), profit_factor 1.11 < 1.5 (x1) |
...
- **전체 19개 균등배분**: -2.31% -> $9,769
- **PASS 1개 균등배분**: +6.54% -> $10,654
- **Top 5 균등배분**: +3.66% -> $10,366
...
_Generated: 2026-07-02T05:22:21.251653Z_
_Symbol: ETH/USDT_
...
| 4 | `price_cluster` | -2.46% | -0.80 | 35.7% | 0.96 | 37 | 11.1% | 1/8 | FAIL |
...
| 4 | `price_cluster` | 50.4 | p83 | -0.80 | 2.30 | 0.96 | 37 | 11.1% | 1/8 | FAIL |
...
| `price_cluster` | -2.46% | -0.80 | 0.96 | 37 | 1/8 | FAIL |
...
| `price_cluster` | sharpe -2.18 < 1.0 (x1), profit_factor 0.67 < 1.5 (x1), mc_p_value 0.872 > 0.1 (우연 가능성) (x1) |
...
| `price_cluster` | 0 | 208 | 90 | 30.2% |

## 포트폴리오 가상 배분

- **전체 19개 균등배분**: -5.41% -> $9,459
- **Top 5 균등배분**: -0.35% -> $9,965
...
_Generated: 2026-07-02T05:26:25.558737Z_
_Symbol: SOL/USDT_
...
| 6 | `price_cluster` | -2.31% | -0.62 | 32.9% | 0.92 | 37 | 9.4% | 0/8 | FAIL |
...
| 7 | `price_cluster` | 43.0 | p66 | -0.62 | 1.47 | 0.92 | 37 | 9.4% | 0/8 | FAIL |
...
| `price_cluster` | -2.31% | -0.62 | 0.92 | 37 | 0/8 | FAIL |
...
| `price_cluster` | profit_factor 0.82 < 1.5 (x2), profit_factor 1.25 < 1.5 (x1), mc_p_value 0.225 > 0.1 (우연 가능성) (x1) |
