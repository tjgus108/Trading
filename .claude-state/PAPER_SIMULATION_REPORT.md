...
_Generated: 2026-06-29T20:09:47.881040Z_
...
_Generated: 2026-06-29T20:15:49.994365Z_
_Symbol: BTC/USDT_
...
| 2 | `dema_cross` | +3.35% | 0.80 | 39.5% | 1.38 | 30 | 7.0% | 2/8 | FAIL |
...
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `dema_cross` | 68.4 | p100 | 0.80 | 2.23 | 1.38 | 30 | 7.0% | 2/8 | FAIL |
| 2 | `price_cluster` | 65.6 | p94 | 0.87 | 1.10 | 1.20 | 41 | 9.8% | 1/8 | FAIL |
| 3 | `frama` | 56.9 | p88 | 0.24 | 1.60 | 1.12 | 40 | 9.4% | 1/8 | FAIL |
| 4 | `lob_maker` | 53.4 | p83 | -0.04 | 1.99 | 1.05 | 75 | 17.0% | 0/8 | FAIL |
| 5 | `volume_breakout` | 45.5 | p77 | -0.74 | 2.18 | 0.96 | 72 | 15.4% | 0/8 | FAIL |
| 6 | `positional_scaling` | 45.3 | p72 | -0.38 | 2.82 | 1.09 | 34 | 9.2% | 1/8 | FAIL |
| 7 | `price_action_momentum` | 44.2 | p66 | -1.08 | 2.79 | 0.97 | 73 | 16.7% | 1/8 | FAIL |
| 8 | `order_flow_imbalance_v2` | 44.1 | p61 | -0.77 | 2.05 | 0.95 | 67 | 15.0% | 0/8 | FAIL |
| 9 | `narrow_range` | 44.0 | p55 | -0.51 | 1.48 | 0.97 | 46 | 10.1% | 0/8 | FAIL |
| 10 | `relative_volume` | 43.7 | p50 | -0.99 | 1.72 | 0.92 | 64 | 13.2% | 0/8 | FAIL |
| 11 | `momentum_quality` | 41.5 | p44 | -1.19 | 3.29 | 0.96 | 71 | 15.8% | 1/8 | FAIL |
| 12 | `htf_ema` | 39.9 | p38 | -0.72 | 0.71 | 0.91 | 43 | 11.2% | 0/8 | FAIL |
| 13 | `acceleration_band` | 39.5 | p33 | -0.94 | 2.58 | 0.98 | 44 | 13.0% | 1/8 | FAIL |
| 14 | `cmf` | 39.4 | p27 | -1.23 | 1.29 | 0.88 | 68 | 16.3% | 0/8 | FAIL |
| 15 | `elder_impulse` | 32.7 | p22 | -1.15 | 1.14 | 0.85 | 42 | 11.5% | 0/8 | FAIL |
...
| `dema_cross` | +3.35% | 0.80 | 1.38 | 30 | 2/8 | FAIL |
...
| `roc_ma_cross` | -4.32% | -1.45 | 0.88 | 39 | 1/8 | FAIL |
...
| `dema_cross` | sharpe 0.69 < 1.0 (x1), profit_factor 1.15 < 1.5 (x1), mc_p_value 0.350 > 0.1 (우연 가능성) (x1) |
...
| `roc_ma_cross` | profit_factor 1.21 < 1.5 (x1), mc_p_value 0.297 > 0.1 (우연 가능성) (x1), sharpe -4.53 < 1.0 (x1) |
...
| `roc_ma_cross` | 0 | 307 | 2 | 0.6% |

## 포트폴리오 가상 배분

- **전체 19개 균등배분**: -2.97% -> $9,703
- **Top 5 균등배분**: +2.07% -> $10,207
...
_Generated: 2026-06-29T20:21:18.159889Z_
_Symbol: ETH/USDT_
...
| 3 | `price_cluster` | -0.31% | -0.44 | 36.9% | 1.09 | 30 | 9.3% | 1/8 | FAIL |
| 4 | `order_flow_imbalance_v2` | -4.32% | -1.02 | 33.8% | 0.94 | 55 | 14.5% | 0/8 | FAIL |
| 5 | `acceleration_band` | -4.40% | -2.03 | 25.1% | 0.57 | 13 | 6.0% | 0/8 | FAIL |
| 6 | `volume_breakout` | -4.47% | -0.87 | 34.4% | 0.91 | 61 | 12.5% | 0/8 | FAIL |
| 7 | `lob_maker` | -5.02% | -0.90 | 33.6% | 0.92 | 58 | 15.6% | 0/8 | FAIL |
| 8 | `cmf` | -5.13% | -1.14 | 31.4% | 0.85 | 46 | 11.8% | 0/8 | FAIL |
| 9 | `volatility_cluster` | -5.39% | -1.49 | 33.3% | 0.81 | 42 | 9.4% | 0/8 | FAIL |
| 10 | `dema_cross` | -5.52% | -2.06 | 25.8% | 0.65 | 25 | 8.3% | 0/8 | FAIL |
...
| Rank | Name | Score | Pctl | AvgSharpe | SharpeStd | AvgPF | AvgTrades | AvgMDD | Consist | Pass |
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `engulfing_zone` | 68.7 | p100 | 0.44 | 2.56 | 1.30 | 24 | 7.0% | 2/8 | FAIL |
| 2 | `frama` | 67.7 | p94 | 0.51 | 1.55 | 1.18 | 33 | 8.4% | 1/8 | FAIL |
| 3 | `volume_breakout` | 57.7 | p88 | -0.87 | 1.49 | 0.91 | 61 | 12.5% | 0/8 | FAIL |
| 4 | `price_cluster` | 53.6 | p83 | -0.44 | 2.85 | 1.09 | 30 | 9.3% | 1/8 | FAIL |
| 5 | `lob_maker` | 49.7 | p77 | -0.90 | 1.82 | 0.92 | 58 | 15.6% | 0/8 | FAIL |
| 6 | `cmf` | 47.7 | p72 | -1.14 | 1.40 | 0.85 | 46 | 11.8% | 0/8 | FAIL |
| 7 | `order_flow_imbalance_v2` | 46.8 | p66 | -1.02 | 2.50 | 0.94 | 55 | 14.5% | 0/8 | FAIL |
| 8 | `volatility_cluster` | 44.9 | p61 | -1.49 | 1.44 | 0.81 | 42 | 9.4% | 0/8 | FAIL |
| 9 | `relative_volume` | 44.6 | p55 | -1.53 | 2.34 | 0.87 | 54 | 12.7% | 0/8 | FAIL |
| 10 | `elder_impulse` | 40.1 | p50 | -1.60 | 0.86 | 0.76 | 36 | 10.7% | 0/8 | FAIL |
| 11 | `momentum_quality` | 39.7 | p44 | -2.48 | 0.88 | 0.71 | 58 | 14.5% | 0/8 | FAIL |
| 12 | `price_action_momentum` | 35.9 | p38 | -2.32 | 1.51 | 0.71 | 48 | 12.6% | 0/8 | FAIL |
| 13 | `dema_cross` | 28.4 | p33 | -2.06 | 1.12 | 0.65 | 25 | 8.3% | 0/8 | FAIL |
| 14 | `linear_channel_rev` | 24.3 | p27 | -2.33 | 1.19 | 0.60 | 23 | 7.9% | 0/8 | FAIL |
...
| `dema_cross` | -5.52% | -2.06 | 0.65 | 25 | 0/8 | FAIL |
...
| `roc_ma_cross` | -9.30% | -3.46 | 0.59 | 32 | 0/8 | FAIL |
...
| `dema_cross` | sharpe -1.02 < 1.0 (x1), profit_factor 0.79 < 1.5 (x1), mc_p_value 0.675 > 0.1 (우연 가능성) (x1) |
...
| `roc_ma_cross` | profit_factor 0.39 < 1.5 (x2), sharpe -4.13 < 1.0 (x1), profit_factor 0.44 < 1.5 (x1) |
...
| `roc_ma_cross` | 0 | 179 | 81 | 31.2% |
| `relative_volume` | 0 | 302 | 134 | 30.7% |

## 포트폴리오 가상 배분

- **전체 19개 균등배분**: -5.74% -> $9,426
- **Top 5 균등배분**: -0.54% -> $9,946
...
_Generated: 2026-06-29T20:26:30.949757Z_
_Symbol: SOL/USDT_
...
| 5 | `positional_scaling` | -3.18% | -1.12 | 33.1% | 0.87 | 32 | 8.8% | 0/8 | FAIL |
| 6 | `htf_ema` | -4.40% | -1.45 | 30.6% | 0.80 | 30 | 9.0% | 0/8 | FAIL |
| 7 | `lob_maker` | -4.59% | -0.73 | 34.3% | 0.90 | 56 | 13.0% | 0/8 | FAIL |
| 8 | `elder_impulse` | -4.87% | -1.91 | 29.0% | 0.82 | 36 | 11.6% | 1/8 | FAIL |
| 9 | `linear_channel_rev` | -5.34% | -2.40 | 25.4% | 0.61 | 24 | 7.5% | 0/8 | FAIL |
| 10 | `momentum_quality` | -5.48% | -1.18 | 31.7% | 0.85 | 56 | 10.5% | 0/8 | FAIL |
...
| 2 | `volatility_cluster` | 54.4 | p94 | -0.12 | 1.16 | 1.02 | 41 | 8.7% | 0/8 | FAIL |
| 3 | `lob_maker` | 48.7 | p88 | -0.73 | 0.95 | 0.90 | 56 | 13.0% | 0/8 | FAIL |
| 4 | `relative_volume` | 48.0 | p83 | -0.61 | 2.05 | 0.97 | 50 | 10.7% | 0/8 | FAIL |
...
| 7 | `cmf` | 38.6 | p66 | -1.28 | 0.94 | 0.82 | 44 | 10.3% | 0/8 | FAIL |
| 8 | `volume_breakout` | 37.7 | p61 | -1.45 | 1.33 | 0.82 | 58 | 14.2% | 0/8 | FAIL |
| 9 | `positional_scaling` | 33.2 | p55 | -1.12 | 2.17 | 0.87 | 32 | 8.8% | 0/8 | FAIL |
| 10 | `elder_impulse` | 31.8 | p50 | -1.91 | 3.14 | 0.82 | 36 | 11.6% | 1/8 | FAIL |
| 11 | `price_action_momentum` | 30.5 | p44 | -1.88 | 0.97 | 0.75 | 47 | 12.3% | 0/8 | FAIL |
| 12 | `acceleration_band` | 30.1 | p38 | -0.80 | 1.82 | 1.00 | 11 | 4.7% | 0/8 | FAIL |
| 13 | `htf_ema` | 27.6 | p33 | -1.45 | 1.94 | 0.80 | 30 | 9.0% | 0/8 | FAIL |
| 14 | `frama` | 24.2 | p27 | -1.94 | 1.83 | 0.74 | 42 | 12.6% | 0/8 | FAIL |
| 15 | `price_cluster` | 21.0 | p22 | -2.09 | 0.57 | 0.67 | 32 | 10.4% | 0/8 | FAIL |
...
| `dema_cross` | -5.92% | -2.13 | 0.70 | 31 | 0/8 | FAIL |
...
| `dema_cross` | sharpe -1.20 < 1.0 (x1), profit_factor 0.81 < 1.5 (x1), mc_p_value 0.723 > 0.1 (우연 가능성) (x1) |
...
| `roc_ma_cross` | mc_p_value 0.929 > 0.1 (우연 가능성) (x2), sharpe -3.26 < 1.0 (x1), profit_factor 0.51 < 1.5 (x1) |
...
| `price_cluster` | profit_factor 0.63 < 1.5 (x2), sharpe -2.76 < 1.0 (x1), profit_factor 0.61 < 1.5 (x1) |

### 전체 FAIL 원인 빈도 (상위 10)

| Fail Reason | Total Count |
|-------------|-------------|
| profit_factor 0.68 < 1.5 | 7 |
...
| `roc_ma_cross` | 0 | 149 | 123 | 45.2% |
| `elder_impulse` | 0 | 157 | 128 | 44.9% |
| `linear_channel_rev` | 0 | 107 | 87 | 44.8% |

## 포트폴리오 가상 배분

- **전체 19개 균등배분**: -4.85% -> $9,515
- **Top 5 균등배분**: -0.50% -> $9,950
