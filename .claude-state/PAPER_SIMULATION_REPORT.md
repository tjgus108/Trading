...
_Generated: 2026-07-03T20:18:24.217033Z_
...
_Generated: 2026-07-03T20:23:16.278831Z_
_Symbol: BTC/USDT_
...
| 7 | `price_cluster` | -2.47% | -0.93 | 31.3% | 0.91 | 22 | 8.4% | 0/8 | FAIL |
...
| 2 | `dema_cross` | 48.2 | p94 | 0.85 | 1.85 | 1.38 | 26 | 6.1% | 2/8 | FAIL |
| 3 | `lob_maker` | 43.6 | p88 | -0.04 | 1.99 | 1.05 | 75 | 17.0% | 0/8 | FAIL |
| 4 | `frama` | 43.4 | p83 | 0.24 | 1.60 | 1.12 | 40 | 9.4% | 1/8 | FAIL |
| 5 | `volume_breakout` | 37.6 | p77 | -0.74 | 2.18 | 0.96 | 72 | 15.4% | 0/8 | FAIL |
| 6 | `order_flow_imbalance_v2` | 36.5 | p72 | -0.77 | 2.05 | 0.95 | 67 | 15.0% | 0/8 | FAIL |
| 7 | `relative_volume` | 36.5 | p66 | -0.99 | 1.72 | 0.92 | 64 | 13.2% | 0/8 | FAIL |
| 8 | `narrow_range` | 35.8 | p61 | -0.51 | 1.48 | 0.97 | 46 | 10.1% | 0/8 | FAIL |
| 9 | `price_action_momentum` | 34.7 | p55 | -1.08 | 2.79 | 0.97 | 73 | 16.7% | 1/8 | FAIL |
| 10 | `cmf` | 34.0 | p50 | -1.23 | 1.29 | 0.88 | 68 | 16.3% | 0/8 | FAIL |
| 11 | `positional_scaling` | 33.8 | p44 | -0.38 | 2.82 | 1.09 | 34 | 9.2% | 1/8 | FAIL |
| 12 | `htf_ema` | 33.4 | p38 | -0.72 | 0.71 | 0.91 | 43 | 11.2% | 0/8 | FAIL |
| 13 | `momentum_quality` | 32.2 | p33 | -1.19 | 3.29 | 0.96 | 71 | 15.8% | 1/8 | FAIL |
| 14 | `acceleration_band` | 30.4 | p27 | -0.94 | 2.58 | 0.98 | 44 | 13.0% | 1/8 | FAIL |
| 15 | `elder_impulse` | 28.0 | p22 | -1.15 | 1.14 | 0.85 | 42 | 11.5% | 0/8 | FAIL |
...
| `price_cluster` | -2.47% | -0.93 | 0.91 | 22 | 0/8 | FAIL |
...
| `price_cluster` | profit_factor 1.11 < 1.5 (x2), sharpe -4.95 < 1.0 (x1), profit_factor 0.30 < 1.5 (x1) |
...
- **전체 19개 균등배분**: -2.80% -> $9,720
- **PASS 1개 균등배분**: +6.54% -> $10,654
- **Top 5 균등배분**: +2.33% -> $10,233
...
_Generated: 2026-07-03T20:27:44.563658Z_
_Symbol: ETH/USDT_
...
| 4 | `price_cluster` | -2.94% | -1.74 | 30.3% | 0.84 | 19 | 8.2% | 1/8 | FAIL |
...
| Rank | Name | Score | Pctl | AvgSharpe | SharpeStd | AvgPF | AvgTrades | AvgMDD | Consist | Pass |
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `engulfing_zone` | 69.0 | p100 | 0.44 | 2.56 | 1.30 | 24 | 7.0% | 2/8 | FAIL |
| 2 | `frama` | 67.6 | p94 | 0.51 | 1.55 | 1.18 | 33 | 8.4% | 1/8 | FAIL |
| 3 | `volume_breakout` | 57.1 | p88 | -0.87 | 1.49 | 0.91 | 61 | 12.5% | 0/8 | FAIL |
| 4 | `lob_maker` | 50.1 | p83 | -0.90 | 1.82 | 0.92 | 58 | 15.6% | 0/8 | FAIL |
| 5 | `cmf` | 47.5 | p77 | -1.14 | 1.40 | 0.85 | 46 | 11.8% | 0/8 | FAIL |
| 6 | `order_flow_imbalance_v2` | 47.2 | p72 | -1.02 | 2.50 | 0.94 | 55 | 14.5% | 0/8 | FAIL |
| 7 | `relative_volume` | 44.6 | p66 | -1.53 | 2.34 | 0.87 | 54 | 12.7% | 0/8 | FAIL |
| 8 | `volatility_cluster` | 44.4 | p61 | -1.49 | 1.44 | 0.81 | 42 | 9.4% | 0/8 | FAIL |
| 9 | `elder_impulse` | 40.0 | p55 | -1.60 | 0.86 | 0.76 | 36 | 10.7% | 0/8 | FAIL |
| 10 | `momentum_quality` | 39.5 | p50 | -2.48 | 0.88 | 0.71 | 58 | 14.5% | 0/8 | FAIL |
| 11 | `price_action_momentum` | 35.8 | p44 | -2.32 | 1.51 | 0.71 | 48 | 12.6% | 0/8 | FAIL |
| 12 | `roc_ma_cross` | 34.5 | p33 | -0.79 | 1.51 | 0.90 | 9 | 4.1% | 0/8 | FAIL |
| 13 | `price_cluster` | 34.5 | p38 | -1.74 | 3.00 | 0.84 | 19 | 8.2% | 1/8 | FAIL |
...
| `price_cluster` | -2.94% | -1.74 | 0.84 | 19 | 1/8 | FAIL |
...
| `price_cluster` | sharpe -5.11 < 1.0 (x1), profit_factor 0.24 < 1.5 (x1), mc_p_value 0.993 > 0.1 (우연 가능성) (x1) |
...
- **전체 19개 균등배분**: -5.44% -> $9,456
- **Top 5 균등배분**: -0.44% -> $9,956
...
_Generated: 2026-07-03T20:32:00.566283Z_
_Symbol: SOL/USDT_
...
| 3 | `price_cluster` | -0.66% | -0.35 | 37.2% | 1.40 | 15 | 5.7% | 0/8 | FAIL |
...
| Rank | Name | Score | Pctl | AvgSharpe | SharpeStd | AvgPF | AvgTrades | AvgMDD | Consist | Pass |
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `engulfing_zone` | 69.7 | p100 | 0.78 | 2.10 | 1.33 | 26 | 7.0% | 1/8 | FAIL |
| 2 | `volatility_cluster` | 53.4 | p94 | -0.12 | 1.16 | 1.02 | 41 | 8.7% | 0/8 | FAIL |
| 3 | `lob_maker` | 48.1 | p88 | -0.73 | 0.95 | 0.90 | 56 | 13.0% | 0/8 | FAIL |
| 4 | `relative_volume` | 46.8 | p83 | -0.61 | 2.05 | 0.97 | 50 | 10.7% | 0/8 | FAIL |
| 5 | `momentum_quality` | 46.0 | p77 | -1.18 | 0.96 | 0.85 | 56 | 10.5% | 0/8 | FAIL |
| 6 | `price_cluster` | 45.3 | p72 | -0.35 | 2.06 | 1.40 | 15 | 5.7% | 0/8 | FAIL |
| 7 | `order_flow_imbalance_v2` | 43.4 | p66 | -1.22 | 0.78 | 0.84 | 55 | 12.0% | 0/8 | FAIL |
| 8 | `cmf` | 37.8 | p61 | -1.28 | 0.94 | 0.82 | 44 | 10.3% | 0/8 | FAIL |
| 9 | `volume_breakout` | 36.9 | p55 | -1.45 | 1.33 | 0.82 | 58 | 14.2% | 0/8 | FAIL |
| 10 | `positional_scaling` | 31.9 | p50 | -1.12 | 2.17 | 0.87 | 32 | 8.8% | 0/8 | FAIL |
| 11 | `elder_impulse` | 30.2 | p44 | -1.91 | 3.14 | 0.82 | 36 | 11.6% | 1/8 | FAIL |
| 12 | `price_action_momentum` | 29.7 | p38 | -1.88 | 0.97 | 0.75 | 47 | 12.3% | 0/8 | FAIL |
| 13 | `acceleration_band` | 28.6 | p33 | -0.80 | 1.82 | 1.00 | 11 | 4.7% | 0/8 | FAIL |
| 14 | `htf_ema` | 26.5 | p27 | -1.45 | 1.94 | 0.80 | 30 | 9.0% | 0/8 | FAIL |
| 15 | `roc_ma_cross` | 23.5 | p22 | -0.94 | 1.65 | 0.85 | 11 | 5.2% | 0/8 | FAIL |
...
| `price_cluster` | -0.66% | -0.35 | 1.40 | 15 | 0/8 | FAIL |
...
| `price_cluster` | trades 12 < 15 (x2), sharpe -0.46 < 1.0 (x1), profit_factor 0.90 < 1.5 (x1) |
...
- **전체 19개 균등배분**: -4.10% -> $9,590
- **Top 5 균등배분**: +0.04% -> $10,004
