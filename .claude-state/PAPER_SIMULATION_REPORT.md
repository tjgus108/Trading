...
_Generated: 2026-06-19T05:26:57.802029Z_
...
_Generated: 2026-06-19T05:32:10.921184Z_
_Symbol: BTC/USDT_
...
| 4 | `roc_ma_cross` | -1.02% | -0.74 | 36.8% | 1.04 | 42 | 11.0% | 2/8 | FAIL |
...
| 2 | `positional_scaling` | 63.6 | p94 | 0.00 | 2.87 | 1.18 | 36 | 9.7% | 1/8 | FAIL |
| 3 | `volume_breakout` | 61.6 | p89 | -0.44 | 2.41 | 1.01 | 78 | 15.8% | 0/8 | FAIL |
| 4 | `roc_ma_cross` | 60.4 | p84 | -0.74 | 3.02 | 1.04 | 42 | 11.0% | 2/8 | FAIL |
...
| `roc_ma_cross` | -1.02% | -0.74 | 1.04 | 42 | 2/8 | FAIL |
...
| `roc_ma_cross` | profit_factor 0.88 < 1.5 (x2), sharpe -0.87 < 1.0 (x1), mc_p_value 0.675 > 0.1 (우연 가능성) (x1) |
...
- **전체 20개 균등배분**: -4.47% -> $9,553
- **Top 5 균등배분**: +0.16% -> $10,016
...
_Generated: 2026-06-19T05:37:23.589822Z_
_Symbol: ETH/USDT_
...
| 7 | `roc_ma_cross` | -3.18% | -0.77 | 38.8% | 0.88 | 36 | 9.2% | 0/8 | FAIL |
...
| 7 | `roc_ma_cross` | 42.1 | p68 | -0.77 | 1.02 | 0.88 | 36 | 9.2% | 0/8 | FAIL |
...
| `roc_ma_cross` | -3.18% | -0.77 | 0.88 | 36 | 0/8 | FAIL |
...
| `roc_ma_cross` | sharpe -0.90 < 1.0 (x1), profit_factor 0.84 < 1.5 (x1), mc_p_value 0.697 > 0.1 (우연 가능성) (x1) |
...
_Generated: 2026-06-19T05:42:16.372064Z_
_Symbol: SOL/USDT_
...
| 9 | `roc_ma_cross` | -1.88% | -0.77 | 39.3% | 0.92 | 34 | 8.1% | 0/8 | FAIL |
...
| 8 | `roc_ma_cross` | 48.0 | p63 | -0.77 | 2.14 | 0.92 | 34 | 8.1% | 0/8 | FAIL |
...
| `roc_ma_cross` | -1.88% | -0.77 | 0.92 | 34 | 0/8 | FAIL |
...
| `roc_ma_cross` | sharpe -2.74 < 1.0 (x1), profit_factor 0.55 < 1.5 (x1), mc_p_value 0.906 > 0.1 (우연 가능성) (x1) |
