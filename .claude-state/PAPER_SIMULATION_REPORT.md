...
_Generated: 2026-07-04T10:15:43.969509Z_
...
_Generated: 2026-07-04T10:19:40.041595Z_
_Symbol: BTC/USDT_
...
| 6 | `price_cluster` | -1.12% | -0.36 | 32.6% | 1.00 | 29 | 9.2% | 0/8 | FAIL |
...
| 15 | `price_cluster` | 30.2 | p22 | -0.36 | 1.69 | 1.00 | 29 | 9.2% | 0/8 | FAIL |
...
| `price_cluster` | -1.12% | -0.36 | 1.00 | 29 | 0/8 | FAIL |
...
| `price_cluster` | sharpe 0.99 < 1.0 (x1), profit_factor 1.25 < 1.5 (x1), mc_p_value 0.265 > 0.1 (우연 가능성) (x1) |
...
_Generated: 2026-07-04T10:23:20.612077Z_
_Symbol: ETH/USDT_
...
| 4 | `lob_maker` | 49.0 | p83 | -0.90 | 1.82 | 0.92 | 58 | 15.6% | 0/8 | FAIL |
| 5 | `cmf` | 47.0 | p77 | -1.14 | 1.40 | 0.85 | 46 | 11.8% | 0/8 | FAIL |
| 6 | `order_flow_imbalance_v2` | 45.5 | p72 | -1.02 | 2.50 | 0.94 | 55 | 14.5% | 0/8 | FAIL |
| 7 | `volatility_cluster` | 43.9 | p66 | -1.49 | 1.44 | 0.81 | 42 | 9.4% | 0/8 | FAIL |
| 8 | `relative_volume` | 43.0 | p61 | -1.53 | 2.34 | 0.87 | 54 | 12.7% | 0/8 | FAIL |
| 9 | `elder_impulse` | 40.0 | p55 | -1.60 | 0.86 | 0.76 | 36 | 10.7% | 0/8 | FAIL |
| 10 | `momentum_quality` | 39.4 | p50 | -2.48 | 0.88 | 0.71 | 58 | 14.5% | 0/8 | FAIL |
| 11 | `price_action_momentum` | 35.2 | p44 | -2.32 | 1.51 | 0.71 | 48 | 12.6% | 0/8 | FAIL |
| 12 | `roc_ma_cross` | 34.3 | p38 | -0.79 | 1.51 | 0.90 | 9 | 4.1% | 0/8 | FAIL |
| 13 | `price_cluster` | 29.6 | p33 | -1.82 | 1.40 | 0.70 | 24 | 9.6% | 0/8 | FAIL |
...
| `price_cluster` | -5.92% | -1.82 | 0.70 | 24 | 0/8 | FAIL |
...
| `price_cluster` | sharpe -3.72 < 1.0 (x1), profit_factor 0.41 < 1.5 (x1), mc_p_value 0.967 > 0.1 (우연 가능성) (x1) |
...
- **전체 19개 균등배분**: -5.59% -> $9,441
- **Top 5 균등배분**: -0.74% -> $9,926
...
_Generated: 2026-07-04T10:26:50.222927Z_
_Symbol: SOL/USDT_
...
| 10 | `price_cluster` | -5.21% | -1.86 | 28.0% | 0.71 | 19 | 9.2% | 0/8 | FAIL |
...
| `price_cluster` | -5.21% | -1.86 | 0.71 | 19 | 0/8 | FAIL |
...
| `price_cluster` | sharpe -4.75 < 1.0 (x1), profit_factor 0.33 < 1.5 (x1), mc_p_value 0.994 > 0.1 (우연 가능성) (x1) |
