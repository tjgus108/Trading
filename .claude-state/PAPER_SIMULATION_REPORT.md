...
_Generated: 2026-06-30T10:08:59.336661Z_
...
_Generated: 2026-06-30T10:13:07.513155Z_
_Symbol: BTC/USDT_
...
| 4 | `dema_cross` | +1.03% | 0.21 | 38.6% | 1.30 | 26 | 6.8% | 2/8 | FAIL |
...
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `price_cluster` | 67.4 | p100 | 0.87 | 1.10 | 1.20 | 41 | 9.8% | 1/8 | FAIL |
| 2 | `roc_ma_cross` | 64.4 | p94 | 0.34 | 2.44 | 1.22 | 36 | 8.1% | 2/8 | FAIL |
| 3 | `dema_cross` | 60.9 | p88 | 0.21 | 2.46 | 1.30 | 26 | 6.8% | 2/8 | FAIL |
| 4 | `frama` | 58.5 | p83 | 0.24 | 1.60 | 1.12 | 40 | 9.4% | 1/8 | FAIL |
| 5 | `lob_maker` | 54.8 | p77 | -0.04 | 1.99 | 1.05 | 75 | 17.0% | 0/8 | FAIL |
| 6 | `positional_scaling` | 46.8 | p72 | -0.38 | 2.82 | 1.09 | 34 | 9.2% | 1/8 | FAIL |
| 7 | `volume_breakout` | 46.5 | p66 | -0.74 | 2.18 | 0.96 | 72 | 15.4% | 0/8 | FAIL |
| 8 | `price_action_momentum` | 45.3 | p61 | -1.08 | 2.79 | 0.97 | 73 | 16.7% | 1/8 | FAIL |
| 9 | `order_flow_imbalance_v2` | 45.1 | p55 | -0.77 | 2.05 | 0.95 | 67 | 15.0% | 0/8 | FAIL |
| 10 | `narrow_range` | 45.0 | p50 | -0.51 | 1.48 | 0.97 | 46 | 10.1% | 0/8 | FAIL |
| 11 | `relative_volume` | 44.6 | p44 | -0.99 | 1.72 | 0.92 | 64 | 13.2% | 0/8 | FAIL |
| 12 | `momentum_quality` | 42.6 | p38 | -1.19 | 3.29 | 0.96 | 71 | 15.8% | 1/8 | FAIL |
| 13 | `htf_ema` | 40.7 | p33 | -0.72 | 0.71 | 0.91 | 43 | 11.2% | 0/8 | FAIL |
| 14 | `acceleration_band` | 40.6 | p27 | -0.94 | 2.58 | 0.98 | 44 | 13.0% | 1/8 | FAIL |
| 15 | `cmf` | 40.2 | p22 | -1.23 | 1.29 | 0.88 | 68 | 16.3% | 0/8 | FAIL |
...
| `dema_cross` | +1.03% | 0.21 | 1.30 | 26 | 2/8 | FAIL |
...
| `dema_cross` | sharpe -0.40 < 1.0 (x1), profit_factor 0.95 < 1.5 (x1), mc_p_value 0.564 > 0.1 (우연 가능성) (x1) |
...
_Generated: 2026-06-30T10:16:56.649194Z_
_Symbol: ETH/USDT_
...
| 14 | `dema_cross` | 21.4 | p22 | -2.54 | 1.11 | 0.57 | 22 | 8.3% | 0/8 | FAIL |
| 15 | `htf_ema` | 21.4 | p27 | -2.83 | 0.81 | 0.56 | 29 | 12.1% | 0/8 | FAIL |
...
| `dema_cross` | -6.25% | -2.54 | 0.57 | 22 | 0/8 | FAIL |
...
| `dema_cross` | profit_factor 0.61 < 1.5 (x2), sharpe -1.93 < 1.0 (x1), mc_p_value 0.830 > 0.1 (우연 가능성) (x1) |
...
_Generated: 2026-06-30T10:20:33.769324Z_
_Symbol: SOL/USDT_
...
| `dema_cross` | -6.45% | -2.52 | 0.63 | 28 | 0/8 | FAIL |
...
| `dema_cross` | sharpe -1.72 < 1.0 (x1), profit_factor 0.73 < 1.5 (x1), mc_p_value 0.802 > 0.1 (우연 가능성) (x1) |
