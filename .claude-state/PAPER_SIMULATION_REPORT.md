...
_Generated: 2026-06-28T10:10:46.465523Z_
...
_Generated: 2026-06-28T10:15:15.888354Z_
_Symbol: BTC/USDT_
...
| 6 | `dema_cross` | -1.48% | -0.69 | 33.5% | 1.00 | 24 | 6.7% | 1/8 | FAIL |
...
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `price_cluster` | 69.9 | p100 | 0.87 | 1.10 | 1.20 | 41 | 9.8% | 1/8 | FAIL |
| 2 | `roc_ma_cross` | 66.9 | p94 | 0.34 | 2.44 | 1.22 | 36 | 8.1% | 2/8 | FAIL |
| 3 | `frama` | 60.6 | p88 | 0.24 | 1.60 | 1.12 | 40 | 9.4% | 1/8 | FAIL |
| 4 | `lob_maker` | 56.6 | p83 | -0.04 | 1.99 | 1.05 | 75 | 17.0% | 0/8 | FAIL |
| 5 | `positional_scaling` | 48.8 | p77 | -0.38 | 2.82 | 1.09 | 34 | 9.2% | 1/8 | FAIL |
| 6 | `volume_breakout` | 47.9 | p72 | -0.74 | 2.18 | 0.96 | 72 | 15.4% | 0/8 | FAIL |
| 7 | `price_action_momentum` | 46.7 | p66 | -1.08 | 2.79 | 0.97 | 73 | 16.7% | 1/8 | FAIL |
| 8 | `order_flow_imbalance_v2` | 46.5 | p61 | -0.77 | 2.05 | 0.95 | 67 | 15.0% | 0/8 | FAIL |
| 9 | `narrow_range` | 46.4 | p55 | -0.51 | 1.48 | 0.97 | 46 | 10.1% | 0/8 | FAIL |
| 10 | `relative_volume` | 45.7 | p50 | -0.99 | 1.72 | 0.92 | 64 | 13.2% | 0/8 | FAIL |
| 11 | `momentum_quality` | 43.9 | p44 | -1.19 | 3.29 | 0.96 | 71 | 15.8% | 1/8 | FAIL |
| 12 | `acceleration_band` | 42.1 | p38 | -0.94 | 2.58 | 0.98 | 44 | 13.0% | 1/8 | FAIL |
| 13 | `htf_ema` | 41.9 | p33 | -0.72 | 0.71 | 0.91 | 43 | 11.2% | 0/8 | FAIL |
| 14 | `cmf` | 41.2 | p27 | -1.23 | 1.29 | 0.88 | 68 | 16.3% | 0/8 | FAIL |
| 15 | `dema_cross` | 40.7 | p22 | -0.69 | 2.14 | 1.00 | 24 | 6.7% | 1/8 | FAIL |
...
| `dema_cross` | -1.48% | -0.69 | 1.00 | 24 | 1/8 | FAIL |
...
| `dema_cross` | mc_p_value 0.166 > 0.1 (우연 가능성) (x1), sharpe -2.10 < 1.0 (x1), profit_factor 0.68 < 1.5 (x1) |
...
_Generated: 2026-06-28T10:19:25.499947Z_
_Symbol: ETH/USDT_
...
| 4 | `dema_cross` | -3.73% | -1.61 | 30.1% | 0.76 | 22 | 7.7% | 0/8 | FAIL |
...
| 13 | `dema_cross` | 31.6 | p33 | -1.61 | 1.87 | 0.76 | 22 | 7.7% | 0/8 | FAIL |
...
| `dema_cross` | -3.73% | -1.61 | 0.76 | 22 | 0/8 | FAIL |
...
| `dema_cross` | sharpe -2.51 < 1.0 (x1), profit_factor 0.56 < 1.5 (x1), mc_p_value 0.890 > 0.1 (우연 가능성) (x1) |
...
- **전체 19개 균등배분**: -5.64% -> $9,436
- **Top 5 균등배분**: -0.41% -> $9,959
