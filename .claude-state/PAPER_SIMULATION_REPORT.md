...
_Generated: 2026-06-12T10:11:03.411334Z_
...
_Generated: 2026-06-12T10:12:15.335688Z_
_Symbol: BTC/USDT_
...
| 3 | `relative_volume` | +2.14% | 0.97 | 40.5% | 1.35 | 18 | 4.8% | 0/8 | FAIL |
| 4 | `linear_channel_rev` | +1.82% | 1.23 | 43.6% | 2.01 | 6 | 2.3% | 0/8 | FAIL |
| 5 | `cmf` | +1.75% | 0.59 | 41.5% | 1.16 | 23 | 6.9% | 1/8 | FAIL |
| 6 | `lob_maker` | +1.61% | 0.50 | 39.6% | 1.23 | 21 | 7.6% | 1/8 | FAIL |
| 7 | `elder_impulse` | +0.22% | -1.56 | 31.8% | 1.48 | 14 | 6.5% | 0/8 | FAIL |
| 8 | `htf_ema` | +0.05% | -0.60 | 40.4% | 1.55 | 11 | 5.0% | 0/8 | FAIL |
| 9 | `value_area` | +0.02% | -0.50 | 37.8% | 1.10 | 16 | 5.2% | 1/8 | FAIL |
| 10 | `positional_scaling` | -0.01% | -1.15 | 39.9% | 1.67 | 10 | 4.5% | 0/8 | FAIL |
...
| 5 | `linear_channel_rev` | 53.0 | p80 | 1.23 | 3.30 | 2.01 | 6 | 2.3% | 0/8 | FAIL |
| 6 | `supertrend_multi` | 51.3 | p76 | 1.84 | 2.92 | 1.14 | 8 | 2.7% | 1/8 | FAIL |
| 7 | `value_area` | 47.6 | p71 | -0.50 | 3.63 | 1.10 | 16 | 5.2% | 1/8 | FAIL |
| 8 | `order_flow_imbalance_v2` | 47.5 | p66 | -1.25 | 6.24 | 1.16 | 19 | 7.6% | 3/8 | FAIL |
| 9 | `htf_ema` | 43.2 | p61 | -0.60 | 4.36 | 1.55 | 11 | 5.0% | 0/8 | FAIL |
| 10 | `price_action_momentum` | 42.5 | p57 | -1.66 | 5.42 | 0.98 | 24 | 7.7% | 1/8 | FAIL |
| 11 | `positional_scaling` | 39.1 | p52 | -1.15 | 5.73 | 1.67 | 10 | 4.5% | 0/8 | FAIL |
| 12 | `volatility_cluster` | 36.7 | p47 | -1.21 | 5.37 | 1.14 | 14 | 5.5% | 0/8 | FAIL |
| 13 | `elder_impulse` | 36.3 | p42 | -1.56 | 6.42 | 1.48 | 14 | 6.5% | 0/8 | FAIL |
| 14 | `volume_breakout` | 31.9 | p38 | -2.40 | 5.40 | 0.91 | 18 | 7.7% | 1/8 | FAIL |
| 15 | `wick_reversal` | 31.6 | p33 | -1.47 | 3.32 | 0.96 | 11 | 4.5% | 0/8 | FAIL |
...
| `price_cluster` | -2.73% | -1.76 | 0.82 | 13 | 0/8 | FAIL |
...
| `price_cluster` | trades 12 < 15 (x2), trades 13 < 15 (x2), sharpe -4.10 < 1.0 (x1) |
...
_Generated: 2026-06-12T10:13:23.602970Z_
_Symbol: ETH/USDT_
...
| 5 | `positional_scaling` | -2.45% | -3.10 | 24.5% | 0.56 | 8 | 4.1% | 0/8 | FAIL |
| 6 | `narrow_range` | -2.49% | -1.92 | 32.7% | 0.81 | 17 | 7.5% | 0/8 | FAIL |
| 7 | `htf_ema` | -2.79% | -2.80 | 25.8% | 0.86 | 9 | 5.6% | 0/8 | FAIL |
| 8 | `wick_reversal` | -2.88% | -3.44 | 31.3% | 0.64 | 10 | 4.8% | 0/8 | FAIL |
| 9 | `linear_channel_rev` | -3.32% | -4.99 | 21.1% | 0.51 | 7 | 4.7% | 0/8 | FAIL |
| 10 | `roc_ma_cross` | -3.53% | -4.17 | 26.5% | 0.59 | 10 | 5.2% | 0/8 | FAIL |
...
| Rank | Name | Score | Pctl | AvgSharpe | SharpeStd | AvgPF | AvgTrades | AvgMDD | Consist | Pass |
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `acceleration_band` | 61.4 | p100 | 1.19 | 2.43 | 1.57 | 7 | 2.5% | 0/8 | FAIL |
| 2 | `dema_cross` | 61.2 | p95 | 0.86 | 2.80 | 1.52 | 8 | 2.4% | 0/8 | FAIL |
| 3 | `volatility_cluster` | 59.7 | p90 | -0.70 | 2.30 | 1.01 | 16 | 4.6% | 0/8 | FAIL |
| 4 | `engulfing_zone` | 57.6 | p85 | 0.73 | 2.80 | 1.40 | 7 | 3.1% | 0/8 | FAIL |
| 5 | `frama` | 56.9 | p80 | -2.01 | 1.92 | 0.79 | 22 | 9.0% | 0/8 | FAIL |
| 6 | `momentum_quality` | 51.7 | p76 | -3.01 | 4.02 | 0.76 | 24 | 7.8% | 0/8 | FAIL |
| 7 | `narrow_range` | 50.2 | p71 | -1.92 | 2.85 | 0.81 | 17 | 7.5% | 0/8 | FAIL |
| 8 | `order_flow_imbalance_v2` | 46.4 | p66 | -3.18 | 2.89 | 0.70 | 21 | 9.9% | 0/8 | FAIL |
| 9 | `lob_maker` | 45.2 | p61 | -4.06 | 2.17 | 0.62 | 24 | 11.2% | 0/8 | FAIL |
| 10 | `value_area` | 38.9 | p57 | -4.33 | 3.15 | 0.60 | 17 | 6.9% | 0/8 | FAIL |
| 11 | `price_action_momentum` | 37.4 | p52 | -5.17 | 3.40 | 0.56 | 22 | 9.9% | 0/8 | FAIL |
| 12 | `htf_ema` | 36.5 | p47 | -2.80 | 3.86 | 0.86 | 9 | 5.6% | 0/8 | FAIL |
| 13 | `relative_volume` | 35.0 | p42 | -4.82 | 3.03 | 0.53 | 18 | 8.7% | 0/8 | FAIL |
| 14 | `cmf` | 34.8 | p38 | -4.30 | 4.25 | 0.60 | 17 | 8.6% | 0/8 | FAIL |
| 15 | `wick_reversal` | 32.1 | p33 | -3.44 | 3.94 | 0.64 | 10 | 4.8% | 0/8 | FAIL |
...
| `price_cluster` | -4.46% | -4.10 | 0.55 | 10 | 0/8 | FAIL |
...
| `price_cluster` | trades 10 < 15 (x2), trades 13 < 15 (x2), trades 8 < 15 (x2) |
...
_Generated: 2026-06-12T10:14:31.769643Z_
_Symbol: SOL/USDT_
...
| 6 | `engulfing_zone` | -2.52% | -2.56 | 34.7% | 0.66 | 8 | 4.8% | 0/8 | FAIL |
| 7 | `momentum_quality` | -2.57% | -2.18 | 32.6% | 0.86 | 23 | 7.2% | 1/8 | FAIL |
| 8 | `volatility_cluster` | -2.70% | -1.93 | 34.2% | 0.81 | 20 | 6.1% | 0/8 | FAIL |
| 9 | `supertrend_multi` | -3.02% | -2.53 | 29.8% | 0.75 | 12 | 6.1% | 0/8 | FAIL |
| 10 | `htf_ema` | -3.05% | -3.68 | 30.5% | 1.31 | 10 | 5.9% | 0/8 | FAIL |
...
| 15 | `volume_breakout` | 28.0 | p33 | -3.73 | 3.51 | 0.57 | 10 | 6.2% | 0/8 | FAIL |
...
| `price_cluster` | -6.07% | -5.50 | 0.39 | 12 | 0/8 | FAIL |
...
| `price_cluster` | trades 11 < 15 (x2), profit_factor 0.51 < 1.5 (x2), trades 5 < 15 (x2) |
