...
_Generated: 2026-06-24T20:10:49.510080Z_
...
_Generated: 2026-06-24T20:15:50.553563Z_
_Symbol: BTC/USDT_
...
| 4 | `dema_cross` | +0.62% | -0.22 | 43.7% | 250.79 | 5 | 2.4% | 0/8 | FAIL |
...
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `price_cluster` | 51.5 | p100 | 0.87 | 1.10 | 1.20 | 41 | 9.8% | 1/8 | FAIL |
| 2 | `roc_ma_cross` | 48.4 | p94 | 0.34 | 2.44 | 1.22 | 36 | 8.1% | 2/8 | FAIL |
| 3 | `frama` | 45.1 | p88 | 0.24 | 1.60 | 1.12 | 40 | 9.4% | 1/8 | FAIL |
| 4 | `lob_maker` | 42.4 | p83 | -0.04 | 1.99 | 1.05 | 75 | 17.0% | 0/8 | FAIL |
| 5 | `dema_cross` | 41.9 | p77 | -0.22 | 2.75 | 250.79 | 5 | 2.4% | 0/8 | FAIL |
| 6 | `volume_breakout` | 36.4 | p72 | -0.74 | 2.18 | 0.96 | 72 | 15.4% | 0/8 | FAIL |
| 7 | `narrow_range` | 35.7 | p61 | -0.51 | 1.48 | 0.97 | 46 | 10.1% | 0/8 | FAIL |
| 8 | `relative_volume` | 35.7 | p66 | -0.99 | 1.72 | 0.92 | 64 | 13.2% | 0/8 | FAIL |
| 9 | `order_flow_imbalance_v2` | 35.6 | p55 | -0.77 | 2.05 | 0.95 | 67 | 15.0% | 0/8 | FAIL |
| 10 | `price_action_momentum` | 35.5 | p50 | -1.08 | 2.79 | 0.97 | 73 | 16.7% | 1/8 | FAIL |
| 11 | `positional_scaling` | 35.1 | p44 | -0.38 | 2.82 | 1.09 | 34 | 9.2% | 1/8 | FAIL |
| 12 | `htf_ema` | 34.0 | p38 | -0.72 | 0.71 | 0.91 | 43 | 11.2% | 0/8 | FAIL |
| 13 | `cmf` | 33.4 | p33 | -1.23 | 1.29 | 0.88 | 68 | 16.3% | 0/8 | FAIL |
| 14 | `momentum_quality` | 32.9 | p27 | -1.19 | 3.29 | 0.96 | 71 | 15.8% | 1/8 | FAIL |
| 15 | `acceleration_band` | 32.1 | p22 | -0.94 | 2.58 | 0.98 | 44 | 13.0% | 1/8 | FAIL |
...
| `dema_cross` | +0.62% | -0.22 | 250.79 | 5 | 0/8 | FAIL |
...
| `dema_cross` | trades 4 < 15 (x2), sharpe -2.91 < 1.0 (x1), profit_factor 0.00 < 1.5 (x1) |
...
_Generated: 2026-06-24T20:20:14.653923Z_
_Symbol: ETH/USDT_
...
| 3 | `dema_cross` | +0.18% | 0.00 | 39.6% | 1.43 | 8 | 2.7% | 0/8 | FAIL |
| 4 | `price_cluster` | -0.31% | -0.44 | 36.9% | 1.09 | 30 | 9.3% | 1/8 | FAIL |
...
| Rank | Name | Score | Pctl | AvgSharpe | SharpeStd | AvgPF | AvgTrades | AvgMDD | Consist | Pass |
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `engulfing_zone` | 65.8 | p100 | 0.44 | 2.56 | 1.30 | 24 | 7.0% | 2/8 | FAIL |
| 2 | `frama` | 64.8 | p94 | 0.51 | 1.55 | 1.18 | 33 | 8.4% | 1/8 | FAIL |
| 3 | `volume_breakout` | 55.0 | p88 | -0.87 | 1.49 | 0.91 | 61 | 12.5% | 0/8 | FAIL |
| 4 | `price_cluster` | 51.3 | p83 | -0.44 | 2.85 | 1.09 | 30 | 9.3% | 1/8 | FAIL |
| 5 | `dema_cross` | 49.4 | p77 | 0.00 | 1.39 | 1.43 | 8 | 2.7% | 0/8 | FAIL |
| 6 | `lob_maker` | 48.4 | p72 | -0.90 | 1.82 | 0.92 | 58 | 15.6% | 0/8 | FAIL |
| 7 | `cmf` | 45.8 | p66 | -1.14 | 1.40 | 0.85 | 46 | 11.8% | 0/8 | FAIL |
| 8 | `order_flow_imbalance_v2` | 45.1 | p61 | -1.02 | 2.50 | 0.94 | 55 | 14.5% | 0/8 | FAIL |
| 9 | `volatility_cluster` | 42.6 | p55 | -1.49 | 1.44 | 0.81 | 42 | 9.4% | 0/8 | FAIL |
| 10 | `relative_volume` | 42.5 | p50 | -1.53 | 2.34 | 0.87 | 54 | 12.7% | 0/8 | FAIL |
| 11 | `elder_impulse` | 38.7 | p44 | -1.60 | 0.86 | 0.76 | 36 | 10.7% | 0/8 | FAIL |
| 12 | `momentum_quality` | 38.6 | p38 | -2.48 | 0.88 | 0.71 | 58 | 14.5% | 0/8 | FAIL |
| 13 | `price_action_momentum` | 34.5 | p33 | -2.32 | 1.51 | 0.71 | 48 | 12.6% | 0/8 | FAIL |
| 14 | `linear_channel_rev` | 23.9 | p27 | -2.33 | 1.19 | 0.60 | 23 | 7.9% | 0/8 | FAIL |
| 15 | `htf_ema` | 21.5 | p22 | -2.83 | 0.81 | 0.56 | 29 | 12.1% | 0/8 | FAIL |
...
| `dema_cross` | +0.18% | 0.00 | 1.43 | 8 | 0/8 | FAIL |
...
| `dema_cross` | trades 10 < 15 (x2), trades 7 < 15 (x1), sharpe 0.41 < 1.0 (x1) |
...
- **전체 19개 균등배분**: -5.43% -> $9,457
- **Top 5 균등배분**: +0.37% -> $10,038
...
_Generated: 2026-06-24T20:24:20.285358Z_
_Symbol: SOL/USDT_
...
| 2 | `dema_cross` | -0.58% | -0.38 | 39.1% | 1.14 | 13 | 4.1% | 0/8 | FAIL |
...
| Rank | Name | Score | Pctl | AvgSharpe | SharpeStd | AvgPF | AvgTrades | AvgMDD | Consist | Pass |
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `engulfing_zone` | 71.1 | p100 | 0.78 | 2.10 | 1.33 | 26 | 7.0% | 1/8 | FAIL |
| 2 | `volatility_cluster` | 57.1 | p94 | -0.12 | 1.16 | 1.02 | 41 | 8.7% | 0/8 | FAIL |
| 3 | `lob_maker` | 53.4 | p88 | -0.73 | 0.95 | 0.90 | 56 | 13.0% | 0/8 | FAIL |
| 4 | `momentum_quality` | 52.4 | p83 | -1.18 | 0.96 | 0.85 | 56 | 10.5% | 0/8 | FAIL |
| 5 | `relative_volume` | 52.1 | p77 | -0.61 | 2.05 | 0.97 | 50 | 10.7% | 0/8 | FAIL |
| 6 | `order_flow_imbalance_v2` | 50.0 | p72 | -1.22 | 0.78 | 0.84 | 55 | 12.0% | 0/8 | FAIL |
| 7 | `cmf` | 44.8 | p66 | -1.28 | 0.94 | 0.82 | 44 | 10.3% | 0/8 | FAIL |
| 8 | `volume_breakout` | 44.5 | p61 | -1.45 | 1.33 | 0.82 | 58 | 14.2% | 0/8 | FAIL |
| 9 | `dema_cross` | 42.8 | p55 | -0.38 | 1.89 | 1.14 | 13 | 4.1% | 0/8 | FAIL |
| 10 | `elder_impulse` | 39.7 | p50 | -1.91 | 3.14 | 0.82 | 36 | 11.6% | 1/8 | FAIL |
| 11 | `positional_scaling` | 38.9 | p44 | -1.12 | 2.17 | 0.87 | 32 | 8.8% | 0/8 | FAIL |
| 12 | `price_action_momentum` | 38.4 | p38 | -1.88 | 0.97 | 0.75 | 47 | 12.3% | 0/8 | FAIL |
| 13 | `acceleration_band` | 34.8 | p33 | -0.80 | 1.82 | 1.00 | 11 | 4.7% | 0/8 | FAIL |
| 14 | `htf_ema` | 34.4 | p27 | -1.45 | 1.94 | 0.80 | 30 | 9.0% | 0/8 | FAIL |
| 15 | `frama` | 32.5 | p22 | -1.94 | 1.83 | 0.74 | 42 | 12.6% | 0/8 | FAIL |
...
| `dema_cross` | -0.58% | -0.38 | 1.14 | 13 | 0/8 | FAIL |
...
| `dema_cross` | profit_factor 0.85 < 1.5 (x2), sharpe -3.16 < 1.0 (x1), profit_factor 0.46 < 1.5 (x1) |
...
- **전체 19개 균등배분**: -4.70% -> $9,530
- **Top 5 균등배분**: +0.02% -> $10,002
