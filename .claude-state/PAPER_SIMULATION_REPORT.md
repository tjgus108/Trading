...
_Generated: 2026-06-25T05:12:18.614208Z_
...
_Generated: 2026-06-25T05:17:01.099380Z_
_Symbol: BTC/USDT_
...
| 3 | `frama` | 63.1 | p88 | 0.24 | 1.60 | 1.12 | 40 | 9.4% | 1/8 | FAIL |
| 4 | `lob_maker` | 58.8 | p83 | -0.04 | 1.99 | 1.05 | 75 | 17.0% | 0/8 | FAIL |
| 5 | `positional_scaling` | 52.6 | p77 | -0.38 | 2.82 | 1.09 | 34 | 9.2% | 1/8 | FAIL |
| 6 | `volume_breakout` | 51.0 | p72 | -0.74 | 2.18 | 0.96 | 72 | 15.4% | 0/8 | FAIL |
| 7 | `narrow_range` | 50.5 | p66 | -0.51 | 1.48 | 0.97 | 46 | 10.1% | 0/8 | FAIL |
| 8 | `price_action_momentum` | 50.1 | p61 | -1.08 | 2.79 | 0.97 | 73 | 16.7% | 1/8 | FAIL |
| 9 | `order_flow_imbalance_v2` | 50.0 | p55 | -0.77 | 2.05 | 0.95 | 67 | 15.0% | 0/8 | FAIL |
| 10 | `relative_volume` | 49.3 | p50 | -0.99 | 1.72 | 0.92 | 64 | 13.2% | 0/8 | FAIL |
| 11 | `htf_ema` | 47.5 | p44 | -0.72 | 0.71 | 0.91 | 43 | 11.2% | 0/8 | FAIL |
| 12 | `momentum_quality` | 47.3 | p38 | -1.19 | 3.29 | 0.96 | 71 | 15.8% | 1/8 | FAIL |
| 13 | `acceleration_band` | 47.1 | p33 | -0.94 | 2.58 | 0.98 | 44 | 13.0% | 1/8 | FAIL |
| 14 | `cmf` | 46.2 | p27 | -1.23 | 1.29 | 0.88 | 68 | 16.3% | 0/8 | FAIL |
| 15 | `elder_impulse` | 40.9 | p22 | -1.15 | 1.14 | 0.85 | 42 | 11.5% | 0/8 | FAIL |
...
_Generated: 2026-06-25T05:21:12.245811Z_
_Symbol: ETH/USDT_
...
| Rank | Name | Score | Pctl | AvgSharpe | SharpeStd | AvgPF | AvgTrades | AvgMDD | Consist | Pass |
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `dema_cross` | 52.6 | p100 | 1.12 | 0.87 | 126.65 | 6 | 1.6% | 0/8 | FAIL |
| 2 | `frama` | 46.3 | p94 | 0.51 | 1.55 | 1.18 | 33 | 8.4% | 1/8 | FAIL |
| 3 | `engulfing_zone` | 45.0 | p88 | 0.44 | 2.56 | 1.30 | 24 | 7.0% | 2/8 | FAIL |
| 4 | `volume_breakout` | 43.0 | p83 | -0.87 | 1.49 | 0.91 | 61 | 12.5% | 0/8 | FAIL |
| 5 | `lob_maker` | 36.6 | p77 | -0.90 | 1.82 | 0.92 | 58 | 15.6% | 0/8 | FAIL |
| 6 | `price_cluster` | 35.6 | p72 | -0.44 | 2.85 | 1.09 | 30 | 9.3% | 1/8 | FAIL |
| 7 | `cmf` | 35.4 | p66 | -1.14 | 1.40 | 0.85 | 46 | 11.8% | 0/8 | FAIL |
| 8 | `volatility_cluster` | 33.3 | p61 | -1.49 | 1.44 | 0.81 | 42 | 9.4% | 0/8 | FAIL |
| 9 | `order_flow_imbalance_v2` | 32.9 | p55 | -1.02 | 2.50 | 0.94 | 55 | 14.5% | 0/8 | FAIL |
| 10 | `momentum_quality` | 32.5 | p50 | -2.48 | 0.88 | 0.71 | 58 | 14.5% | 0/8 | FAIL |
| 11 | `relative_volume` | 32.2 | p44 | -1.53 | 2.34 | 0.87 | 54 | 12.7% | 0/8 | FAIL |
| 12 | `elder_impulse` | 30.7 | p38 | -1.60 | 0.86 | 0.76 | 36 | 10.7% | 0/8 | FAIL |
| 13 | `price_action_momentum` | 28.1 | p33 | -2.32 | 1.51 | 0.71 | 48 | 12.6% | 0/8 | FAIL |
| 14 | `linear_channel_rev` | 19.9 | p27 | -2.33 | 1.19 | 0.60 | 23 | 7.9% | 0/8 | FAIL |
| 15 | `htf_ema` | 18.8 | p22 | -2.83 | 0.81 | 0.56 | 29 | 12.1% | 0/8 | FAIL |
...
- **전체 19개 균등배분**: -5.35% -> $9,465
- **Top 5 균등배분**: +0.68% -> $10,068
...
_Generated: 2026-06-25T05:25:09.551707Z_
_Symbol: SOL/USDT_
...
| 9 | `dema_cross` | -5.04% | -3.55 | 14.1% | 0.26 | 10 | 5.4% | 0/8 | FAIL |
...
| 2 | `volatility_cluster` | 59.1 | p94 | -0.12 | 1.16 | 1.02 | 41 | 8.7% | 0/8 | FAIL |
| 3 | `lob_maker` | 55.7 | p88 | -0.73 | 0.95 | 0.90 | 56 | 13.0% | 0/8 | FAIL |
| 4 | `momentum_quality` | 55.2 | p83 | -1.18 | 0.96 | 0.85 | 56 | 10.5% | 0/8 | FAIL |
| 5 | `relative_volume` | 54.3 | p77 | -0.61 | 2.05 | 0.97 | 50 | 10.7% | 0/8 | FAIL |
| 6 | `order_flow_imbalance_v2` | 52.7 | p72 | -1.22 | 0.78 | 0.84 | 55 | 12.0% | 0/8 | FAIL |
| 7 | `cmf` | 47.7 | p66 | -1.28 | 0.94 | 0.82 | 44 | 10.3% | 0/8 | FAIL |
| 8 | `volume_breakout` | 47.1 | p61 | -1.45 | 1.33 | 0.82 | 58 | 14.2% | 0/8 | FAIL |
| 9 | `elder_impulse` | 42.5 | p55 | -1.91 | 3.14 | 0.82 | 36 | 11.6% | 1/8 | FAIL |
| 10 | `positional_scaling` | 41.6 | p50 | -1.12 | 2.17 | 0.87 | 32 | 8.8% | 0/8 | FAIL |
| 11 | `price_action_momentum` | 41.5 | p44 | -1.88 | 0.97 | 0.75 | 47 | 12.3% | 0/8 | FAIL |
| 12 | `htf_ema` | 37.5 | p38 | -1.45 | 1.94 | 0.80 | 30 | 9.0% | 0/8 | FAIL |
| 13 | `acceleration_band` | 36.8 | p33 | -0.80 | 1.82 | 1.00 | 11 | 4.7% | 0/8 | FAIL |
| 14 | `frama` | 35.6 | p27 | -1.94 | 1.83 | 0.74 | 42 | 12.6% | 0/8 | FAIL |
| 15 | `price_cluster` | 33.4 | p22 | -2.09 | 0.57 | 0.67 | 32 | 10.4% | 0/8 | FAIL |
...
| `dema_cross` | -5.04% | -3.55 | 0.26 | 10 | 0/8 | FAIL |
...
| `dema_cross` | trades 11 < 15 (x3), sharpe -4.97 < 1.0 (x1), profit_factor 0.07 < 1.5 (x1) |
