...
_Generated: 2026-07-05T05:17:18.677146Z_
...
_Generated: 2026-07-05T05:23:06.635417Z_
_Symbol: BTC/USDT_
...
| 4 | `frama` | +0.93% | 0.15 | 34.7% | 1.08 | 71 | 10.8% | 1/8 | FAIL |
...
| 2 | `frama` | 54.1 | p94 | 0.15 | 1.72 | 1.08 | 71 | 10.8% | 1/8 | FAIL |
...
| `frama` | +0.93% | 0.15 | 1.08 | 71 | 1/8 | FAIL |
...
| `frama` | sharpe -1.98 < 1.0 (x1), profit_factor 0.80 < 1.5 (x1), mc_p_value 0.816 > 0.1 (우연 가능성) (x1) |
...
- **전체 19개 균등배분**: -2.38% -> $9,762
- **PASS 1개 균등배분**: +6.54% -> $10,654
- **Top 5 균등배분**: +3.42% -> $10,342
...
_Generated: 2026-07-05T05:28:16.782728Z_
_Symbol: ETH/USDT_
...
| 2 | `frama` | +1.48% | 0.25 | 36.8% | 1.08 | 54 | 8.7% | 0/8 | FAIL |
...
| Rank | Name | Score | Pctl | AvgSharpe | SharpeStd | AvgPF | AvgTrades | AvgMDD | Consist | Pass |
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `frama` | 69.4 | p100 | 0.25 | 1.55 | 1.08 | 54 | 8.7% | 0/8 | FAIL |
...
| `frama` | +1.48% | 0.25 | 1.08 | 54 | 0/8 | FAIL |
...
| `frama` | profit_factor 1.06 < 1.5 (x2), sharpe -3.16 < 1.0 (x1), profit_factor 0.62 < 1.5 (x1) |
...
- **전체 19개 균등배분**: -5.45% -> $9,455
- **Top 5 균등배분**: -0.51% -> $9,949
...
_Generated: 2026-07-05T05:33:29.855598Z_
_Symbol: SOL/USDT_
...
| 9 | `frama` | -4.84% | -0.96 | 35.7% | 0.88 | 54 | 11.1% | 0/8 | FAIL |
...
| 5 | `frama` | 46.7 | p77 | -0.96 | 1.18 | 0.88 | 54 | 11.1% | 0/8 | FAIL |
...
| `frama` | -4.84% | -0.96 | 0.88 | 54 | 0/8 | FAIL |
...
| `frama` | profit_factor 0.86 < 1.5 (x2), sharpe -1.90 < 1.0 (x1), profit_factor 0.75 < 1.5 (x1) |
...
| `frama` | 0 | 238 | 194 | 44.9% |
| `linear_channel_rev` | 0 | 107 | 87 | 44.8% |

## 포트폴리오 가상 배분

- **전체 19개 균등배분**: -4.27% -> $9,573
