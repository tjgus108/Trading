...
_Generated: 2026-07-04T05:19:29.585987Z_
...
_Generated: 2026-07-04T05:23:16.526782Z_
_Symbol: BTC/USDT_
...
| 2 | `price_cluster` | +3.18% | 0.55 | 35.0% | 1.22 | 30 | 9.8% | 1/8 | FAIL |
...
| 5 | `price_cluster` | 42.1 | p77 | 0.55 | 1.66 | 1.22 | 30 | 9.8% | 1/8 | FAIL |
...
| `price_cluster` | +3.18% | 0.55 | 1.22 | 30 | 1/8 | FAIL |
...
|----------|-----------------------------------|
| `price_cluster` | profit_factor 1.38 < 1.5 (x1), mc_p_value 0.240 > 0.1 (우연 가능성) (x1), profit_factor 1.36 < 1.5 (x1) |
...
- **전체 19개 균등배분**: -2.50% -> $9,750
- **PASS 1개 균등배분**: +6.54% -> $10,654
- **Top 5 균등배분**: +2.93% -> $10,293
...
_Generated: 2026-07-04T05:26:49.451579Z_
_Symbol: ETH/USDT_
...
| 3 | `price_cluster` | -1.07% | -0.93 | 33.0% | 1.00 | 21 | 7.7% | 1/8 | FAIL |
| 4 | `roc_ma_cross` | -1.28% | -0.79 | 33.4% | 0.90 | 9 | 4.1% | 0/8 | FAIL |
...
| 3 | `volume_breakout` | 56.8 | p88 | -0.87 | 1.49 | 0.91 | 61 | 12.5% | 0/8 | FAIL |
| 4 | `lob_maker` | 49.7 | p83 | -0.90 | 1.82 | 0.92 | 58 | 15.6% | 0/8 | FAIL |
| 5 | `cmf` | 47.3 | p77 | -1.14 | 1.40 | 0.85 | 46 | 11.8% | 0/8 | FAIL |
| 6 | `order_flow_imbalance_v2` | 46.5 | p72 | -1.02 | 2.50 | 0.94 | 55 | 14.5% | 0/8 | FAIL |
| 7 | `price_cluster` | 44.8 | p66 | -0.93 | 2.80 | 1.00 | 21 | 7.7% | 1/8 | FAIL |
| 8 | `volatility_cluster` | 44.2 | p61 | -1.49 | 1.44 | 0.81 | 42 | 9.4% | 0/8 | FAIL |
| 9 | `relative_volume` | 43.9 | p55 | -1.53 | 2.34 | 0.87 | 54 | 12.7% | 0/8 | FAIL |
| 10 | `elder_impulse` | 40.0 | p50 | -1.60 | 0.86 | 0.76 | 36 | 10.7% | 0/8 | FAIL |
| 11 | `momentum_quality` | 39.5 | p44 | -2.48 | 0.88 | 0.71 | 58 | 14.5% | 0/8 | FAIL |
| 12 | `price_action_momentum` | 35.5 | p38 | -2.32 | 1.51 | 0.71 | 48 | 12.6% | 0/8 | FAIL |
| 13 | `roc_ma_cross` | 34.4 | p33 | -0.79 | 1.51 | 0.90 | 9 | 4.1% | 0/8 | FAIL |
...
| `price_cluster` | -1.07% | -0.93 | 1.00 | 21 | 1/8 | FAIL |
...
| `price_cluster` | sharpe -0.25 < 1.0 (x1), profit_factor 0.96 < 1.5 (x1), mc_p_value 0.533 > 0.1 (우연 가능성) (x1) |
...
- **전체 19개 균등배분**: -5.34% -> $9,466
- **Top 5 균등배분**: -0.07% -> $9,993
...
_Generated: 2026-07-04T05:30:11.785408Z_
_Symbol: SOL/USDT_
...
| 2 | `volatility_cluster` | 55.0 | p94 | -0.12 | 1.16 | 1.02 | 41 | 8.7% | 0/8 | FAIL |
| 3 | `lob_maker` | 49.5 | p88 | -0.73 | 0.95 | 0.90 | 56 | 13.0% | 0/8 | FAIL |
| 4 | `relative_volume` | 48.3 | p83 | -0.61 | 2.05 | 0.97 | 50 | 10.7% | 0/8 | FAIL |
| 5 | `momentum_quality` | 47.4 | p77 | -1.18 | 0.96 | 0.85 | 56 | 10.5% | 0/8 | FAIL |
| 6 | `order_flow_imbalance_v2` | 44.8 | p72 | -1.22 | 0.78 | 0.84 | 55 | 12.0% | 0/8 | FAIL |
| 7 | `cmf` | 39.2 | p66 | -1.28 | 0.94 | 0.82 | 44 | 10.3% | 0/8 | FAIL |
| 8 | `volume_breakout` | 38.3 | p61 | -1.45 | 1.33 | 0.82 | 58 | 14.2% | 0/8 | FAIL |
| 9 | `positional_scaling` | 33.3 | p55 | -1.12 | 2.17 | 0.87 | 32 | 8.8% | 0/8 | FAIL |
| 10 | `elder_impulse` | 31.6 | p50 | -1.91 | 3.14 | 0.82 | 36 | 11.6% | 1/8 | FAIL |
| 11 | `price_action_momentum` | 31.0 | p44 | -1.88 | 0.97 | 0.75 | 47 | 12.3% | 0/8 | FAIL |
| 12 | `acceleration_band` | 30.1 | p38 | -0.80 | 1.82 | 1.00 | 11 | 4.7% | 0/8 | FAIL |
| 13 | `htf_ema` | 27.8 | p33 | -1.45 | 1.94 | 0.80 | 30 | 9.0% | 0/8 | FAIL |
| 14 | `roc_ma_cross` | 24.9 | p27 | -0.94 | 1.65 | 0.85 | 11 | 5.2% | 0/8 | FAIL |
| 15 | `frama` | 24.5 | p22 | -1.94 | 1.83 | 0.74 | 42 | 12.6% | 0/8 | FAIL |
...
| `price_cluster` | -6.96% | -2.43 | 0.58 | 20 | 0/8 | FAIL |
...
| `price_cluster` | sharpe -2.62 < 1.0 (x2), profit_factor 0.51 < 1.5 (x1), mc_p_value 0.907 > 0.1 (우연 가능성) (x1) |
