...
_Generated: 2026-06-25T15:17:13.755391Z_
...
_Generated: 2026-06-25T15:21:34.574993Z_
_Symbol: BTC/USDT_
...
|---|------|-----------|-----------|-------|-------|-----------|--------|-------------|------|
| 1 | `dema_cross` | +2.94% | 0.37 | 35.5% | 1.19 | 50 | 9.8% | 2/8 | FAIL |
...
| 6 | `price_cluster` | -0.84% | -0.30 | 35.1% | 1.03 | 24 | 7.9% | 0/8 | FAIL |
...
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `dema_cross` | 76.2 | p100 | 0.37 | 2.61 | 1.19 | 50 | 9.8% | 2/8 | FAIL |
| 2 | `roc_ma_cross` | 72.0 | p94 | 0.34 | 2.44 | 1.22 | 36 | 8.1% | 2/8 | FAIL |
| 3 | `frama` | 65.5 | p88 | 0.24 | 1.60 | 1.12 | 40 | 9.4% | 1/8 | FAIL |
| 4 | `lob_maker` | 60.3 | p83 | -0.04 | 1.99 | 1.05 | 75 | 17.0% | 0/8 | FAIL |
| 5 | `positional_scaling` | 52.7 | p77 | -0.38 | 2.82 | 1.09 | 34 | 9.2% | 1/8 | FAIL |
| 6 | `volume_breakout` | 50.9 | p72 | -0.74 | 2.18 | 0.96 | 72 | 15.4% | 0/8 | FAIL |
| 7 | `narrow_range` | 50.3 | p66 | -0.51 | 1.48 | 0.97 | 46 | 10.1% | 0/8 | FAIL |
| 8 | `order_flow_imbalance_v2` | 49.5 | p61 | -0.77 | 2.05 | 0.95 | 67 | 15.0% | 0/8 | FAIL |
| 9 | `price_action_momentum` | 49.0 | p55 | -1.08 | 2.79 | 0.97 | 73 | 16.7% | 1/8 | FAIL |
| 10 | `relative_volume` | 48.7 | p50 | -0.99 | 1.72 | 0.92 | 64 | 13.2% | 0/8 | FAIL |
| 11 | `momentum_quality` | 46.2 | p44 | -1.19 | 3.29 | 0.96 | 71 | 15.8% | 1/8 | FAIL |
| 12 | `htf_ema` | 45.3 | p38 | -0.72 | 0.71 | 0.91 | 43 | 11.2% | 0/8 | FAIL |
| 13 | `acceleration_band` | 45.0 | p33 | -0.94 | 2.58 | 0.98 | 44 | 13.0% | 1/8 | FAIL |
| 14 | `price_cluster` | 43.6 | p27 | -0.30 | 1.78 | 1.03 | 24 | 7.9% | 0/8 | FAIL |
| 15 | `cmf` | 43.4 | p22 | -1.23 | 1.29 | 0.88 | 68 | 16.3% | 0/8 | FAIL |

## 전체 결과

| Name | AvgReturn | AvgSharpe | AvgPF | AvgTrades | Consistency | Pass |
|------|-----------|-----------|-------|-----------|-------------|------|
| `dema_cross` | +2.94% | 0.37 | 1.19 | 50 | 2/8 | FAIL |
...
| `price_cluster` | -0.84% | -0.30 | 1.03 | 24 | 0/8 | FAIL |
...
|----------|-----------------------------------|
| `dema_cross` | profit_factor 1.40 < 1.5 (x1), mc_p_value 0.141 > 0.1 (우연 가능성) (x1), sharpe -1.36 < 1.0 (x1) |
...
| `price_cluster` | sharpe -4.21 < 1.0 (x1), profit_factor 0.41 < 1.5 (x1), mc_p_value 0.985 > 0.1 (우연 가능성) (x1) |
...
_Generated: 2026-06-25T15:25:35.012335Z_
_Symbol: ETH/USDT_
...
| 3 | `price_cluster` | -3.61% | -1.71 | 32.5% | 0.82 | 21 | 8.5% | 1/8 | FAIL |
| 4 | `dema_cross` | -4.26% | -1.26 | 32.0% | 0.86 | 41 | 9.8% | 0/8 | FAIL |
...
| Rank | Name | Score | Pctl | AvgSharpe | SharpeStd | AvgPF | AvgTrades | AvgMDD | Consist | Pass |
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `engulfing_zone` | 68.5 | p100 | 0.44 | 2.56 | 1.30 | 24 | 7.0% | 2/8 | FAIL |
| 2 | `frama` | 67.6 | p94 | 0.51 | 1.55 | 1.18 | 33 | 8.4% | 1/8 | FAIL |
| 3 | `volume_breakout` | 57.6 | p88 | -0.87 | 1.49 | 0.91 | 61 | 12.5% | 0/8 | FAIL |
| 4 | `lob_maker` | 49.5 | p83 | -0.90 | 1.82 | 0.92 | 58 | 15.6% | 0/8 | FAIL |
| 5 | `cmf` | 47.6 | p77 | -1.14 | 1.40 | 0.85 | 46 | 11.8% | 0/8 | FAIL |
| 6 | `order_flow_imbalance_v2` | 46.5 | p72 | -1.02 | 2.50 | 0.94 | 55 | 14.5% | 0/8 | FAIL |
| 7 | `volatility_cluster` | 44.8 | p66 | -1.49 | 1.44 | 0.81 | 42 | 9.4% | 0/8 | FAIL |
| 8 | `dema_cross` | 44.6 | p61 | -1.26 | 2.03 | 0.86 | 41 | 9.8% | 0/8 | FAIL |
| 9 | `relative_volume` | 44.4 | p55 | -1.53 | 2.34 | 0.87 | 54 | 12.7% | 0/8 | FAIL |
...
| 13 | `price_cluster` | 34.2 | p33 | -1.71 | 2.78 | 0.82 | 21 | 8.5% | 1/8 | FAIL |
...
| `price_cluster` | -3.61% | -1.71 | 0.82 | 21 | 1/8 | FAIL |
| `dema_cross` | -4.26% | -1.26 | 0.86 | 41 | 0/8 | FAIL |
...
| `price_cluster` | sharpe -4.52 < 1.0 (x1), profit_factor 0.32 < 1.5 (x1), mc_p_value 0.984 > 0.1 (우연 가능성) (x1) |
| `dema_cross` | profit_factor 0.80 < 1.5 (x2), sharpe 0.61 < 1.0 (x1), profit_factor 1.13 < 1.5 (x1) |
...
- **전체 19개 균등배분**: -5.84% -> $9,416
- **Top 5 균등배분**: -1.17% -> $9,883
...
_Generated: 2026-06-25T15:29:26.948633Z_
_Symbol: SOL/USDT_
...
| 3 | `price_cluster` | -0.81% | -0.19 | 37.0% | 0.99 | 18 | 5.4% | 0/8 | FAIL |
...
| 8 | `price_cluster` | 44.8 | p61 | -0.19 | 0.76 | 0.99 | 18 | 5.4% | 0/8 | FAIL |
...
| `price_cluster` | -0.81% | -0.19 | 0.99 | 18 | 0/8 | FAIL |
...
| `dema_cross` | -7.81% | -2.39 | 0.70 | 41 | 0/8 | FAIL |
...
| `price_cluster` | sharpe -0.99 < 1.0 (x1), profit_factor 0.80 < 1.5 (x1), mc_p_value 0.712 > 0.1 (우연 가능성) (x1) |
...
| `dema_cross` | sharpe -6.42 < 1.0 (x1), profit_factor 0.35 < 1.5 (x1), mc_p_value 0.998 > 0.1 (우연 가능성) (x1) |
...
- **전체 19개 균등배분**: -4.69% -> $9,531
- **Top 5 균등배분**: -0.02% -> $9,998
