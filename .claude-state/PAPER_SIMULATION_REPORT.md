...
_Generated: 2026-06-25T20:13:24.545186Z_
...
_Generated: 2026-06-25T20:17:28.771158Z_
_Symbol: BTC/USDT_
...
| 4 | `dema_cross` | +1.43% | 0.24 | 36.8% | 1.23 | 32 | 7.8% | 2/8 | FAIL |
...
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `price_cluster` | 70.0 | p100 | 0.87 | 1.10 | 1.20 | 41 | 9.8% | 1/8 | FAIL |
| 2 | `roc_ma_cross` | 67.1 | p94 | 0.34 | 2.44 | 1.22 | 36 | 8.1% | 2/8 | FAIL |
| 3 | `dema_cross` | 65.1 | p88 | 0.24 | 2.36 | 1.23 | 32 | 7.8% | 2/8 | FAIL |
| 4 | `frama` | 60.8 | p83 | 0.24 | 1.60 | 1.12 | 40 | 9.4% | 1/8 | FAIL |
| 5 | `lob_maker` | 56.3 | p77 | -0.04 | 1.99 | 1.05 | 75 | 17.0% | 0/8 | FAIL |
| 6 | `positional_scaling` | 48.9 | p72 | -0.38 | 2.82 | 1.09 | 34 | 9.2% | 1/8 | FAIL |
| 7 | `volume_breakout` | 47.9 | p66 | -0.74 | 2.18 | 0.96 | 72 | 15.4% | 0/8 | FAIL |
| 8 | `narrow_range` | 46.8 | p61 | -0.51 | 1.48 | 0.97 | 46 | 10.1% | 0/8 | FAIL |
| 9 | `order_flow_imbalance_v2` | 46.5 | p50 | -0.77 | 2.05 | 0.95 | 67 | 15.0% | 0/8 | FAIL |
| 10 | `price_action_momentum` | 46.5 | p55 | -1.08 | 2.79 | 0.97 | 73 | 16.7% | 1/8 | FAIL |
| 11 | `relative_volume` | 46.0 | p44 | -0.99 | 1.72 | 0.92 | 64 | 13.2% | 0/8 | FAIL |
| 12 | `momentum_quality` | 43.8 | p38 | -1.19 | 3.29 | 0.96 | 71 | 15.8% | 1/8 | FAIL |
| 13 | `acceleration_band` | 42.2 | p33 | -0.94 | 2.58 | 0.98 | 44 | 13.0% | 1/8 | FAIL |
| 14 | `htf_ema` | 42.1 | p27 | -0.72 | 0.71 | 0.91 | 43 | 11.2% | 0/8 | FAIL |
| 15 | `cmf` | 41.1 | p22 | -1.23 | 1.29 | 0.88 | 68 | 16.3% | 0/8 | FAIL |
...
| `dema_cross` | +1.43% | 0.24 | 1.23 | 32 | 2/8 | FAIL |
...
| `dema_cross` | sharpe 0.37 < 1.0 (x1), profit_factor 1.08 < 1.5 (x1), mc_p_value 0.423 > 0.1 (우연 가능성) (x1) |
...
_Generated: 2026-06-25T20:21:17.345975Z_
_Symbol: ETH/USDT_
...
| 13 | `dema_cross` | 25.6 | p33 | -2.45 | 1.57 | 0.64 | 28 | 9.0% | 0/8 | FAIL |
...
| `dema_cross` | -6.74% | -2.45 | 0.64 | 28 | 0/8 | FAIL |
...
| `dema_cross` | profit_factor 0.54 < 1.5 (x2), sharpe 0.69 < 1.0 (x1), profit_factor 1.18 < 1.5 (x1) |
