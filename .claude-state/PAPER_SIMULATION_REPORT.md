...
_Generated: 2026-07-01T20:30:32.661445Z_
...
_Generated: 2026-07-01T20:35:14.276827Z_
_Symbol: BTC/USDT_
...
|---|------|-----------|-----------|-------|-------|-----------|--------|-------------|------|
| 1 | `price_cluster` | +3.74% | 0.72 | 35.9% | 1.18 | 35 | 9.2% | 0/8 | FAIL |
| 2 | `dema_cross` | +3.08% | 0.85 | 39.4% | 1.38 | 26 | 6.1% | 2/8 | FAIL |
| 3 | `roc_ma_cross` | +2.44% | 0.72 | 41.4% | 1.68 | 10 | 2.9% | 0/8 | FAIL |
...
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `dema_cross` | 63.8 | p100 | 0.85 | 1.85 | 1.38 | 26 | 6.1% | 2/8 | FAIL |
| 2 | `frama` | 53.9 | p94 | 0.24 | 1.60 | 1.12 | 40 | 9.4% | 1/8 | FAIL |
| 3 | `price_cluster` | 53.3 | p88 | 0.72 | 0.83 | 1.18 | 35 | 9.2% | 0/8 | FAIL |
| 4 | `roc_ma_cross` | 51.7 | p83 | 0.72 | 1.90 | 1.68 | 10 | 2.9% | 0/8 | FAIL |
| 5 | `lob_maker` | 50.3 | p77 | -0.04 | 1.99 | 1.05 | 75 | 17.0% | 0/8 | FAIL |
| 6 | `positional_scaling` | 43.2 | p72 | -0.38 | 2.82 | 1.09 | 34 | 9.2% | 1/8 | FAIL |
| 7 | `volume_breakout` | 42.6 | p66 | -0.74 | 2.18 | 0.96 | 72 | 15.4% | 0/8 | FAIL |
| 8 | `narrow_range` | 41.7 | p55 | -0.51 | 1.48 | 0.97 | 46 | 10.1% | 0/8 | FAIL |
| 9 | `price_action_momentum` | 41.7 | p61 | -1.08 | 2.79 | 0.97 | 73 | 16.7% | 1/8 | FAIL |
| 10 | `order_flow_imbalance_v2` | 41.5 | p50 | -0.77 | 2.05 | 0.95 | 67 | 15.0% | 0/8 | FAIL |
| 11 | `relative_volume` | 40.9 | p44 | -0.99 | 1.72 | 0.92 | 64 | 13.2% | 0/8 | FAIL |
| 12 | `momentum_quality` | 38.9 | p38 | -1.19 | 3.29 | 0.96 | 71 | 15.8% | 1/8 | FAIL |
| 13 | `htf_ema` | 38.6 | p33 | -0.72 | 0.71 | 0.91 | 43 | 11.2% | 0/8 | FAIL |
| 14 | `acceleration_band` | 38.1 | p27 | -0.94 | 2.58 | 0.98 | 44 | 13.0% | 1/8 | FAIL |
| 15 | `cmf` | 37.8 | p22 | -1.23 | 1.29 | 0.88 | 68 | 16.3% | 0/8 | FAIL |

## 전체 결과

| Name | AvgReturn | AvgSharpe | AvgPF | AvgTrades | Consistency | Pass |
|------|-----------|-----------|-------|-----------|-------------|------|
| `price_cluster` | +3.74% | 0.72 | 1.18 | 35 | 0/8 | FAIL |
| `dema_cross` | +3.08% | 0.85 | 1.38 | 26 | 2/8 | FAIL |
| `roc_ma_cross` | +2.44% | 0.72 | 1.68 | 10 | 0/8 | FAIL |
...
|----------|-----------------------------------|
| `price_cluster` | sharpe -0.10 < 1.0 (x1), profit_factor 1.00 < 1.5 (x1), mc_p_value 0.510 > 0.1 (우연 가능성) (x1) |
| `dema_cross` | sharpe 0.63 < 1.0 (x1), profit_factor 1.14 < 1.5 (x1), mc_p_value 0.366 > 0.1 (우연 가능성) (x1) |
| `roc_ma_cross` | trades 11 < 15 (x2), trades 9 < 15 (x2), sharpe -0.23 < 1.0 (x1) |
...
- **전체 19개 균등배분**: -2.69% -> $9,731
- **Top 5 균등배분**: +2.22% -> $10,222
...
_Generated: 2026-07-01T20:39:43.808730Z_
_Symbol: ETH/USDT_
...
| 3 | `roc_ma_cross` | +0.23% | 0.08 | 40.6% | 1.31 | 7 | 3.2% | 0/8 | FAIL |
| 4 | `price_cluster` | -1.85% | -0.95 | 35.6% | 0.96 | 24 | 9.6% | 0/8 | FAIL |
...
| 3 | `volume_breakout` | 56.2 | p88 | -0.87 | 1.49 | 0.91 | 61 | 12.5% | 0/8 | FAIL |
| 4 | `roc_ma_cross` | 49.5 | p83 | 0.08 | 1.36 | 1.31 | 7 | 3.2% | 0/8 | FAIL |
| 5 | `lob_maker` | 49.4 | p77 | -0.90 | 1.82 | 0.92 | 58 | 15.6% | 0/8 | FAIL |
| 6 | `cmf` | 47.1 | p72 | -1.14 | 1.40 | 0.85 | 46 | 11.8% | 0/8 | FAIL |
| 7 | `order_flow_imbalance_v2` | 46.1 | p66 | -1.02 | 2.50 | 0.94 | 55 | 14.5% | 0/8 | FAIL |
| 8 | `volatility_cluster` | 43.9 | p61 | -1.49 | 1.44 | 0.81 | 42 | 9.4% | 0/8 | FAIL |
| 9 | `relative_volume` | 43.4 | p55 | -1.53 | 2.34 | 0.87 | 54 | 12.7% | 0/8 | FAIL |
| 10 | `elder_impulse` | 39.9 | p50 | -1.60 | 0.86 | 0.76 | 36 | 10.7% | 0/8 | FAIL |
| 11 | `momentum_quality` | 39.4 | p44 | -2.48 | 0.88 | 0.71 | 58 | 14.5% | 0/8 | FAIL |
| 12 | `price_cluster` | 39.1 | p38 | -0.95 | 2.72 | 0.96 | 24 | 9.6% | 0/8 | FAIL |
| 13 | `price_action_momentum` | 35.3 | p33 | -2.32 | 1.51 | 0.71 | 48 | 12.6% | 0/8 | FAIL |
| 14 | `linear_channel_rev` | 24.6 | p27 | -2.33 | 1.19 | 0.60 | 23 | 7.9% | 0/8 | FAIL |
| 15 | `htf_ema` | 22.0 | p22 | -2.83 | 0.81 | 0.56 | 29 | 12.1% | 0/8 | FAIL |
...
| `roc_ma_cross` | +0.23% | 0.08 | 1.31 | 7 | 0/8 | FAIL |
| `price_cluster` | -1.85% | -0.95 | 0.96 | 24 | 0/8 | FAIL |
...
| `roc_ma_cross` | trades 5 < 15 (x2), trades 10 < 15 (x2), trades 7 < 15 (x2) |
| `price_cluster` | sharpe -4.36 < 1.0 (x1), profit_factor 0.34 < 1.5 (x1), mc_p_value 0.980 > 0.1 (우연 가능성) (x1) |
...
- **전체 19개 균등배분**: -5.30% -> $9,470
- **Top 5 균등배분**: +0.08% -> $10,008
...
_Generated: 2026-07-01T20:44:00.193815Z_
_Symbol: SOL/USDT_
...
| 6 | `roc_ma_cross` | -3.85% | -2.64 | 25.9% | 0.39 | 9 | 5.0% | 0/8 | FAIL |
...
| Rank | Name | Score | Pctl | AvgSharpe | SharpeStd | AvgPF | AvgTrades | AvgMDD | Consist | Pass |
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `engulfing_zone` | 72.1 | p100 | 0.78 | 2.10 | 1.33 | 26 | 7.0% | 1/8 | FAIL |
| 2 | `volatility_cluster` | 58.2 | p94 | -0.12 | 1.16 | 1.02 | 41 | 8.7% | 0/8 | FAIL |
| 3 | `lob_maker` | 54.1 | p88 | -0.73 | 0.95 | 0.90 | 56 | 13.0% | 0/8 | FAIL |
| 4 | `momentum_quality` | 52.9 | p83 | -1.18 | 0.96 | 0.85 | 56 | 10.5% | 0/8 | FAIL |
| 5 | `relative_volume` | 52.4 | p77 | -0.61 | 2.05 | 0.97 | 50 | 10.7% | 0/8 | FAIL |
| 6 | `order_flow_imbalance_v2` | 50.4 | p72 | -1.22 | 0.78 | 0.84 | 55 | 12.0% | 0/8 | FAIL |
| 7 | `cmf` | 45.2 | p66 | -1.28 | 0.94 | 0.82 | 44 | 10.3% | 0/8 | FAIL |
| 8 | `volume_breakout` | 44.3 | p61 | -1.45 | 1.33 | 0.82 | 58 | 14.2% | 0/8 | FAIL |
| 9 | `positional_scaling` | 39.0 | p55 | -1.12 | 2.17 | 0.87 | 32 | 8.8% | 0/8 | FAIL |
| 10 | `elder_impulse` | 38.6 | p50 | -1.91 | 3.14 | 0.82 | 36 | 11.6% | 1/8 | FAIL |
| 11 | `price_action_momentum` | 38.2 | p44 | -1.88 | 0.97 | 0.75 | 47 | 12.3% | 0/8 | FAIL |
| 12 | `acceleration_band` | 34.9 | p38 | -0.80 | 1.82 | 1.00 | 11 | 4.7% | 0/8 | FAIL |
| 13 | `htf_ema` | 34.4 | p33 | -1.45 | 1.94 | 0.80 | 30 | 9.0% | 0/8 | FAIL |
| 14 | `frama` | 31.9 | p27 | -1.94 | 1.83 | 0.74 | 42 | 12.6% | 0/8 | FAIL |
| 15 | `dema_cross` | 29.6 | p22 | -1.89 | 1.75 | 0.72 | 29 | 8.4% | 0/8 | FAIL |
...
| `roc_ma_cross` | -3.85% | -2.64 | 0.39 | 9 | 0/8 | FAIL |
...
| `price_cluster` | -10.44% | -3.00 | 0.54 | 27 | 0/8 | FAIL |
...
| `roc_ma_cross` | trades 7 < 15 (x3), trades 8 < 15 (x2), profit_factor 0.50 < 1.5 (x2) |
...
| `price_cluster` | sharpe -4.42 < 1.0 (x1), profit_factor 0.37 < 1.5 (x1), mc_p_value 0.980 > 0.1 (우연 가능성) (x1) |
