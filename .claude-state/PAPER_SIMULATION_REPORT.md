...
_Generated: 2026-06-26T20:11:15.132588Z_
...
_Generated: 2026-06-26T20:17:10.842963Z_
_Symbol: BTC/USDT_
...
|---|------|-----------|-----------|-------|-------|-----------|--------|-------------|------|
| 1 | `price_cluster` | +3.91% | 0.72 | 35.9% | 1.15 | 45 | 10.2% | 0/8 | FAIL |
| 2 | `roc_ma_cross` | +2.86% | 0.34 | 36.2% | 1.22 | 36 | 8.1% | 2/8 | FAIL |
| 3 | `dema_cross` | +1.74% | 0.37 | 37.5% | 1.26 | 31 | 7.5% | 2/8 | FAIL |
...
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `roc_ma_cross` | 67.0 | p100 | 0.34 | 2.44 | 1.22 | 36 | 8.1% | 2/8 | FAIL |
| 2 | `dema_cross` | 66.7 | p94 | 0.37 | 2.32 | 1.26 | 31 | 7.5% | 2/8 | FAIL |
| 3 | `price_cluster` | 64.9 | p88 | 0.72 | 0.69 | 1.15 | 45 | 10.2% | 0/8 | FAIL |
| 4 | `frama` | 60.8 | p83 | 0.24 | 1.60 | 1.12 | 40 | 9.4% | 1/8 | FAIL |
| 5 | `lob_maker` | 56.5 | p77 | -0.04 | 1.99 | 1.05 | 75 | 17.0% | 0/8 | FAIL |
| 6 | `positional_scaling` | 48.8 | p72 | -0.38 | 2.82 | 1.09 | 34 | 9.2% | 1/8 | FAIL |
| 7 | `volume_breakout` | 48.0 | p66 | -0.74 | 2.18 | 0.96 | 72 | 15.4% | 0/8 | FAIL |
| 8 | `narrow_range` | 46.8 | p61 | -0.51 | 1.48 | 0.97 | 46 | 10.1% | 0/8 | FAIL |
| 9 | `order_flow_imbalance_v2` | 46.6 | p55 | -0.77 | 2.05 | 0.95 | 67 | 15.0% | 0/8 | FAIL |
| 10 | `price_action_momentum` | 46.5 | p50 | -1.08 | 2.79 | 0.97 | 73 | 16.7% | 1/8 | FAIL |
| 11 | `relative_volume` | 46.0 | p44 | -0.99 | 1.72 | 0.92 | 64 | 13.2% | 0/8 | FAIL |
| 12 | `momentum_quality` | 43.8 | p38 | -1.19 | 3.29 | 0.96 | 71 | 15.8% | 1/8 | FAIL |
| 13 | `htf_ema` | 42.2 | p33 | -0.72 | 0.71 | 0.91 | 43 | 11.2% | 0/8 | FAIL |
| 14 | `acceleration_band` | 42.1 | p27 | -0.94 | 2.58 | 0.98 | 44 | 13.0% | 1/8 | FAIL |
...
|------|-----------|-----------|-------|-----------|-------------|------|
| `price_cluster` | +3.91% | 0.72 | 1.15 | 45 | 0/8 | FAIL |
...
|----------|-----------------------------------|
| `price_cluster` | sharpe 0.50 < 1.0 (x1), profit_factor 1.11 < 1.5 (x1), mc_p_value 0.377 > 0.1 (우연 가능성) (x1) |
...
- **전체 19개 균등배분**: -2.73% -> $9,727
- **Top 5 균등배분**: +2.07% -> $10,208
...
_Generated: 2026-06-26T20:22:37.675977Z_
_Symbol: ETH/USDT_
...
| 3 | `price_cluster` | -0.69% | -0.44 | 36.1% | 1.03 | 36 | 10.2% | 2/8 | FAIL |
...
| 10 | `dema_cross` | -5.67% | -2.07 | 28.0% | 0.69 | 27 | 8.4% | 0/8 | FAIL |
...
| 3 | `price_cluster` | 59.7 | p88 | -0.44 | 2.31 | 1.03 | 36 | 10.2% | 2/8 | FAIL |
| 4 | `volume_breakout` | 57.1 | p83 | -0.87 | 1.49 | 0.91 | 61 | 12.5% | 0/8 | FAIL |
| 5 | `lob_maker` | 48.9 | p77 | -0.90 | 1.82 | 0.92 | 58 | 15.6% | 0/8 | FAIL |
| 6 | `cmf` | 47.4 | p72 | -1.14 | 1.40 | 0.85 | 46 | 11.8% | 0/8 | FAIL |
| 7 | `order_flow_imbalance_v2` | 45.6 | p66 | -1.02 | 2.50 | 0.94 | 55 | 14.5% | 0/8 | FAIL |
| 8 | `volatility_cluster` | 44.5 | p61 | -1.49 | 1.44 | 0.81 | 42 | 9.4% | 0/8 | FAIL |
| 9 | `relative_volume` | 43.5 | p55 | -1.53 | 2.34 | 0.87 | 54 | 12.7% | 0/8 | FAIL |
| 10 | `elder_impulse` | 40.1 | p50 | -1.60 | 0.86 | 0.76 | 36 | 10.7% | 0/8 | FAIL |
| 11 | `momentum_quality` | 39.6 | p44 | -2.48 | 0.88 | 0.71 | 58 | 14.5% | 0/8 | FAIL |
| 12 | `price_action_momentum` | 35.4 | p38 | -2.32 | 1.51 | 0.71 | 48 | 12.6% | 0/8 | FAIL |
...
| `price_cluster` | -0.69% | -0.44 | 1.03 | 36 | 2/8 | FAIL |
...
| `price_cluster` | sharpe -3.56 < 1.0 (x1), profit_factor 0.49 < 1.5 (x1), mc_p_value 0.966 > 0.1 (우연 가능성) (x1) |
...
- **전체 19개 균등배분**: -5.76% -> $9,424
- **Top 5 균등배분**: -0.62% -> $9,938
...
_Generated: 2026-06-26T20:27:50.030641Z_
_Symbol: SOL/USDT_
...
| 12 | `price_cluster` | 38.0 | p38 | -1.38 | 1.38 | 0.79 | 36 | 10.9% | 0/8 | FAIL |
...
| `price_cluster` | -5.52% | -1.38 | 0.79 | 36 | 0/8 | FAIL |
...
| `price_cluster` | sharpe 0.85 < 1.0 (x1), profit_factor 1.16 < 1.5 (x1), mc_p_value 0.326 > 0.1 (우연 가능성) (x1) |
