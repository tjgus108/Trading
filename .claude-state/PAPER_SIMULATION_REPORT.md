...
_Generated: 2026-06-10T10:23:12.356616Z_
_Symbols: BTC/USDT_
...
_Generated: 2026-06-10T10:24:50.907765Z_
_Symbol: BTC/USDT_
...
|---|------|-----------|-----------|-------|-------|-----------|--------|-------------|------|
| 1 | `momentum_quality` | +5.30% | 2.12 | 41.4% | 1.41 | 22 | 5.0% | 1/8 | FAIL |
| 2 | `supertrend_multi` | +4.15% | 2.14 | 30.4% | 1.22 | 8 | 2.6% | 1/8 | FAIL |
| 3 | `relative_volume` | +3.21% | 1.94 | 41.7% | 1.53 | 15 | 4.2% | 0/8 | FAIL |
...
| 9 | `htf_ema` | +1.11% | -0.17 | 38.3% | 1.22 | 14 | 5.4% | 1/8 | FAIL |
| 10 | `price_cluster` | +1.10% | 0.35 | 37.3% | 1.25 | 11 | 5.5% | 0/8 | FAIL |
...
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `momentum_quality` | 78.7 | p100 | 2.12 | 3.31 | 1.41 | 22 | 5.0% | 1/8 | FAIL |
| 2 | `cmf` | 71.3 | p95 | 1.25 | 2.69 | 1.24 | 23 | 6.3% | 1/8 | FAIL |
| 3 | `lob_maker` | 67.0 | p90 | 1.18 | 3.25 | 1.32 | 21 | 6.8% | 1/8 | FAIL |
| 4 | `relative_volume` | 61.8 | p85 | 1.94 | 2.73 | 1.53 | 15 | 4.2% | 0/8 | FAIL |
| 5 | `supertrend_multi` | 57.9 | p80 | 2.14 | 2.92 | 1.22 | 8 | 2.6% | 1/8 | FAIL |
| 6 | `value_area` | 55.0 | p76 | 1.47 | 2.42 | 1.42 | 12 | 3.0% | 0/8 | FAIL |
| 7 | `linear_channel_rev` | 51.9 | p71 | 1.39 | 3.29 | 2.12 | 6 | 2.2% | 0/8 | FAIL |
| 8 | `htf_ema` | 50.6 | p66 | -0.17 | 3.81 | 1.22 | 14 | 5.4% | 1/8 | FAIL |
| 9 | `price_action_momentum` | 47.6 | p61 | -1.00 | 5.77 | 1.11 | 24 | 7.9% | 1/8 | FAIL |
| 10 | `order_flow_imbalance_v2` | 46.1 | p57 | 0.26 | 5.37 | 1.34 | 20 | 7.1% | 0/8 | FAIL |
| 11 | `price_cluster` | 40.3 | p52 | 0.35 | 3.45 | 1.25 | 11 | 5.5% | 0/8 | FAIL |
| 12 | `wick_reversal` | 38.1 | p47 | -0.84 | 4.36 | 1.17 | 16 | 5.6% | 0/8 | FAIL |
| 13 | `positional_scaling` | 35.9 | p42 | -0.97 | 5.83 | 1.75 | 10 | 4.9% | 0/8 | FAIL |
| 14 | `elder_impulse` | 35.3 | p38 | -0.93 | 5.99 | 1.58 | 14 | 7.3% | 0/8 | FAIL |
| 15 | `volatility_cluster` | 32.1 | p33 | -1.31 | 5.16 | 1.14 | 14 | 5.3% | 0/8 | FAIL |

## 전체 결과

| Name | AvgReturn | AvgSharpe | AvgPF | AvgTrades | Consistency | Pass |
|------|-----------|-----------|-------|-----------|-------------|------|
| `momentum_quality` | +5.30% | 2.12 | 1.41 | 22 | 1/8 | FAIL |
| `supertrend_multi` | +4.15% | 2.14 | 1.22 | 8 | 1/8 | FAIL |
| `relative_volume` | +3.21% | 1.94 | 1.53 | 15 | 0/8 | FAIL |
...
| `htf_ema` | +1.11% | -0.17 | 1.22 | 14 | 1/8 | FAIL |
| `price_cluster` | +1.10% | 0.35 | 1.25 | 11 | 0/8 | FAIL |
...
| `wick_reversal` | -1.04% | -0.84 | 1.17 | 16 | 0/8 | FAIL |
...
|----------|-----------------------------------|
| `momentum_quality` | profit_factor 1.44 < 1.5 (x1), mc_p_value 0.185 > 0.05 (우연 가능성) (x1), sharpe -1.42 < 1.0 (x1) |
| `supertrend_multi` | no trades generated (x3), trades 13 < 15 (x1), trades 12 < 15 (x1) |
| `relative_volume` | trades 10 < 15 (x1), mc_p_value 0.062 > 0.05 (우연 가능성) (x1), sharpe 0.18 < 1.0 (x1) |
...
| `htf_ema` | trades 13 < 15 (x2), mc_p_value 0.200 > 0.05 (우연 가능성) (x1), sharpe -2.75 < 1.0 (x1) |
| `price_cluster` | profit_factor 0.90 < 1.5 (x2), trades 11 < 15 (x2), trades 6 < 15 (x1) |
...
| `wick_reversal` | trades 14 < 15 (x2), mc_p_value 0.132 > 0.05 (우연 가능성) (x1), sharpe 0.77 < 1.0 (x1) |
