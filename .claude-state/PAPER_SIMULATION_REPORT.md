...
_Generated: 2026-06-19T15:09:28.943700Z_
_Symbols: BTC/USDT_
...
_Generated: 2026-06-19T15:14:56.135961Z_
_Symbol: BTC/USDT_
...
| 2 | `roc_ma_cross` | 64.8 | p94 | -0.41 | 2.83 | 1.10 | 40 | 9.8% | 2/8 | FAIL |
| 3 | `positional_scaling` | 63.6 | p89 | 0.00 | 2.87 | 1.18 | 36 | 9.7% | 1/8 | FAIL |
| 4 | `volume_breakout` | 61.6 | p84 | -0.44 | 2.41 | 1.01 | 78 | 15.8% | 0/8 | FAIL |
| 5 | `price_action_momentum` | 59.7 | p78 | -0.88 | 3.03 | 1.01 | 82 | 17.8% | 1/8 | FAIL |
...
| 10 | `lob_maker` | 56.4 | p52 | -0.91 | 1.91 | 0.94 | 84 | 19.7% | 0/8 | FAIL |
| 11 | `order_flow_imbalance_v2` | 54.1 | p47 | -1.03 | 2.13 | 0.93 | 82 | 19.8% | 0/8 | FAIL |
| 12 | `momentum_quality` | 52.2 | p42 | -1.31 | 3.52 | 0.96 | 77 | 18.1% | 1/8 | FAIL |
| 13 | `relative_volume` | 51.4 | p36 | -1.44 | 1.68 | 0.87 | 72 | 15.3% | 0/8 | FAIL |
...
| `order_flow_imbalance_v2` | -7.36% | -1.03 | 0.93 | 82 | 0/8 | FAIL |
...
| `order_flow_imbalance_v2` | sharpe -0.52 < 1.0 (x1), profit_factor 0.96 < 1.5 (x1), mc_p_value 0.572 > 0.1 (우연 가능성) (x1) |
...
| `order_flow_imbalance_v2` | 0 | 556 | 104 | 15.8% |
| `cmf` | 0 | 486 | 90 | 15.6% |
