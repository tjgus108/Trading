...
_Generated: 2026-06-27T05:08:01.021532Z_
...
_Generated: 2026-06-27T05:12:05.502065Z_
_Symbol: BTC/USDT_
...
| 2 | `frama` | +1.60% | 0.24 | 35.2% | 1.12 | 40 | 9.4% | 1/8 | FAIL |
| 3 | `dema_cross` | +1.18% | 0.40 | 41.6% | 1.45 | 18 | 5.4% | 0/8 | FAIL |
| 4 | `price_cluster` | +0.85% | 0.07 | 32.4% | 1.07 | 45 | 11.5% | 0/8 | FAIL |
...
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `roc_ma_cross` | 65.6 | p100 | 0.34 | 2.44 | 1.22 | 36 | 8.1% | 2/8 | FAIL |
| 2 | `frama` | 59.9 | p94 | 0.24 | 1.60 | 1.12 | 40 | 9.4% | 1/8 | FAIL |
| 3 | `lob_maker` | 55.9 | p88 | -0.04 | 1.99 | 1.05 | 75 | 17.0% | 0/8 | FAIL |
| 4 | `dema_cross` | 54.7 | p83 | 0.40 | 2.25 | 1.45 | 18 | 5.4% | 0/8 | FAIL |
| 5 | `price_cluster` | 52.5 | p77 | 0.07 | 1.67 | 1.07 | 45 | 11.5% | 0/8 | FAIL |
| 6 | `positional_scaling` | 47.9 | p72 | -0.38 | 2.82 | 1.09 | 34 | 9.2% | 1/8 | FAIL |
| 7 | `volume_breakout` | 47.1 | p66 | -0.74 | 2.18 | 0.96 | 72 | 15.4% | 0/8 | FAIL |
| 8 | `narrow_range` | 46.2 | p61 | -0.51 | 1.48 | 0.97 | 46 | 10.1% | 0/8 | FAIL |
| 9 | `order_flow_imbalance_v2` | 45.8 | p55 | -0.77 | 2.05 | 0.95 | 67 | 15.0% | 0/8 | FAIL |
| 10 | `price_action_momentum` | 45.5 | p50 | -1.08 | 2.79 | 0.97 | 73 | 16.7% | 1/8 | FAIL |
| 11 | `relative_volume` | 45.0 | p44 | -0.99 | 1.72 | 0.92 | 64 | 13.2% | 0/8 | FAIL |
| 12 | `momentum_quality` | 42.6 | p38 | -1.19 | 3.29 | 0.96 | 71 | 15.8% | 1/8 | FAIL |
| 13 | `htf_ema` | 42.2 | p33 | -0.72 | 0.71 | 0.91 | 43 | 11.2% | 0/8 | FAIL |
| 14 | `acceleration_band` | 41.6 | p27 | -0.94 | 2.58 | 0.98 | 44 | 13.0% | 1/8 | FAIL |
| 15 | `cmf` | 40.9 | p22 | -1.23 | 1.29 | 0.88 | 68 | 16.3% | 0/8 | FAIL |
...
| `dema_cross` | +1.18% | 0.40 | 1.45 | 18 | 0/8 | FAIL |
| `price_cluster` | +0.85% | 0.07 | 1.07 | 45 | 0/8 | FAIL |
...
| `dema_cross` | trades 14 < 15 (x2), sharpe -0.88 < 1.0 (x1), profit_factor 0.85 < 1.5 (x1) |
| `price_cluster` | sharpe -1.82 < 1.0 (x1), profit_factor 0.75 < 1.5 (x1), mc_p_value 0.830 > 0.1 (우연 가능성) (x1) |
...
- **전체 19개 균등배분**: -2.92% -> $9,708
- **Top 5 균등배분**: +1.35% -> $10,135
...
_Generated: 2026-06-27T05:15:55.156043Z_
_Symbol: ETH/USDT_
...
| 9 | `dema_cross` | -5.51% | -2.66 | 22.7% | 0.54 | 18 | 7.2% | 0/8 | FAIL |
...
| 12 | `linear_channel_rev` | 24.2 | p38 | -2.33 | 1.19 | 0.60 | 23 | 7.9% | 0/8 | FAIL |
| 13 | `htf_ema` | 21.4 | p33 | -2.83 | 0.81 | 0.56 | 29 | 12.1% | 0/8 | FAIL |
| 14 | `acceleration_band` | 19.7 | p27 | -2.03 | 1.23 | 0.57 | 13 | 6.0% | 0/8 | FAIL |
| 15 | `price_cluster` | 19.1 | p22 | -3.09 | 1.32 | 0.57 | 34 | 13.9% | 0/8 | FAIL |
...
| `dema_cross` | -5.51% | -2.66 | 0.54 | 18 | 0/8 | FAIL |
...
| `price_cluster` | -11.40% | -3.09 | 0.57 | 34 | 0/8 | FAIL |
...
| `dema_cross` | sharpe -1.63 < 1.0 (x1), profit_factor 0.65 < 1.5 (x1), mc_p_value 0.790 > 0.1 (우연 가능성) (x1) |
...
| `price_cluster` | sharpe -5.13 < 1.0 (x1), profit_factor 0.34 < 1.5 (x1), mc_p_value 0.993 > 0.1 (우연 가능성) (x1) |
...
_Generated: 2026-06-27T05:19:32.868609Z_
_Symbol: SOL/USDT_
...
| 2 | `price_cluster` | +0.29% | 0.05 | 35.8% | 1.05 | 28 | 8.6% | 0/8 | FAIL |
...
| 10 | `dema_cross` | -5.28% | -2.23 | 27.5% | 0.63 | 22 | 7.6% | 0/8 | FAIL |
...
| 6 | `price_cluster` | 51.6 | p72 | 0.05 | 1.17 | 1.05 | 28 | 8.6% | 0/8 | FAIL |
| 7 | `order_flow_imbalance_v2` | 50.2 | p66 | -1.22 | 0.78 | 0.84 | 55 | 12.0% | 0/8 | FAIL |
| 8 | `cmf` | 45.1 | p61 | -1.28 | 0.94 | 0.82 | 44 | 10.3% | 0/8 | FAIL |
| 9 | `volume_breakout` | 44.5 | p55 | -1.45 | 1.33 | 0.82 | 58 | 14.2% | 0/8 | FAIL |
...
| `price_cluster` | +0.29% | 0.05 | 1.05 | 28 | 0/8 | FAIL |
...
| `dema_cross` | -5.28% | -2.23 | 0.63 | 22 | 0/8 | FAIL |
...
| `price_cluster` | sharpe -0.06 < 1.0 (x1), profit_factor 0.99 < 1.5 (x1), mc_p_value 0.520 > 0.1 (우연 가능성) (x1) |
...
| `dema_cross` | sharpe -2.48 < 1.0 (x1), profit_factor 0.60 < 1.5 (x1), mc_p_value 0.877 > 0.1 (우연 가능성) (x1) |
...
- **전체 19개 균등배분**: -4.50% -> $9,550
- **Top 5 균등배분**: +0.20% -> $10,020
