...
_Generated: 2026-06-06T05:23:36.259300Z_
...
_Generated: 2026-06-06T05:29:16.220022Z_
_Symbol: BTC/USDT_
...
_Generated: 2026-06-06T05:34:58.722669Z_
_Symbol: ETH/USDT_
...
| Rank | Name | Score | Pctl | AvgSharpe | SharpeStd | AvgPF | AvgTrades | AvgMDD | Consist | Pass |
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `momentum_quality` | 66.1 | p100 | 0.73 | 1.60 | 1.17 | 63 | 10.4% | 0/8 | FAIL |
| 2 | `volatility_cluster` | 58.8 | p95 | 0.27 | 1.39 | 1.09 | 51 | 9.1% | 0/8 | FAIL |
| 3 | `price_action_momentum` | 57.4 | p90 | 0.20 | 1.39 | 1.08 | 51 | 10.8% | 0/8 | FAIL |
| 4 | `narrow_range` | 55.8 | p85 | 0.01 | 1.59 | 1.06 | 51 | 10.9% | 0/8 | FAIL |
| 5 | `dema_cross` | 55.6 | p80 | 0.81 | 2.05 | 1.72 | 14 | 3.4% | 0/8 | FAIL |
| 6 | `engulfing_zone` | 46.3 | p76 | -1.30 | 3.43 | 0.98 | 27 | 10.2% | 1/8 | FAIL |
| 7 | `cmf` | 45.9 | p71 | -1.16 | 2.20 | 0.89 | 60 | 16.3% | 0/8 | FAIL |
| 8 | `lob_maker` | 44.1 | p66 | -1.70 | 1.35 | 0.81 | 70 | 20.7% | 0/8 | FAIL |
| 9 | `elder_impulse` | 42.4 | p61 | -1.29 | 1.75 | 0.85 | 46 | 12.2% | 0/8 | FAIL |
| 10 | `roc_ma_cross` | 41.5 | p57 | -1.02 | 1.10 | 0.85 | 34 | 9.7% | 0/8 | FAIL |
| 11 | `volume_breakout` | 40.9 | p52 | -2.25 | 1.91 | 0.78 | 79 | 21.4% | 0/8 | FAIL |
| 12 | `value_area` | 40.6 | p47 | -1.58 | 1.67 | 0.81 | 46 | 11.5% | 0/8 | FAIL |
| 13 | `linear_channel_rev` | 39.3 | p42 | -1.08 | 0.74 | 0.81 | 28 | 6.8% | 0/8 | FAIL |
| 14 | `relative_volume` | 38.8 | p38 | -2.34 | 1.53 | 0.74 | 60 | 15.1% | 0/8 | FAIL |
| 15 | `htf_ema` | 37.1 | p33 | -1.37 | 1.72 | 0.80 | 31 | 9.9% | 0/8 | FAIL |
...
| `supertrend_multi` | -20.49% | -4.01 | 0.62 | 74 | 0/8 | FAIL |
...
_Generated: 2026-06-06T05:40:23.872310Z_
_Symbol: SOL/USDT_
...
| 15 | `cmf` | 36.4 | p33 | -2.19 | 1.72 | 0.73 | 57 | 16.4% | 0/8 | FAIL |
...
| `supertrend_multi` | -12.94% | -3.07 | 0.61 | 52 | 0/8 | FAIL |
...
| `positional_scaling` | sharpe -3.06 < 1.0 (x1), profit_factor 0.56 < 1.5 (x1), mc_p_value 0.929 > 0.05 (우연 가능성) (x1) |
