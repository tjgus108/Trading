...
_Generated: 2026-06-12T20:15:36.712198Z_
_Symbols: BTC/USDT_
...
_Generated: 2026-06-12T20:21:24.112030Z_
_Symbol: BTC/USDT_
...
| 2 | `price_cluster` | +3.19% | 0.53 | 39.2% | 1.12 | 50 | 11.6% | 0/8 | FAIL |
...
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `supertrend_multi` | 72.1 | p100 | 0.32 | 2.82 | 1.14 | 48 | 10.6% | 2/8 | FAIL |
| 2 | `price_cluster` | 67.3 | p95 | 0.53 | 1.07 | 1.12 | 50 | 11.6% | 0/8 | FAIL |
| 3 | `roc_ma_cross` | 64.5 | p90 | -0.35 | 2.88 | 1.12 | 40 | 9.6% | 2/8 | FAIL |
| 4 | `positional_scaling` | 62.3 | p85 | 0.00 | 2.87 | 1.18 | 36 | 9.7% | 1/8 | FAIL |
| 5 | `volume_breakout` | 60.4 | p80 | -0.44 | 2.41 | 1.01 | 78 | 15.8% | 0/8 | FAIL |
| 6 | `price_action_momentum` | 58.6 | p76 | -0.88 | 3.03 | 1.01 | 82 | 17.8% | 1/8 | FAIL |
| 7 | `frama` | 56.7 | p71 | -0.22 | 1.40 | 1.02 | 42 | 9.8% | 0/8 | FAIL |
| 8 | `narrow_range` | 56.7 | p66 | -0.42 | 1.39 | 0.99 | 50 | 11.6% | 0/8 | FAIL |
| 9 | `acceleration_band` | 56.2 | p61 | -0.63 | 2.20 | 1.00 | 45 | 12.8% | 1/8 | FAIL |
| 10 | `htf_ema` | 55.9 | p57 | -0.35 | 1.14 | 0.98 | 45 | 11.4% | 0/8 | FAIL |
| 11 | `order_flow_imbalance_v2` | 55.6 | p52 | -0.83 | 2.13 | 0.95 | 73 | 15.8% | 0/8 | FAIL |
| 12 | `lob_maker` | 55.2 | p47 | -0.91 | 1.91 | 0.94 | 84 | 19.7% | 0/8 | FAIL |
| 13 | `momentum_quality` | 51.3 | p42 | -1.31 | 3.52 | 0.96 | 77 | 18.1% | 1/8 | FAIL |
| 14 | `relative_volume` | 50.4 | p38 | -1.44 | 1.68 | 0.87 | 72 | 15.3% | 0/8 | FAIL |
| 15 | `cmf` | 48.9 | p33 | -1.44 | 1.81 | 0.87 | 75 | 18.4% | 0/8 | FAIL |
...
| `price_cluster` | +3.19% | 0.53 | 1.12 | 50 | 0/8 | FAIL |
...
| `price_cluster` | sharpe 0.02 < 1.0 (x1), profit_factor 1.02 < 1.5 (x1), mc_p_value 0.478 > 0.1 (우연 가능성) (x1) |
