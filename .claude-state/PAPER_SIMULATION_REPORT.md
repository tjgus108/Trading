...
_Generated: 2026-06-29T06:05:30.922593Z_
...
_Generated: 2026-06-29T06:11:28.944509Z_
_Symbol: BTC/USDT_
...
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `price_cluster` | 70.8 | p100 | 0.87 | 1.10 | 1.20 | 41 | 9.8% | 1/8 | FAIL |
| 2 | `roc_ma_cross` | 68.1 | p94 | 0.34 | 2.44 | 1.22 | 36 | 8.1% | 2/8 | FAIL |
| 3 | `frama` | 61.6 | p88 | 0.24 | 1.60 | 1.12 | 40 | 9.4% | 1/8 | FAIL |
| 4 | `lob_maker` | 57.0 | p83 | -0.04 | 1.99 | 1.05 | 75 | 17.0% | 0/8 | FAIL |
| 5 | `positional_scaling` | 49.8 | p77 | -0.38 | 2.82 | 1.09 | 34 | 9.2% | 1/8 | FAIL |
| 6 | `volume_breakout` | 48.7 | p72 | -0.74 | 2.18 | 0.96 | 72 | 15.4% | 0/8 | FAIL |
| 7 | `narrow_range` | 47.5 | p66 | -0.51 | 1.48 | 0.97 | 46 | 10.1% | 0/8 | FAIL |
| 8 | `price_action_momentum` | 47.4 | p61 | -1.08 | 2.79 | 0.97 | 73 | 16.7% | 1/8 | FAIL |
| 9 | `order_flow_imbalance_v2` | 47.2 | p55 | -0.77 | 2.05 | 0.95 | 67 | 15.0% | 0/8 | FAIL |
| 10 | `relative_volume` | 46.7 | p50 | -0.99 | 1.72 | 0.92 | 64 | 13.2% | 0/8 | FAIL |
| 11 | `momentum_quality` | 44.9 | p44 | -1.19 | 3.29 | 0.96 | 71 | 15.8% | 1/8 | FAIL |
| 12 | `acceleration_band` | 42.9 | p38 | -0.94 | 2.58 | 0.98 | 44 | 13.0% | 1/8 | FAIL |
| 13 | `htf_ema` | 42.6 | p33 | -0.72 | 0.71 | 0.91 | 43 | 11.2% | 0/8 | FAIL |
| 14 | `cmf` | 41.5 | p27 | -1.23 | 1.29 | 0.88 | 68 | 16.3% | 0/8 | FAIL |
| 15 | `elder_impulse` | 34.9 | p22 | -1.15 | 1.14 | 0.85 | 42 | 11.5% | 0/8 | FAIL |
...
| `dema_cross` | -4.12% | -2.25 | 0.81 | 26 | 1/8 | FAIL |
...
| `dema_cross` | mc_p_value 1.000 > 0.1 (우연 가능성) (x2), profit_factor 1.28 < 1.5 (x1), mc_p_value 0.273 > 0.1 (우연 가능성) (x1) |
...
_Generated: 2026-06-29T06:16:53.885002Z_
_Symbol: ETH/USDT_
...
| 4 | `dema_cross` | -2.55% | -0.99 | 35.9% | 0.96 | 24 | 7.8% | 1/8 | FAIL |
...
| 8 | `dema_cross` | 46.3 | p61 | -0.99 | 2.04 | 0.96 | 24 | 7.8% | 1/8 | FAIL |
...
| `dema_cross` | -2.55% | -0.99 | 0.96 | 24 | 1/8 | FAIL |
...
| `dema_cross` | profit_factor 0.71 < 1.5 (x2), mc_p_value 0.760 > 0.1 (우연 가능성) (x2), sharpe -1.47 < 1.0 (x1) |
...
- **전체 19개 균등배분**: -5.57% -> $9,443
- **Top 5 균등배분**: -0.17% -> $9,983
...
_Generated: 2026-06-29T06:22:05.724110Z_
_Symbol: SOL/USDT_
...
| 6 | `dema_cross` | -4.38% | -1.32 | 29.9% | 0.81 | 33 | 9.0% | 0/8 | FAIL |
...
| 11 | `dema_cross` | 38.5 | p38 | -1.32 | 1.33 | 0.81 | 33 | 9.0% | 0/8 | FAIL |
| 12 | `price_action_momentum` | 38.5 | p44 | -1.88 | 0.97 | 0.75 | 47 | 12.3% | 0/8 | FAIL |
...
| `dema_cross` | -4.38% | -1.32 | 0.81 | 33 | 0/8 | FAIL |
...
| `dema_cross` | sharpe -0.49 < 1.0 (x1), profit_factor 0.91 < 1.5 (x1), mc_p_value 0.573 > 0.1 (우연 가능성) (x1) |
...
| `dema_cross` | 0 | 145 | 116 | 44.4% |

## 포트폴리오 가상 배분

- **전체 19개 균등배분**: -4.90% -> $9,510
