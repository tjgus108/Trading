...
_Generated: 2026-06-30T00:26:06.015847Z_
_Symbols: BTC/USDT_
...
_Generated: 2026-06-30T00:30:34.556597Z_
_Symbol: BTC/USDT_
...
| 5 | `roc_ma_cross` | -0.64% | -0.33 | 33.0% | 1.05 | 34 | 8.5% | 1/8 | FAIL |
| 6 | `dema_cross` | -1.07% | -0.35 | 35.3% | 1.08 | 15 | 5.1% | 0/8 | FAIL |
...
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `price_cluster` | 76.1 | p100 | 0.87 | 1.10 | 1.20 | 41 | 9.8% | 1/8 | FAIL |
| 2 | `frama` | 66.7 | p94 | 0.24 | 1.60 | 1.12 | 40 | 9.4% | 1/8 | FAIL |
| 3 | `lob_maker` | 56.9 | p88 | -0.04 | 1.99 | 1.05 | 75 | 17.0% | 0/8 | FAIL |
| 4 | `roc_ma_cross` | 56.1 | p83 | -0.33 | 2.04 | 1.05 | 34 | 8.5% | 1/8 | FAIL |
| 5 | `positional_scaling` | 55.3 | p77 | -0.38 | 2.82 | 1.09 | 34 | 9.2% | 1/8 | FAIL |
| 6 | `price_action_momentum` | 52.0 | p72 | -1.08 | 2.79 | 0.97 | 73 | 16.7% | 1/8 | FAIL |
| 7 | `momentum_quality` | 49.2 | p66 | -1.19 | 3.29 | 0.96 | 71 | 15.8% | 1/8 | FAIL |
| 8 | `acceleration_band` | 48.3 | p61 | -0.94 | 2.58 | 0.98 | 44 | 13.0% | 1/8 | FAIL |
| 9 | `volume_breakout` | 48.0 | p55 | -0.74 | 2.18 | 0.96 | 72 | 15.4% | 0/8 | FAIL |
| 10 | `narrow_range` | 47.2 | p50 | -0.51 | 1.48 | 0.97 | 46 | 10.1% | 0/8 | FAIL |
| 11 | `order_flow_imbalance_v2` | 46.7 | p44 | -0.77 | 2.05 | 0.95 | 67 | 15.0% | 0/8 | FAIL |
| 12 | `relative_volume` | 45.8 | p38 | -0.99 | 1.72 | 0.92 | 64 | 13.2% | 0/8 | FAIL |
| 13 | `htf_ema` | 42.9 | p33 | -0.72 | 0.71 | 0.91 | 43 | 11.2% | 0/8 | FAIL |
| 14 | `cmf` | 41.6 | p27 | -1.23 | 1.29 | 0.88 | 68 | 16.3% | 0/8 | FAIL |
| 15 | `dema_cross` | 39.7 | p22 | -0.35 | 1.68 | 1.08 | 15 | 5.1% | 0/8 | FAIL |
...
| `roc_ma_cross` | -0.64% | -0.33 | 1.05 | 34 | 1/8 | FAIL |
| `dema_cross` | -1.07% | -0.35 | 1.08 | 15 | 0/8 | FAIL |
...
| `roc_ma_cross` | profit_factor 0.91 < 1.5 (x2), profit_factor 1.01 < 1.5 (x2), sharpe -0.63 < 1.0 (x1) |
| `dema_cross` | trades 11 < 15 (x2), sharpe 0.53 < 1.0 (x1), profit_factor 1.25 < 1.5 (x1) |
...
| `dema_cross` | 0 | 121 | 2 | 1.6% |
| `relative_volume` | 0 | 507 | 8 | 1.6% |
| `roc_ma_cross` | 0 | 270 | 4 | 1.5% |
