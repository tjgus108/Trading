...
_Generated: 2026-07-01T10:43:56.786179Z_
...
_Generated: 2026-07-01T10:50:01.138970Z_
_Symbol: BTC/USDT_
...
| 3 | `dema_cross` | +2.09% | 0.56 | 38.4% | 1.34 | 22 | 5.4% | 1/8 | FAIL |
...
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `price_cluster` | 66.1 | p100 | 0.87 | 1.10 | 1.20 | 41 | 9.8% | 1/8 | FAIL |
| 2 | `roc_ma_cross` | 63.1 | p94 | 0.34 | 2.44 | 1.22 | 36 | 8.1% | 2/8 | FAIL |
| 3 | `dema_cross` | 58.3 | p88 | 0.56 | 1.96 | 1.34 | 22 | 5.4% | 1/8 | FAIL |
| 4 | `frama` | 57.3 | p83 | 0.24 | 1.60 | 1.12 | 40 | 9.4% | 1/8 | FAIL |
| 5 | `lob_maker` | 54.0 | p77 | -0.04 | 1.99 | 1.05 | 75 | 17.0% | 0/8 | FAIL |
| 6 | `positional_scaling` | 45.9 | p72 | -0.38 | 2.82 | 1.09 | 34 | 9.2% | 1/8 | FAIL |
| 7 | `volume_breakout` | 45.7 | p66 | -0.74 | 2.18 | 0.96 | 72 | 15.4% | 0/8 | FAIL |
| 8 | `price_action_momentum` | 44.6 | p61 | -1.08 | 2.79 | 0.97 | 73 | 16.7% | 1/8 | FAIL |
...
| 11 | `relative_volume` | 43.6 | p44 | -0.99 | 1.72 | 0.92 | 64 | 13.2% | 0/8 | FAIL |
| 12 | `momentum_quality` | 41.8 | p38 | -1.19 | 3.29 | 0.96 | 71 | 15.8% | 1/8 | FAIL |
| 13 | `htf_ema` | 40.1 | p33 | -0.72 | 0.71 | 0.91 | 43 | 11.2% | 0/8 | FAIL |
| 14 | `acceleration_band` | 40.0 | p27 | -0.94 | 2.58 | 0.98 | 44 | 13.0% | 1/8 | FAIL |
| 15 | `cmf` | 39.7 | p22 | -1.23 | 1.29 | 0.88 | 68 | 16.3% | 0/8 | FAIL |
...
| `dema_cross` | +2.09% | 0.56 | 1.34 | 22 | 1/8 | FAIL |
...
| `dema_cross` | sharpe -0.09 < 1.0 (x1), profit_factor 1.00 < 1.5 (x1), mc_p_value 0.501 > 0.1 (우연 가능성) (x1) |
...
_Generated: 2026-07-01T10:55:31.304202Z_
_Symbol: ETH/USDT_
...
| 3 | `volume_breakout` | 57.8 | p88 | -0.87 | 1.49 | 0.91 | 61 | 12.5% | 0/8 | FAIL |
| 4 | `price_cluster` | 53.7 | p83 | -0.44 | 2.85 | 1.09 | 30 | 9.3% | 1/8 | FAIL |
| 5 | `lob_maker` | 49.8 | p77 | -0.90 | 1.82 | 0.92 | 58 | 15.6% | 0/8 | FAIL |
| 6 | `cmf` | 47.9 | p72 | -1.14 | 1.40 | 0.85 | 46 | 11.8% | 0/8 | FAIL |
| 7 | `order_flow_imbalance_v2` | 46.9 | p66 | -1.02 | 2.50 | 0.94 | 55 | 14.5% | 0/8 | FAIL |
| 8 | `volatility_cluster` | 45.0 | p61 | -1.49 | 1.44 | 0.81 | 42 | 9.4% | 0/8 | FAIL |
| 9 | `relative_volume` | 44.8 | p55 | -1.53 | 2.34 | 0.87 | 54 | 12.7% | 0/8 | FAIL |
| 10 | `elder_impulse` | 40.3 | p50 | -1.60 | 0.86 | 0.76 | 36 | 10.7% | 0/8 | FAIL |
| 11 | `momentum_quality` | 39.9 | p44 | -2.48 | 0.88 | 0.71 | 58 | 14.5% | 0/8 | FAIL |
| 12 | `price_action_momentum` | 36.1 | p38 | -2.32 | 1.51 | 0.71 | 48 | 12.6% | 0/8 | FAIL |
| 13 | `linear_channel_rev` | 24.5 | p33 | -2.33 | 1.19 | 0.60 | 23 | 7.9% | 0/8 | FAIL |
| 14 | `htf_ema` | 21.7 | p27 | -2.83 | 0.81 | 0.56 | 29 | 12.1% | 0/8 | FAIL |
| 15 | `acceleration_band` | 20.1 | p22 | -2.03 | 1.23 | 0.57 | 13 | 6.0% | 0/8 | FAIL |
...
| `dema_cross` | -5.77% | -3.04 | 0.46 | 16 | 0/8 | FAIL |
...
| `dema_cross` | trades 14 < 15 (x2), sharpe -3.70 < 1.0 (x1), profit_factor 0.23 < 1.5 (x1) |
...
_Generated: 2026-07-01T11:01:19.215551Z_
_Symbol: SOL/USDT_
...
| 6 | `dema_cross` | -4.14% | -1.69 | 29.8% | 0.74 | 24 | 7.3% | 0/8 | FAIL |
...
| `dema_cross` | -4.14% | -1.69 | 0.74 | 24 | 0/8 | FAIL |
...
| `dema_cross` | sharpe -1.80 < 1.0 (x1), profit_factor 0.68 < 1.5 (x1), mc_p_value 0.811 > 0.1 (우연 가능성) (x1) |
