...
_Generated: 2026-07-02T10:35:54.172404Z_
...
_Generated: 2026-07-02T10:40:11.627542Z_
_Symbol: BTC/USDT_
...
|---|------|-----------|-----------|-------|-------|-----------|--------|-------------|------|
| 1 | `roc_ma_cross` | +5.91% | 1.51 | 43.3% | 1.87 | 16 | 4.3% | 2/8 | FAIL |
| 2 | `price_cluster` | +4.99% | 0.87 | 37.2% | 1.20 | 41 | 9.8% | 1/8 | FAIL |
...
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `roc_ma_cross` | 64.3 | p100 | 1.51 | 2.06 | 1.87 | 16 | 4.3% | 2/8 | FAIL |
| 2 | `dema_cross` | 56.2 | p94 | 0.85 | 1.85 | 1.38 | 26 | 6.1% | 2/8 | FAIL |
| 3 | `price_cluster` | 55.2 | p88 | 0.87 | 1.10 | 1.20 | 41 | 9.8% | 1/8 | FAIL |
| 4 | `frama` | 48.2 | p83 | 0.24 | 1.60 | 1.12 | 40 | 9.4% | 1/8 | FAIL |
| 5 | `lob_maker` | 45.6 | p77 | -0.04 | 1.99 | 1.05 | 75 | 17.0% | 0/8 | FAIL |
| 6 | `volume_breakout` | 39.2 | p72 | -0.74 | 2.18 | 0.96 | 72 | 15.4% | 0/8 | FAIL |
| 7 | `price_action_momentum` | 38.6 | p66 | -1.08 | 2.79 | 0.97 | 73 | 16.7% | 1/8 | FAIL |
| 8 | `positional_scaling` | 38.2 | p61 | -0.38 | 2.82 | 1.09 | 34 | 9.2% | 1/8 | FAIL |
| 9 | `order_flow_imbalance_v2` | 38.1 | p55 | -0.77 | 2.05 | 0.95 | 67 | 15.0% | 0/8 | FAIL |
| 10 | `relative_volume` | 38.0 | p50 | -0.99 | 1.72 | 0.92 | 64 | 13.2% | 0/8 | FAIL |
| 11 | `narrow_range` | 37.6 | p44 | -0.51 | 1.48 | 0.97 | 46 | 10.1% | 0/8 | FAIL |
| 12 | `momentum_quality` | 36.0 | p38 | -1.19 | 3.29 | 0.96 | 71 | 15.8% | 1/8 | FAIL |
| 13 | `cmf` | 35.1 | p33 | -1.23 | 1.29 | 0.88 | 68 | 16.3% | 0/8 | FAIL |
| 14 | `htf_ema` | 34.8 | p27 | -0.72 | 0.71 | 0.91 | 43 | 11.2% | 0/8 | FAIL |
| 15 | `acceleration_band` | 34.3 | p22 | -0.94 | 2.58 | 0.98 | 44 | 13.0% | 1/8 | FAIL |

## 전체 결과

| Name | AvgReturn | AvgSharpe | AvgPF | AvgTrades | Consistency | Pass |
|------|-----------|-----------|-------|-----------|-------------|------|
| `roc_ma_cross` | +5.91% | 1.51 | 1.87 | 16 | 2/8 | FAIL |
...
|----------|-----------------------------------|
| `roc_ma_cross` | sharpe 0.32 < 1.0 (x1), profit_factor 1.11 < 1.5 (x1), mc_p_value 0.433 > 0.1 (우연 가능성) (x1) |
...
- **전체 19개 균등배분**: -2.44% -> $9,756
- **Top 5 균등배분**: +3.17% -> $10,317
...
_Generated: 2026-07-02T10:44:12.841832Z_
_Symbol: ETH/USDT_
...
| 4 | `roc_ma_cross` | -1.90% | -1.12 | 30.6% | 0.77 | 10 | 4.4% | 0/8 | FAIL |
...
| 3 | `volume_breakout` | 57.0 | p88 | -0.87 | 1.49 | 0.91 | 61 | 12.5% | 0/8 | FAIL |
| 4 | `price_cluster` | 53.5 | p83 | -0.44 | 2.85 | 1.09 | 30 | 9.3% | 1/8 | FAIL |
...
| 8 | `volatility_cluster` | 44.3 | p61 | -1.49 | 1.44 | 0.81 | 42 | 9.4% | 0/8 | FAIL |
| 9 | `relative_volume` | 44.2 | p55 | -1.53 | 2.34 | 0.87 | 54 | 12.7% | 0/8 | FAIL |
| 10 | `elder_impulse` | 39.9 | p50 | -1.60 | 0.86 | 0.76 | 36 | 10.7% | 0/8 | FAIL |
| 11 | `momentum_quality` | 39.5 | p44 | -2.48 | 0.88 | 0.71 | 58 | 14.5% | 0/8 | FAIL |
| 12 | `price_action_momentum` | 35.6 | p38 | -2.32 | 1.51 | 0.71 | 48 | 12.6% | 0/8 | FAIL |
| 13 | `roc_ma_cross` | 29.4 | p33 | -1.12 | 1.49 | 0.77 | 10 | 4.4% | 0/8 | FAIL |
| 14 | `linear_channel_rev` | 24.4 | p27 | -2.33 | 1.19 | 0.60 | 23 | 7.9% | 0/8 | FAIL |
| 15 | `htf_ema` | 21.7 | p22 | -2.83 | 0.81 | 0.56 | 29 | 12.1% | 0/8 | FAIL |
...
| `roc_ma_cross` | -1.90% | -1.12 | 0.77 | 10 | 0/8 | FAIL |
...
| `roc_ma_cross` | trades 10 < 15 (x3), trades 8 < 15 (x2), sharpe -2.82 < 1.0 (x1) |
...
- **전체 19개 균등배분**: -5.33% -> $9,467
- **Top 5 균등배분**: -0.04% -> $9,996
...
_Generated: 2026-07-02T10:48:01.021134Z_
_Symbol: SOL/USDT_
...
| 6 | `roc_ma_cross` | -3.99% | -2.18 | 25.2% | 0.60 | 13 | 6.6% | 0/8 | FAIL |
...
| 2 | `volatility_cluster` | 54.2 | p94 | -0.12 | 1.16 | 1.02 | 41 | 8.7% | 0/8 | FAIL |
| 3 | `lob_maker` | 48.4 | p88 | -0.73 | 0.95 | 0.90 | 56 | 13.0% | 0/8 | FAIL |
| 4 | `relative_volume` | 47.7 | p83 | -0.61 | 2.05 | 0.97 | 50 | 10.7% | 0/8 | FAIL |
| 5 | `momentum_quality` | 46.3 | p77 | -1.18 | 0.96 | 0.85 | 56 | 10.5% | 0/8 | FAIL |
| 6 | `order_flow_imbalance_v2` | 43.6 | p72 | -1.22 | 0.78 | 0.84 | 55 | 12.0% | 0/8 | FAIL |
| 7 | `cmf` | 38.2 | p66 | -1.28 | 0.94 | 0.82 | 44 | 10.3% | 0/8 | FAIL |
| 8 | `volume_breakout` | 37.2 | p61 | -1.45 | 1.33 | 0.82 | 58 | 14.2% | 0/8 | FAIL |
| 9 | `positional_scaling` | 32.8 | p55 | -1.12 | 2.17 | 0.87 | 32 | 8.8% | 0/8 | FAIL |
| 10 | `elder_impulse` | 31.1 | p50 | -1.91 | 3.14 | 0.82 | 36 | 11.6% | 1/8 | FAIL |
| 11 | `price_action_momentum` | 29.9 | p44 | -1.88 | 0.97 | 0.75 | 47 | 12.3% | 0/8 | FAIL |
| 12 | `acceleration_band` | 29.8 | p38 | -0.80 | 1.82 | 1.00 | 11 | 4.7% | 0/8 | FAIL |
| 13 | `htf_ema` | 27.1 | p33 | -1.45 | 1.94 | 0.80 | 30 | 9.0% | 0/8 | FAIL |
| 14 | `frama` | 23.6 | p27 | -1.94 | 1.83 | 0.74 | 42 | 12.6% | 0/8 | FAIL |
| 15 | `dema_cross` | 21.2 | p22 | -1.89 | 1.75 | 0.72 | 29 | 8.4% | 0/8 | FAIL |
...
| `roc_ma_cross` | -3.99% | -2.18 | 0.60 | 13 | 0/8 | FAIL |
...
| `roc_ma_cross` | profit_factor 0.61 < 1.5 (x2), trades 11 < 15 (x2), sharpe -1.43 < 1.0 (x1) |
