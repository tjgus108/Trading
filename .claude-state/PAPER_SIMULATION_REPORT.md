...
_Generated: 2026-06-11T05:17:05.566977Z_
...
_Generated: 2026-06-11T05:18:48.114136Z_
_Symbol: BTC/USDT_
...
| 8 | `order_flow_imbalance_v2` | +1.80% | 0.36 | 40.4% | 1.34 | 20 | 7.0% | 2/8 | FAIL |
...
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `price_cluster` | 74.9 | p100 | 3.72 | 2.34 | 2.17 | 12 | 4.1% | 2/8 | FAIL |
| 2 | `momentum_quality` | 64.5 | p95 | 1.82 | 3.71 | 1.39 | 22 | 4.9% | 1/8 | FAIL |
| 3 | `relative_volume` | 62.6 | p90 | 1.84 | 3.94 | 1.63 | 19 | 4.7% | 1/8 | FAIL |
| 4 | `cmf` | 60.4 | p85 | 1.25 | 2.69 | 1.24 | 23 | 6.3% | 1/8 | FAIL |
| 5 | `lob_maker` | 56.1 | p80 | 1.18 | 3.25 | 1.32 | 21 | 6.8% | 1/8 | FAIL |
| 6 | `order_flow_imbalance_v2` | 52.6 | p76 | 0.36 | 5.32 | 1.34 | 20 | 7.0% | 2/8 | FAIL |
| 7 | `value_area` | 50.7 | p71 | 0.76 | 2.61 | 1.25 | 16 | 5.0% | 1/8 | FAIL |
| 8 | `supertrend_multi` | 45.9 | p66 | 2.14 | 2.92 | 1.22 | 8 | 2.6% | 1/8 | FAIL |
| 9 | `linear_channel_rev` | 45.4 | p61 | 1.39 | 3.29 | 2.12 | 6 | 2.2% | 0/8 | FAIL |
| 10 | `htf_ema` | 39.7 | p57 | 0.02 | 3.92 | 1.65 | 11 | 4.8% | 0/8 | FAIL |
| 11 | `price_action_momentum` | 39.5 | p52 | -1.00 | 5.77 | 1.11 | 24 | 7.9% | 1/8 | FAIL |
...
| `order_flow_imbalance_v2` | +1.80% | 0.36 | 1.34 | 20 | 2/8 | FAIL |
...
| `order_flow_imbalance_v2` | mc_p_value 0.101 > 0.1 (우연 가능성) (x1), profit_factor 1.48 < 1.5 (x1), mc_p_value 0.251 > 0.1 (우연 가능성) (x1) |
...
_Generated: 2026-06-11T05:20:26.319176Z_
_Symbol: ETH/USDT_
...
| 4 | `volatility_cluster` | -0.92% | -0.51 | 40.4% | 1.05 | 16 | 4.5% | 0/8 | FAIL |
| 5 | `price_cluster` | -1.76% | -1.78 | 31.0% | 0.75 | 7 | 4.4% | 0/8 | FAIL |
...
| 4 | `volatility_cluster` | 59.1 | p85 | -0.51 | 2.30 | 1.05 | 16 | 4.5% | 0/8 | FAIL |
| 5 | `engulfing_zone` | 58.4 | p80 | 0.98 | 2.74 | 1.47 | 7 | 3.0% | 0/8 | FAIL |
| 6 | `order_flow_imbalance_v2` | 55.7 | p76 | -2.15 | 2.16 | 0.80 | 24 | 9.2% | 0/8 | FAIL |
...
| `order_flow_imbalance_v2` | -4.56% | -2.15 | 0.80 | 24 | 0/8 | FAIL |
...
| `order_flow_imbalance_v2` | profit_factor 0.70 < 1.5 (x2), sharpe -4.37 < 1.0 (x1), profit_factor 0.56 < 1.5 (x1) |
...
_Generated: 2026-06-11T05:22:05.335883Z_
_Symbol: SOL/USDT_
...
| Rank | Name | Score | Pctl | AvgSharpe | SharpeStd | AvgPF | AvgTrades | AvgMDD | Consist | Pass |
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `narrow_range` | 81.4 | p100 | 1.87 | 3.01 | 1.54 | 16 | 3.7% | 1/8 | FAIL |
| 2 | `momentum_quality` | 63.4 | p95 | -1.83 | 3.66 | 0.89 | 23 | 7.0% | 1/8 | FAIL |
| 3 | `volatility_cluster` | 53.9 | p90 | -1.56 | 2.04 | 0.84 | 20 | 6.1% | 0/8 | FAIL |
| 4 | `acceleration_band` | 48.3 | p85 | 0.15 | 2.95 | 1.36 | 7 | 2.7% | 0/8 | FAIL |
| 5 | `value_area` | 46.8 | p80 | -2.20 | 4.87 | 1.19 | 17 | 6.7% | 0/8 | FAIL |
| 6 | `frama` | 43.7 | p76 | -2.61 | 3.60 | 0.80 | 24 | 11.2% | 0/8 | FAIL |
| 7 | `linear_channel_rev` | 39.2 | p71 | -0.94 | 4.12 | 1.13 | 6 | 2.9% | 0/8 | FAIL |
| 8 | `supertrend_multi` | 37.8 | p66 | -2.08 | 2.97 | 0.79 | 12 | 5.6% | 0/8 | FAIL |
| 9 | `htf_ema` | 37.2 | p61 | -3.29 | 4.91 | 1.36 | 10 | 5.9% | 0/8 | FAIL |
| 10 | `price_action_momentum` | 35.8 | p57 | -4.08 | 3.85 | 0.64 | 21 | 8.5% | 0/8 | FAIL |
| 11 | `lob_maker` | 33.3 | p52 | -5.17 | 2.29 | 0.52 | 21 | 9.6% | 0/8 | FAIL |
| 12 | `order_flow_imbalance_v2` | 33.0 | p47 | -4.99 | 3.51 | 0.58 | 25 | 11.2% | 0/8 | FAIL |
| 13 | `wick_reversal` | 31.5 | p42 | -2.00 | 3.66 | 0.90 | 6 | 2.9% | 0/8 | FAIL |
| 14 | `engulfing_zone` | 29.8 | p38 | -2.54 | 2.94 | 0.67 | 8 | 4.8% | 0/8 | FAIL |
| 15 | `price_cluster` | 28.2 | p33 | -2.55 | 4.48 | 0.85 | 6 | 3.8% | 0/8 | FAIL |
...
| `order_flow_imbalance_v2` | -8.06% | -4.99 | 0.58 | 25 | 0/8 | FAIL |
...
| `order_flow_imbalance_v2` | sharpe -7.36 < 1.0 (x1), profit_factor 0.41 < 1.5 (x1), mc_p_value 0.961 > 0.1 (우연 가능성) (x1) |
