...
_Generated: 2026-07-03T00:34:32.534610Z_
...
_Generated: 2026-07-03T00:40:50.681728Z_
_Symbol: BTC/USDT_
...
|---|------|-----------|-----------|-------|-------|-----------|--------|-------------|------|
| 1 | `roc_ma_cross` | +5.13% | 1.43 | 43.6% | 1.84 | 14 | 3.4% | 2/8 | FAIL |
...
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `roc_ma_cross` | 63.8 | p100 | 1.43 | 1.85 | 1.84 | 14 | 3.4% | 2/8 | FAIL |
| 2 | `dema_cross` | 57.2 | p94 | 0.85 | 1.85 | 1.38 | 26 | 6.1% | 2/8 | FAIL |
| 3 | `price_cluster` | 56.0 | p88 | 0.87 | 1.10 | 1.20 | 41 | 9.8% | 1/8 | FAIL |
| 4 | `frama` | 48.9 | p83 | 0.24 | 1.60 | 1.12 | 40 | 9.4% | 1/8 | FAIL |
| 5 | `lob_maker` | 46.1 | p77 | -0.04 | 1.99 | 1.05 | 75 | 17.0% | 0/8 | FAIL |
| 6 | `volume_breakout` | 39.5 | p72 | -0.74 | 2.18 | 0.96 | 72 | 15.4% | 0/8 | FAIL |
| 7 | `price_action_momentum` | 39.0 | p66 | -1.08 | 2.79 | 0.97 | 73 | 16.7% | 1/8 | FAIL |
| 8 | `positional_scaling` | 38.9 | p61 | -0.38 | 2.82 | 1.09 | 34 | 9.2% | 1/8 | FAIL |
| 9 | `order_flow_imbalance_v2` | 38.4 | p55 | -0.77 | 2.05 | 0.95 | 67 | 15.0% | 0/8 | FAIL |
| 10 | `relative_volume` | 38.2 | p50 | -0.99 | 1.72 | 0.92 | 64 | 13.2% | 0/8 | FAIL |
| 11 | `narrow_range` | 38.0 | p44 | -0.51 | 1.48 | 0.97 | 46 | 10.1% | 0/8 | FAIL |
| 12 | `momentum_quality` | 36.3 | p38 | -1.19 | 3.29 | 0.96 | 71 | 15.8% | 1/8 | FAIL |
| 13 | `cmf` | 35.4 | p33 | -1.23 | 1.29 | 0.88 | 68 | 16.3% | 0/8 | FAIL |
| 14 | `htf_ema` | 35.3 | p27 | -0.72 | 0.71 | 0.91 | 43 | 11.2% | 0/8 | FAIL |
| 15 | `acceleration_band` | 34.8 | p22 | -0.94 | 2.58 | 0.98 | 44 | 13.0% | 1/8 | FAIL |

## 전체 결과

| Name | AvgReturn | AvgSharpe | AvgPF | AvgTrades | Consistency | Pass |
|------|-----------|-----------|-------|-----------|-------------|------|
| `roc_ma_cross` | +5.13% | 1.43 | 1.84 | 14 | 2/8 | FAIL |
...
|----------|-----------------------------------|
| `roc_ma_cross` | trades 14 < 15 (x4), sharpe 0.44 < 1.0 (x2), profit_factor 1.50 < 1.5 (x1) |
...
- **전체 19개 균등배분**: -2.48% -> $9,752
- **Top 5 균등배분**: +3.01% -> $10,301
...
_Generated: 2026-07-03T00:46:47.770762Z_
_Symbol: ETH/USDT_
...
| 4 | `roc_ma_cross` | -1.03% | -0.94 | 31.4% | 1.03 | 8 | 3.7% | 0/8 | FAIL |
...
| Rank | Name | Score | Pctl | AvgSharpe | SharpeStd | AvgPF | AvgTrades | AvgMDD | Consist | Pass |
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `engulfing_zone` | 68.9 | p100 | 0.44 | 2.56 | 1.30 | 24 | 7.0% | 2/8 | FAIL |
| 2 | `frama` | 67.4 | p94 | 0.51 | 1.55 | 1.18 | 33 | 8.4% | 1/8 | FAIL |
| 3 | `volume_breakout` | 56.7 | p88 | -0.87 | 1.49 | 0.91 | 61 | 12.5% | 0/8 | FAIL |
...
| 8 | `volatility_cluster` | 44.2 | p61 | -1.49 | 1.44 | 0.81 | 42 | 9.4% | 0/8 | FAIL |
| 9 | `relative_volume` | 44.0 | p55 | -1.53 | 2.34 | 0.87 | 54 | 12.7% | 0/8 | FAIL |
| 10 | `elder_impulse` | 40.0 | p50 | -1.60 | 0.86 | 0.76 | 36 | 10.7% | 0/8 | FAIL |
| 11 | `momentum_quality` | 39.5 | p44 | -2.48 | 0.88 | 0.71 | 58 | 14.5% | 0/8 | FAIL |
| 12 | `roc_ma_cross` | 35.7 | p38 | -0.94 | 2.10 | 1.03 | 8 | 3.7% | 0/8 | FAIL |
| 13 | `price_action_momentum` | 35.6 | p33 | -2.32 | 1.51 | 0.71 | 48 | 12.6% | 0/8 | FAIL |
| 14 | `linear_channel_rev` | 24.7 | p27 | -2.33 | 1.19 | 0.60 | 23 | 7.9% | 0/8 | FAIL |
...
| `roc_ma_cross` | -1.03% | -0.94 | 1.03 | 8 | 0/8 | FAIL |
...
| `roc_ma_cross` | trades 5 < 15 (x2), trades 7 < 15 (x2), sharpe -1.77 < 1.0 (x1) |
...
| `roc_ma_cross` | 0 | 42 | 20 | 32.3% |
| `engulfing_zone` | 0 | 132 | 60 | 31.2% |
| `relative_volume` | 0 | 302 | 134 | 30.7% |

## 포트폴리오 가상 배분

- **전체 19개 균등배분**: -5.28% -> $9,472
- **Top 5 균등배분**: +0.13% -> $10,013
...
_Generated: 2026-07-03T00:52:22.775621Z_
_Symbol: SOL/USDT_
...
| 4 | `roc_ma_cross` | -1.81% | -0.91 | 32.5% | 0.86 | 11 | 5.1% | 0/8 | FAIL |
...
| 11 | `acceleration_band` | 29.6 | p44 | -0.80 | 1.82 | 1.00 | 11 | 4.7% | 0/8 | FAIL |
| 12 | `price_action_momentum` | 29.4 | p38 | -1.88 | 0.97 | 0.75 | 47 | 12.3% | 0/8 | FAIL |
| 13 | `htf_ema` | 26.8 | p33 | -1.45 | 1.94 | 0.80 | 30 | 9.0% | 0/8 | FAIL |
| 14 | `roc_ma_cross` | 24.5 | p27 | -0.91 | 1.65 | 0.86 | 11 | 5.1% | 0/8 | FAIL |
| 15 | `frama` | 23.2 | p22 | -1.94 | 1.83 | 0.74 | 42 | 12.6% | 0/8 | FAIL |
...
| `roc_ma_cross` | -1.81% | -0.91 | 0.86 | 11 | 0/8 | FAIL |
...
| `roc_ma_cross` | trades 10 < 15 (x2), trades 9 < 15 (x2), sharpe -0.48 < 1.0 (x1) |
