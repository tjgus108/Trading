...
_Generated: 2026-06-25T00:16:01.644874Z_
...
_Generated: 2026-06-25T00:20:39.648974Z_
_Symbol: BTC/USDT_
...
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `price_cluster` | 71.1 | p100 | 0.87 | 1.10 | 1.20 | 41 | 9.8% | 1/8 | FAIL |
| 2 | `roc_ma_cross` | 68.7 | p94 | 0.34 | 2.44 | 1.22 | 36 | 8.1% | 2/8 | FAIL |
| 3 | `frama` | 62.8 | p88 | 0.24 | 1.60 | 1.12 | 40 | 9.4% | 1/8 | FAIL |
| 4 | `lob_maker` | 61.3 | p83 | -0.04 | 1.99 | 1.05 | 75 | 17.0% | 0/8 | FAIL |
| 5 | `volume_breakout` | 53.4 | p77 | -0.74 | 2.18 | 0.96 | 72 | 15.4% | 0/8 | FAIL |
| 6 | `price_action_momentum` | 53.0 | p72 | -1.08 | 2.79 | 0.97 | 73 | 16.7% | 1/8 | FAIL |
| 7 | `positional_scaling` | 51.7 | p61 | -0.38 | 2.82 | 1.09 | 34 | 9.2% | 1/8 | FAIL |
| 8 | `order_flow_imbalance_v2` | 51.7 | p66 | -0.77 | 2.05 | 0.95 | 67 | 15.0% | 0/8 | FAIL |
| 9 | `relative_volume` | 51.0 | p55 | -0.99 | 1.72 | 0.92 | 64 | 13.2% | 0/8 | FAIL |
| 10 | `momentum_quality` | 50.1 | p50 | -1.19 | 3.29 | 0.96 | 71 | 15.8% | 1/8 | FAIL |
| 11 | `narrow_range` | 50.0 | p44 | -0.51 | 1.48 | 0.97 | 46 | 10.1% | 0/8 | FAIL |
| 12 | `cmf` | 47.4 | p38 | -1.23 | 1.29 | 0.88 | 68 | 16.3% | 0/8 | FAIL |
| 13 | `acceleration_band` | 46.5 | p33 | -0.94 | 2.58 | 0.98 | 44 | 13.0% | 1/8 | FAIL |
| 14 | `htf_ema` | 45.8 | p27 | -0.72 | 0.71 | 0.91 | 43 | 11.2% | 0/8 | FAIL |
| 15 | `elder_impulse` | 38.8 | p22 | -1.15 | 1.14 | 0.85 | 42 | 11.5% | 0/8 | FAIL |
...
| `dema_cross` | -14.68% | -3.50 | 0.64 | 65 | 0/8 | FAIL |
...
| `dema_cross` | max_drawdown 21.4% > 20% (x2), sharpe -0.92 < 1.0 (x1), profit_factor 0.91 < 1.5 (x1) |

### 전체 FAIL 원인 빈도 (상위 10)

| Fail Reason | Total Count |
|-------------|-------------|
| profit_factor 0.91 < 1.5 | 6 |
...
_Generated: 2026-06-25T00:24:54.861538Z_
_Symbol: ETH/USDT_
...
| 3 | `price_cluster` | -1.34% | -0.68 | 36.5% | 1.05 | 30 | 9.4% | 1/8 | FAIL |
...
| Rank | Name | Score | Pctl | AvgSharpe | SharpeStd | AvgPF | AvgTrades | AvgMDD | Consist | Pass |
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `engulfing_zone` | 68.6 | p100 | 0.44 | 2.56 | 1.30 | 24 | 7.0% | 2/8 | FAIL |
| 2 | `frama` | 67.7 | p94 | 0.51 | 1.55 | 1.18 | 33 | 8.4% | 1/8 | FAIL |
| 3 | `volume_breakout` | 57.6 | p88 | -0.87 | 1.49 | 0.91 | 61 | 12.5% | 0/8 | FAIL |
| 4 | `price_cluster` | 50.8 | p83 | -0.68 | 2.83 | 1.05 | 30 | 9.4% | 1/8 | FAIL |
| 5 | `lob_maker` | 49.7 | p77 | -0.90 | 1.82 | 0.92 | 58 | 15.6% | 0/8 | FAIL |
| 6 | `cmf` | 47.7 | p72 | -1.14 | 1.40 | 0.85 | 46 | 11.8% | 0/8 | FAIL |
| 7 | `order_flow_imbalance_v2` | 46.7 | p66 | -1.02 | 2.50 | 0.94 | 55 | 14.5% | 0/8 | FAIL |
| 8 | `volatility_cluster` | 44.9 | p61 | -1.49 | 1.44 | 0.81 | 42 | 9.4% | 0/8 | FAIL |
| 9 | `relative_volume` | 44.5 | p55 | -1.53 | 2.34 | 0.87 | 54 | 12.7% | 0/8 | FAIL |
| 10 | `elder_impulse` | 40.1 | p50 | -1.60 | 0.86 | 0.76 | 36 | 10.7% | 0/8 | FAIL |
| 11 | `momentum_quality` | 39.7 | p44 | -2.48 | 0.88 | 0.71 | 58 | 14.5% | 0/8 | FAIL |
| 12 | `price_action_momentum` | 35.8 | p38 | -2.32 | 1.51 | 0.71 | 48 | 12.6% | 0/8 | FAIL |
| 13 | `linear_channel_rev` | 24.3 | p33 | -2.33 | 1.19 | 0.60 | 23 | 7.9% | 0/8 | FAIL |
| 14 | `dema_cross` | 22.1 | p27 | -3.22 | 2.67 | 0.65 | 50 | 14.6% | 0/8 | FAIL |
...
| `price_cluster` | -1.34% | -0.68 | 1.05 | 30 | 1/8 | FAIL |
...
| `dema_cross` | -10.91% | -3.22 | 0.65 | 50 | 0/8 | FAIL |
...
| `price_cluster` | sharpe -1.50 < 1.0 (x1), profit_factor 0.74 < 1.5 (x1), mc_p_value 0.744 > 0.1 (우연 가능성) (x1) |
...
| `dema_cross` | mc_p_value 1.000 > 0.1 (우연 가능성) (x2), profit_factor 0.68 < 1.5 (x2), sharpe -7.44 < 1.0 (x1) |
...
- **전체 19개 균등배분**: -6.07% -> $9,393
- **Top 5 균등배분**: -0.75% -> $9,925
...
_Generated: 2026-06-25T00:28:59.710287Z_
_Symbol: SOL/USDT_
...
| 9 | `elder_impulse` | 39.9 | p55 | -1.91 | 3.14 | 0.82 | 36 | 11.6% | 1/8 | FAIL |
| 10 | `positional_scaling` | 39.2 | p50 | -1.12 | 2.17 | 0.87 | 32 | 8.8% | 0/8 | FAIL |
| 11 | `price_action_momentum` | 38.5 | p44 | -1.88 | 0.97 | 0.75 | 47 | 12.3% | 0/8 | FAIL |
| 12 | `acceleration_band` | 35.0 | p38 | -0.80 | 1.82 | 1.00 | 11 | 4.7% | 0/8 | FAIL |
| 13 | `htf_ema` | 34.7 | p33 | -1.45 | 1.94 | 0.80 | 30 | 9.0% | 0/8 | FAIL |
| 14 | `frama` | 32.6 | p27 | -1.94 | 1.83 | 0.74 | 42 | 12.6% | 0/8 | FAIL |
| 15 | `price_cluster` | 32.0 | p22 | -1.80 | 0.78 | 0.71 | 31 | 9.9% | 0/8 | FAIL |
...
| `price_cluster` | -7.10% | -1.80 | 0.71 | 31 | 0/8 | FAIL |
...
| `dema_cross` | -11.31% | -3.38 | 0.57 | 46 | 0/8 | FAIL |
...
| `price_cluster` | profit_factor 0.70 < 1.5 (x2), sharpe -2.99 < 1.0 (x1), profit_factor 0.58 < 1.5 (x1) |
...
| `dema_cross` | profit_factor 0.57 < 1.5 (x2), sharpe -2.09 < 1.0 (x1), profit_factor 0.69 < 1.5 (x1) |
