...
_Generated: 2026-06-02T00:16:54.083758Z_
...
_Generated: 2026-06-02T00:22:32.791755Z_
_Symbol: BTC/USDT_
...
_Generated: 2026-06-02T00:28:07.092791Z_
_Symbol: ETH/USDT_
...
| # | Name | AvgReturn | AvgSharpe | AvgWR | AvgPF | AvgTrades | AvgMDD | Consistency | Pass |
|---|------|-----------|-----------|-------|-------|-----------|--------|-------------|------|
| 1 | `momentum_quality` | +3.88% | 0.73 | 44.0% | 1.17 | 63 | 10.4% | 1/8 | FAIL |
...
| Rank | Name | Score | Pctl | AvgSharpe | SharpeStd | AvgPF | AvgTrades | AvgMDD | Consist | Pass |
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `momentum_quality` | 75.8 | p100 | 0.73 | 1.60 | 1.17 | 63 | 10.4% | 1/8 | FAIL |
...
| Name | AvgReturn | AvgSharpe | AvgPF | AvgTrades | Consistency | Pass |
|------|-----------|-----------|-------|-----------|-------------|------|
| `momentum_quality` | +3.88% | 0.73 | 1.17 | 63 | 1/8 | FAIL |
...
| Strategy | Top Fail Reasons (reason x count) |
|----------|-----------------------------------|
| `momentum_quality` | sharpe 0.16 < 1.0 (x1), profit_factor 1.04 < 1.5 (x1), mc_p_value 0.470 > 0.05 (우연 가능성) (x1) |
| `dema_cross` | trades 11 < 15 (x3), trades 12 < 15 (x2), sharpe -0.53 < 1.0 (x1) |
| `volatility_cluster` | sharpe -0.17 < 1.0 (x1), profit_factor 0.98 < 1.5 (x1), mc_p_value 0.550 > 0.05 (우연 가능성) (x1) |
| `price_action_momentum` | sharpe -1.17 < 1.0 (x1), profit_factor 0.83 < 1.5 (x1), mc_p_value 0.682 > 0.05 (우연 가능성) (x1) |
...
| `linear_channel_rev` | profit_factor 0.82 < 1.5 (x2), sharpe -0.99 < 1.0 (x1), mc_p_value 0.698 > 0.05 (우연 가능성) (x1) |
| `roc_ma_cross` | sharpe -0.33 < 1.0 (x1), profit_factor 0.94 < 1.5 (x1), mc_p_value 0.592 > 0.05 (우연 가능성) (x1) |
| `acceleration_band` | trades 6 < 15 (x2), trades 14 < 15 (x2), profit_factor 0.61 < 1.5 (x2) |
| `htf_ema` | sharpe -0.76 < 1.0 (x1), profit_factor 0.88 < 1.5 (x1), mc_p_value 0.640 > 0.05 (우연 가능성) (x1) |
| `price_cluster` | sharpe -2.23 < 1.0 (x1), profit_factor 0.65 < 1.5 (x1), mc_p_value 0.860 > 0.05 (우연 가능성) (x1) |
| `cmf` | sharpe -2.27 < 1.0 (x1), profit_factor 0.72 < 1.5 (x1), mc_p_value 0.868 > 0.05 (우연 가능성) (x1) |
| `elder_impulse` | sharpe -0.79 < 1.0 (x1), profit_factor 0.88 < 1.5 (x1), mc_p_value 0.654 > 0.05 (우연 가능성) (x1) |
| `value_area` | sharpe -1.29 < 1.0 (x1), profit_factor 0.82 < 1.5 (x1), mc_p_value 0.694 > 0.05 (우연 가능성) (x1) |
| `positional_scaling` | profit_factor 0.54 < 1.5 (x2), sharpe -4.31 < 1.0 (x1), profit_factor 0.46 < 1.5 (x1) |
| `relative_volume` | sharpe -2.79 < 1.0 (x1), profit_factor 0.67 < 1.5 (x1), mc_p_value 0.900 > 0.05 (우연 가능성) (x1) |
| `frama` | profit_factor 0.73 < 1.5 (x2), sharpe -1.51 < 1.0 (x1), profit_factor 0.76 < 1.5 (x1) |
...
_Generated: 2026-06-02T00:33:35.299503Z_
_Symbol: SOL/USDT_
...
| Strategy | Top Fail Reasons (reason x count) |
|----------|-----------------------------------|
| `htf_ema` | sharpe -0.85 < 1.0 (x1), profit_factor 0.84 < 1.5 (x1), mc_p_value 0.644 > 0.05 (우연 가능성) (x1) |
| `momentum_quality` | sharpe -1.57 < 1.0 (x1), profit_factor 0.81 < 1.5 (x1), mc_p_value 0.784 > 0.05 (우연 가능성) (x1) |
| `elder_impulse` | sharpe -1.24 < 1.0 (x1), profit_factor 0.81 < 1.5 (x1), mc_p_value 0.704 > 0.05 (우연 가능성) (x1) |
| `wick_reversal` | no trades generated (x8) |
| `volatility_cluster` | sharpe -1.85 < 1.0 (x1), profit_factor 0.74 < 1.5 (x1), mc_p_value 0.826 > 0.05 (우연 가능성) (x1) |
| `order_flow_imbalance_v2` | sharpe -2.67 < 1.0 (x1), profit_factor 0.70 < 1.5 (x1), mc_p_value 0.890 > 0.05 (우연 가능성) (x1) |
| `acceleration_band` | trades 7 < 15 (x4), trades 8 < 15 (x2), trades 6 < 15 (x2) |
| `price_action_momentum` | sharpe -2.60 < 1.0 (x1), profit_factor 0.67 < 1.5 (x1), mc_p_value 0.906 > 0.05 (우연 가능성) (x1) |
| `price_cluster` | sharpe 0.04 < 1.0 (x2), profit_factor 1.01 < 1.5 (x1), mc_p_value 0.474 > 0.05 (우연 가능성) (x1) |
| `roc_ma_cross` | profit_factor 0.64 < 1.5 (x2), sharpe -2.07 < 1.0 (x1), mc_p_value 0.852 > 0.05 (우연 가능성) (x1) |
| `narrow_range` | sharpe -3.85 < 1.0 (x1), profit_factor 0.55 < 1.5 (x1), mc_p_value 0.962 > 0.05 (우연 가능성) (x1) |
...
| `linear_channel_rev` | sharpe -3.28 < 1.0 (x1), profit_factor 0.49 < 1.5 (x1), mc_p_value 0.960 > 0.05 (우연 가능성) (x1) |
...
| `engulfing_zone` | sharpe -3.32 < 1.0 (x1), profit_factor 0.39 < 1.5 (x1), mc_p_value 0.962 > 0.05 (우연 가능성) (x1) |
...
| mc_p_value 0.962 > 0.05 (우연 가능성) | 4 |
