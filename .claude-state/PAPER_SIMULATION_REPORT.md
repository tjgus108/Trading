...
_Generated: 2026-06-21T10:18:34.744949Z_
...
_Generated: 2026-06-21T10:25:10.783423Z_
_Symbol: BTC/USDT_
...
| 3 | `positional_scaling` | +0.27% | -0.38 | 33.7% | 1.09 | 34 | 9.2% | 1/8 | FAIL |
| 4 | `lob_maker` | +0.15% | -0.04 | 35.0% | 1.05 | 75 | 17.0% | 0/8 | FAIL |
| 5 | `roc_ma_cross` | -0.71% | -0.43 | 32.7% | 0.94 | 18 | 5.5% | 0/8 | FAIL |
...
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `price_cluster` | 76.6 | p100 | 0.87 | 1.10 | 1.20 | 41 | 9.8% | 1/8 | FAIL |
| 2 | `frama` | 68.4 | p94 | 0.24 | 1.60 | 1.12 | 40 | 9.4% | 1/8 | FAIL |
| 3 | `lob_maker` | 59.1 | p89 | -0.04 | 1.99 | 1.05 | 75 | 17.0% | 0/8 | FAIL |
| 4 | `positional_scaling` | 57.8 | p84 | -0.38 | 2.82 | 1.09 | 34 | 9.2% | 1/8 | FAIL |
| 5 | `price_action_momentum` | 55.3 | p78 | -1.08 | 2.79 | 0.97 | 73 | 16.7% | 1/8 | FAIL |
| 6 | `momentum_quality` | 52.5 | p73 | -1.19 | 3.29 | 0.96 | 71 | 15.8% | 1/8 | FAIL |
| 7 | `acceleration_band` | 52.3 | p68 | -0.94 | 2.58 | 0.98 | 44 | 13.0% | 1/8 | FAIL |
| 8 | `volume_breakout` | 51.2 | p63 | -0.74 | 2.18 | 0.96 | 72 | 15.4% | 0/8 | FAIL |
| 9 | `narrow_range` | 50.7 | p57 | -0.51 | 1.48 | 0.97 | 46 | 10.1% | 0/8 | FAIL |
| 10 | `order_flow_imbalance_v2` | 50.2 | p52 | -0.77 | 2.05 | 0.95 | 67 | 15.0% | 0/8 | FAIL |
| 11 | `relative_volume` | 49.5 | p47 | -0.99 | 1.72 | 0.92 | 64 | 13.2% | 0/8 | FAIL |
| 12 | `htf_ema` | 47.6 | p42 | -0.72 | 0.71 | 0.91 | 43 | 11.2% | 0/8 | FAIL |
| 13 | `cmf` | 46.4 | p36 | -1.23 | 1.29 | 0.88 | 68 | 16.3% | 0/8 | FAIL |
| 14 | `roc_ma_cross` | 41.3 | p31 | -0.43 | 1.33 | 0.94 | 18 | 5.5% | 0/8 | FAIL |
| 15 | `elder_impulse` | 41.1 | p26 | -1.15 | 1.14 | 0.85 | 42 | 11.5% | 0/8 | FAIL |
...
| `roc_ma_cross` | -0.71% | -0.43 | 0.94 | 18 | 0/8 | FAIL |
...
| `roc_ma_cross` | sharpe -1.85 < 1.0 (x1), profit_factor 0.59 < 1.5 (x1), trades 13 < 15 (x1) |
...
- **전체 20개 균등배분**: -3.36% -> $9,664
- **Top 5 균등배분**: +1.26% -> $10,126
...
_Generated: 2026-06-21T10:31:12.954617Z_
_Symbol: ETH/USDT_
...
| Rank | Name | Score | Pctl | AvgSharpe | SharpeStd | AvgPF | AvgTrades | AvgMDD | Consist | Pass |
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `price_action_momentum` | 70.0 | p100 | 0.23 | 1.76 | 1.12 | 43 | 9.8% | 1/8 | FAIL |
| 2 | `momentum_quality` | 67.2 | p94 | 0.30 | 1.37 | 1.08 | 60 | 10.3% | 0/8 | FAIL |
| 3 | `volatility_cluster` | 66.2 | p89 | 0.82 | 1.81 | 1.24 | 42 | 8.2% | 0/8 | FAIL |
| 4 | `narrow_range` | 65.0 | p84 | -0.11 | 2.15 | 1.07 | 40 | 10.7% | 1/8 | FAIL |
| 5 | `cmf` | 63.6 | p78 | -0.38 | 2.23 | 1.01 | 48 | 12.1% | 1/8 | FAIL |
| 6 | `engulfing_zone` | 63.1 | p73 | 0.04 | 2.15 | 1.16 | 25 | 8.0% | 1/8 | FAIL |
| 7 | `relative_volume` | 60.1 | p68 | -0.97 | 2.77 | 0.95 | 58 | 12.7% | 1/8 | FAIL |
| 8 | `elder_impulse` | 58.6 | p63 | -0.74 | 2.48 | 0.98 | 39 | 10.0% | 1/8 | FAIL |
| 9 | `lob_maker` | 52.7 | p57 | -0.98 | 1.04 | 0.88 | 59 | 15.4% | 0/8 | FAIL |
| 10 | `order_flow_imbalance_v2` | 45.7 | p52 | -1.51 | 1.84 | 0.83 | 60 | 16.0% | 0/8 | FAIL |
| 11 | `dema_cross` | 43.5 | p47 | -0.54 | 2.23 | 1.07 | 12 | 4.2% | 0/8 | FAIL |
| 12 | `htf_ema` | 41.8 | p36 | -1.05 | 1.59 | 0.84 | 26 | 8.5% | 0/8 | FAIL |
| 13 | `volume_breakout` | 41.8 | p42 | -1.91 | 2.37 | 0.81 | 69 | 18.0% | 0/8 | FAIL |
| 14 | `frama` | 40.0 | p31 | -1.69 | 1.69 | 0.77 | 41 | 13.3% | 0/8 | FAIL |
| 15 | `linear_channel_rev` | 39.7 | p26 | -1.29 | 1.69 | 0.80 | 26 | 7.6% | 0/8 | FAIL |
...
| `roc_ma_cross` | -7.26% | -3.82 | 0.40 | 20 | 0/8 | FAIL |
...
| `roc_ma_cross` | sharpe -4.92 < 1.0 (x1), profit_factor 0.24 < 1.5 (x1), mc_p_value 0.994 > 0.1 (우연 가능성) (x1) |
...
_Generated: 2026-06-21T10:36:46.253001Z_
_Symbol: SOL/USDT_
...
| 2 | `order_flow_imbalance_v2` | 64.6 | p94 | -0.37 | 1.38 | 0.96 | 59 | 11.4% | 0/8 | FAIL |
| 3 | `elder_impulse` | 63.8 | p89 | 0.07 | 0.92 | 1.02 | 39 | 9.0% | 0/8 | FAIL |
| 4 | `volume_breakout` | 63.1 | p84 | -0.74 | 2.85 | 0.99 | 50 | 11.5% | 2/8 | FAIL |
| 5 | `htf_ema` | 52.2 | p78 | -0.50 | 1.80 | 0.97 | 32 | 8.8% | 0/8 | FAIL |
| 6 | `volatility_cluster` | 50.3 | p73 | -0.96 | 1.09 | 0.85 | 39 | 9.2% | 0/8 | FAIL |
| 7 | `acceleration_band` | 49.4 | p68 | -0.34 | 2.04 | 1.38 | 7 | 3.5% | 0/8 | FAIL |
| 8 | `price_action_momentum` | 45.1 | p63 | -1.56 | 2.51 | 0.84 | 40 | 11.8% | 1/8 | FAIL |
| 9 | `narrow_range` | 42.3 | p57 | -1.47 | 1.14 | 0.77 | 37 | 10.6% | 0/8 | FAIL |
| 10 | `linear_channel_rev` | 40.5 | p52 | -1.32 | 1.00 | 0.77 | 26 | 6.8% | 0/8 | FAIL |
| 11 | `relative_volume` | 39.1 | p47 | -2.36 | 1.28 | 0.72 | 60 | 14.5% | 0/8 | FAIL |
| 12 | `frama` | 34.7 | p42 | -2.31 | 1.62 | 0.70 | 50 | 14.4% | 0/8 | FAIL |
| 13 | `price_cluster` | 34.6 | p36 | -1.50 | 1.46 | 0.71 | 21 | 7.1% | 0/8 | FAIL |
| 14 | `dema_cross` | 33.3 | p31 | -1.64 | 1.86 | 0.73 | 22 | 8.2% | 0/8 | FAIL |
| 15 | `lob_maker` | 31.1 | p26 | -2.62 | 1.80 | 0.70 | 58 | 17.6% | 0/8 | FAIL |
...
| `roc_ma_cross` | -6.02% | -2.91 | 0.47 | 18 | 0/8 | FAIL |
...
| `roc_ma_cross` | profit_factor 0.44 < 1.5 (x2), sharpe -2.87 < 1.0 (x1), mc_p_value 0.929 > 0.1 (우연 가능성) (x1) |
