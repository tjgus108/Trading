...
_Generated: 2026-06-05T00:14:24.170134Z_
...
_Generated: 2026-06-05T00:21:38.235092Z_
_Symbol: BTC/USDT_
...
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `supertrend_multi` | 72.7 | p100 | 0.43 | 2.62 | 1.13 | 47 | 10.5% | 2/8 | FAIL |
| 2 | `price_cluster` | 69.4 | p95 | 0.40 | 1.43 | 1.12 | 45 | 11.8% | 1/8 | FAIL |
| 3 | `roc_ma_cross` | 66.4 | p90 | -0.11 | 2.66 | 1.15 | 40 | 9.1% | 2/8 | FAIL |
| 4 | `narrow_range` | 60.3 | p85 | -0.10 | 1.28 | 1.04 | 50 | 11.1% | 0/8 | FAIL |
| 5 | `positional_scaling` | 59.8 | p80 | -0.10 | 3.00 | 1.17 | 36 | 10.4% | 1/8 | FAIL |
| 6 | `frama` | 59.3 | p76 | 0.01 | 1.26 | 1.06 | 42 | 9.6% | 0/8 | FAIL |
| 7 | `order_flow_imbalance_v2` | 59.1 | p71 | -0.55 | 1.81 | 0.98 | 77 | 14.8% | 0/8 | FAIL |
| 8 | `volume_breakout` | 58.1 | p66 | -0.35 | 2.65 | 1.04 | 78 | 15.7% | 0/8 | FAIL |
| 9 | `lob_maker` | 57.8 | p61 | -0.55 | 1.81 | 0.98 | 84 | 18.9% | 0/8 | FAIL |
| 10 | `htf_ema` | 57.6 | p57 | -0.15 | 1.26 | 1.02 | 45 | 11.1% | 0/8 | FAIL |
| 11 | `price_action_momentum` | 54.9 | p52 | -0.85 | 2.97 | 1.01 | 82 | 18.2% | 1/8 | FAIL |
| 12 | `momentum_quality` | 54.1 | p47 | -0.81 | 2.93 | 1.00 | 66 | 15.3% | 1/8 | FAIL |
| 13 | `cmf` | 47.6 | p42 | -1.31 | 1.84 | 0.90 | 82 | 19.5% | 0/8 | FAIL |
| 14 | `acceleration_band` | 45.3 | p38 | -0.87 | 2.19 | 0.97 | 45 | 14.5% | 0/8 | FAIL |
| 15 | `relative_volume` | 43.0 | p33 | -1.44 | 1.74 | 0.86 | 59 | 14.0% | 0/8 | FAIL |
...
| `cmf` | -9.16% | -1.31 | 0.90 | 82 | 0/8 | FAIL |
...
| `cmf` | profit_factor 1.17 < 1.5 (x1), mc_p_value 0.265 > 0.05 (우연 가능성) (x1), sharpe -3.64 < 1.0 (x1) |
...
|-------------|-------------|
| profit_factor 0.82 < 1.5 | 7 |
| profit_factor 1.01 < 1.5 | 5 |
...
| mc_p_value 0.999 > 0.05 (우연 가능성) | 3 |
...
_Generated: 2026-06-05T00:28:55.861254Z_
_Symbol: ETH/USDT_
...
| 7 | `cmf` | 45.3 | p71 | -1.42 | 2.14 | 0.87 | 72 | 17.7% | 0/8 | FAIL |
...
| `cmf` | -7.25% | -1.42 | 0.87 | 72 | 0/8 | FAIL |
...
| `cmf` | sharpe -2.43 < 1.0 (x1), profit_factor 0.73 < 1.5 (x1), mc_p_value 0.869 > 0.05 (우연 가능성) (x1) |
...
_Generated: 2026-06-05T00:35:45.047944Z_
_Symbol: SOL/USDT_
...
| 14 | `cmf` | 41.5 | p38 | -2.05 | 1.72 | 0.77 | 68 | 16.2% | 0/8 | FAIL |
| 15 | `lob_maker` | 40.3 | p33 | -1.92 | 1.63 | 0.78 | 67 | 19.6% | 0/8 | FAIL |
...
| `cmf` | -10.26% | -2.05 | 0.77 | 68 | 0/8 | FAIL |
...
| `cmf` | profit_factor 1.04 < 1.5 (x2), sharpe -4.67 < 1.0 (x1), max_drawdown 21.3% > 20% (x1) |
