...
_Generated: 2026-05-29T15:32:00.214973Z_
_Symbol: SOL/USDT_
_Data Source: Synthetic BlockBootstrap x8640 (SOL/USDT-like, seed=246669640, block=24)_
_Data Range: 0 ~ 8639 (8640봉)_
_Walk-Forward: 4개 윈도우 (train=5040h, test=1440h)_
_Initial Balance: $10,000 USDT | Fee: 0.1% | Slippage: 0.05%_
_통과 기준: 윈도우 50% 이상에서 Sharpe>=1.0, PF>=1.5, Trades>=15, MDD<=20%_
...
| FAIL | 22개 |
| 평균 수익률 | 15.63% |
| 최고 수익률 | 52.78% (order_flow_imbalance_v2) |
| 최저 수익률 | -4.56% (frama) |
...
| # | Name | AvgReturn | AvgSharpe | AvgWR | AvgPF | AvgTrades | AvgMDD | Consistency | Pass |
|---|------|-----------|-----------|-------|-------|-----------|--------|-------------|------|
| 1 | `order_flow_imbalance_v2` | +52.78% | 4.02 | 48.1% | 1.66 | 85 | 14.2% | 0/4 | FAIL |
| 2 | `price_action_momentum` | +45.33% | 3.42 | 44.8% | 1.40 | 146 | 19.0% | 0/4 | FAIL |
| 3 | `lob_maker` | +36.90% | 2.57 | 42.7% | 1.35 | 123 | 19.6% | 0/4 | FAIL |
| 4 | `momentum_quality` | +35.27% | 3.57 | 45.8% | 1.49 | 110 | 9.2% | 0/4 | FAIL |
| 5 | `acceleration_band` | +31.69% | 2.94 | 44.4% | 1.41 | 100 | 12.5% | 0/4 | FAIL |
| 6 | `supertrend_multi` | +27.05% | 3.33 | 47.0% | 1.52 | 83 | 8.2% | 0/4 | FAIL |
| 7 | `cmf` | +23.83% | 1.98 | 41.3% | 1.25 | 118 | 25.2% | 0/4 | FAIL |
| 8 | `htf_ema` | +21.16% | 2.47 | 44.9% | 1.42 | 67 | 11.9% | 0/4 | FAIL |
| 9 | `volume_breakout` | +17.73% | 1.95 | 42.1% | 1.30 | 91 | 13.0% | 0/4 | FAIL |
| 10 | `narrow_range` | +16.53% | 2.00 | 42.6% | 1.29 | 98 | 13.2% | 0/4 | FAIL |
...
| Rank | Name | Score | Pctl | AvgSharpe | SharpeStd | AvgPF | AvgTrades | AvgMDD | Consist | Pass |
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `momentum_quality` | 61.3 | p100 | 3.57 | 1.11 | 1.49 | 110 | 9.2% | 0/4 | FAIL |
| 2 | `wick_reversal` | 57.8 | p95 | 0.49 | 0.85 | 250.00 | 0 | 0.0% | 0/4 | FAIL |
| 3 | `supertrend_multi` | 56.8 | p90 | 3.33 | 1.28 | 1.52 | 83 | 8.2% | 0/4 | FAIL |
| 4 | `acceleration_band` | 54.8 | p85 | 2.94 | 1.07 | 1.41 | 100 | 12.5% | 0/4 | FAIL |
| 5 | `price_action_momentum` | 54.1 | p80 | 3.42 | 1.88 | 1.40 | 146 | 19.0% | 0/4 | FAIL |
| 6 | `order_flow_imbalance_v2` | 53.8 | p76 | 4.02 | 2.00 | 1.66 | 85 | 14.2% | 0/4 | FAIL |
| 7 | `htf_ema` | 48.2 | p71 | 2.47 | 1.16 | 1.42 | 67 | 11.9% | 0/4 | FAIL |
| 8 | `volume_breakout` | 47.2 | p66 | 1.95 | 1.09 | 1.30 | 91 | 13.0% | 0/4 | FAIL |
| 9 | `volatility_cluster` | 46.1 | p61 | 2.01 | 1.26 | 1.32 | 78 | 11.7% | 0/4 | FAIL |
| 10 | `narrow_range` | 46.0 | p57 | 2.00 | 1.47 | 1.29 | 98 | 13.2% | 0/4 | FAIL |
| 11 | `lob_maker` | 45.9 | p52 | 2.57 | 1.91 | 1.35 | 123 | 19.6% | 0/4 | FAIL |
| 12 | `cmf` | 42.9 | p47 | 1.98 | 1.09 | 1.25 | 118 | 25.2% | 0/4 | FAIL |
| 13 | `roc_ma_cross` | 40.3 | p42 | 1.93 | 1.83 | 1.58 | 40 | 8.8% | 0/4 | FAIL |
| 14 | `relative_volume` | 39.8 | p38 | 0.90 | 0.81 | 1.18 | 59 | 11.3% | 0/4 | FAIL |
| 15 | `engulfing_zone` | 37.4 | p33 | 0.84 | 1.02 | 1.33 | 17 | 5.8% | 0/4 | FAIL |

## 전체 결과

| Name | AvgReturn | AvgSharpe | AvgPF | AvgTrades | Consistency | Pass |
|------|-----------|-----------|-------|-----------|-------------|------|
| `order_flow_imbalance_v2` | +52.78% | 4.02 | 1.66 | 85 | 0/4 | FAIL |
| `price_action_momentum` | +45.33% | 3.42 | 1.40 | 146 | 0/4 | FAIL |
| `lob_maker` | +36.90% | 2.57 | 1.35 | 123 | 0/4 | FAIL |
| `momentum_quality` | +35.27% | 3.57 | 1.49 | 110 | 0/4 | FAIL |
| `acceleration_band` | +31.69% | 2.94 | 1.41 | 100 | 0/4 | FAIL |
| `supertrend_multi` | +27.05% | 3.33 | 1.52 | 83 | 0/4 | FAIL |
| `cmf` | +23.83% | 1.98 | 1.25 | 118 | 0/4 | FAIL |
| `htf_ema` | +21.16% | 2.47 | 1.42 | 67 | 0/4 | FAIL |
| `volume_breakout` | +17.73% | 1.95 | 1.30 | 91 | 0/4 | FAIL |
| `narrow_range` | +16.53% | 2.00 | 1.29 | 98 | 0/4 | FAIL |
| `volatility_cluster` | +14.28% | 2.01 | 1.32 | 78 | 0/4 | FAIL |
| `roc_ma_cross` | +9.88% | 1.93 | 1.58 | 40 | 0/4 | FAIL |
| `positional_scaling` | +5.97% | 1.27 | 1.61 | 27 | 0/4 | FAIL |
| `relative_volume` | +4.67% | 0.90 | 1.18 | 59 | 0/4 | FAIL |
| `linear_channel_rev` | +3.42% | 0.84 | 1.24 | 30 | 0/4 | FAIL |
| `engulfing_zone` | +3.42% | 0.84 | 1.33 | 17 | 0/4 | FAIL |
| `value_area` | +1.12% | 0.24 | 1.19 | 16 | 0/4 | FAIL |
| `price_cluster` | +0.91% | 0.17 | 1.13 | 35 | 0/4 | FAIL |
| `wick_reversal` | +0.47% | 0.49 | 250.00 | 0 | 0/4 | FAIL |
| `dema_cross` | -1.85% | -0.80 | 0.95 | 14 | 0/4 | FAIL |
| `elder_impulse` | -2.06% | -0.21 | 1.01 | 55 | 0/4 | FAIL |
| `frama` | -4.56% | -0.68 | 0.98 | 85 | 0/4 | FAIL |

## FAIL 원인 분석

| Strategy | Top Fail Reasons (reason x count) |
|----------|-----------------------------------|
| `order_flow_imbalance_v2` | profit_factor 1.18 < 1.5 (x1), mc_p_value 0.418 > 0.05 (우연 가능성) (x1), mc_p_value 0.358 > 0.05 (우연 가능성) (x1) |
| `price_action_momentum` | profit_factor 1.19 < 1.5 (x1), mc_p_value 0.408 > 0.05 (우연 가능성) (x1), max_drawdown 20.7% > 20% (x1) |
| `lob_maker` | profit_factor 1.22 < 1.5 (x1), mc_p_value 0.438 > 0.05 (우연 가능성) (x1), profit_factor 1.40 < 1.5 (x1) |
| `momentum_quality` | profit_factor 1.28 < 1.5 (x1), mc_p_value 0.430 > 0.05 (우연 가능성) (x1), mc_p_value 0.364 > 0.05 (우연 가능성) (x1) |
| `acceleration_band` | profit_factor 1.42 < 1.5 (x1), mc_p_value 0.366 > 0.05 (우연 가능성) (x1), profit_factor 1.39 < 1.5 (x1) |
| `supertrend_multi` | mc_p_value 0.348 > 0.05 (우연 가능성) (x1), profit_factor 1.20 < 1.5 (x1), mc_p_value 0.454 > 0.05 (우연 가능성) (x1) |
| `cmf` | profit_factor 1.23 < 1.5 (x1), mc_p_value 0.412 > 0.05 (우연 가능성) (x1), max_drawdown 29.0% > 20% (x1) |
| `htf_ema` | profit_factor 1.47 < 1.5 (x1), mc_p_value 0.372 > 0.05 (우연 가능성) (x1), sharpe 0.50 < 1.0 (x1) |
| `volume_breakout` | profit_factor 1.34 < 1.5 (x1), mc_p_value 0.444 > 0.05 (우연 가능성) (x1), profit_factor 1.19 < 1.5 (x1) |
| `narrow_range` | sharpe 0.77 < 1.0 (x1), profit_factor 1.12 < 1.5 (x1), mc_p_value 0.430 > 0.05 (우연 가능성) (x1) |
| `volatility_cluster` | profit_factor 1.41 < 1.5 (x1), mc_p_value 0.366 > 0.05 (우연 가능성) (x1), profit_factor 1.42 < 1.5 (x1) |
| `roc_ma_cross` | sharpe 0.48 < 1.0 (x1), profit_factor 1.11 < 1.5 (x1), mc_p_value 0.494 > 0.05 (우연 가능성) (x1) |
| `positional_scaling` | mc_p_value 0.406 > 0.05 (우연 가능성) (x1), mc_p_value 0.444 > 0.05 (우연 가능성) (x1), sharpe 0.64 < 1.0 (x1) |
| `relative_volume` | profit_factor 1.24 < 1.5 (x1), mc_p_value 0.466 > 0.05 (우연 가능성) (x1), sharpe -0.25 < 1.0 (x1) |
| `linear_channel_rev` | mc_p_value 0.450 > 0.05 (우연 가능성) (x1), sharpe -0.61 < 1.0 (x1), profit_factor 0.90 < 1.5 (x1) |
| `engulfing_zone` | sharpe 0.67 < 1.0 (x1), profit_factor 1.23 < 1.5 (x1), mc_p_value 0.486 > 0.05 (우연 가능성) (x1) |
| `value_area` | sharpe -0.17 < 1.0 (x1), profit_factor 0.99 < 1.5 (x1), mc_p_value 0.516 > 0.05 (우연 가능성) (x1) |
| `price_cluster` | sharpe -1.45 < 1.0 (x1), profit_factor 0.81 < 1.5 (x1), mc_p_value 0.506 > 0.05 (우연 가능성) (x1) |
| `wick_reversal` | no trades generated (x3), trades 1 < 15 (x1) |
| `dema_cross` | sharpe 0.42 < 1.0 (x1), profit_factor 1.15 < 1.5 (x1), trades 13 < 15 (x1) |

### 전체 FAIL 원인 빈도 (상위 10)

| Fail Reason | Total Count |
|-------------|-------------|
| mc_p_value 0.366 > 0.05 (우연 가능성) | 4 |
| mc_p_value 0.486 > 0.05 (우연 가능성) | 4 |
| mc_p_value 0.372 > 0.05 (우연 가능성) | 3 |
| mc_p_value 0.456 > 0.05 (우연 가능성) | 3 |
...
- **전체 22개 균등배분**: +15.63% -> $11,563
- **Top 5 균등배분**: +40.39% -> $14,039
