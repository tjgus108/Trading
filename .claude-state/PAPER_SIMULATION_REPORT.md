...
_Generated: 2026-06-29T15:17:18.419539Z_
...
_Generated: 2026-06-29T15:21:09.042501Z_
_Symbol: BTC/USDT_
...
| 2 | `dema_cross` | +2.25% | 0.55 | 39.0% | 1.35 | 26 | 6.6% | 2/8 | FAIL |
...
| 6 | `roc_ma_cross` | -2.01% | -0.91 | 31.0% | 1.00 | 34 | 9.8% | 1/8 | FAIL |
...
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `price_cluster` | 66.0 | p100 | 0.87 | 1.10 | 1.20 | 41 | 9.8% | 1/8 | FAIL |
| 2 | `dema_cross` | 63.9 | p94 | 0.55 | 2.32 | 1.35 | 26 | 6.6% | 2/8 | FAIL |
| 3 | `frama` | 57.2 | p88 | 0.24 | 1.60 | 1.12 | 40 | 9.4% | 1/8 | FAIL |
| 4 | `lob_maker` | 53.8 | p83 | -0.04 | 1.99 | 1.05 | 75 | 17.0% | 0/8 | FAIL |
| 5 | `volume_breakout` | 45.7 | p77 | -0.74 | 2.18 | 0.96 | 72 | 15.4% | 0/8 | FAIL |
| 6 | `positional_scaling` | 45.6 | p72 | -0.38 | 2.82 | 1.09 | 34 | 9.2% | 1/8 | FAIL |
| 7 | `price_action_momentum` | 44.5 | p66 | -1.08 | 2.79 | 0.97 | 73 | 16.7% | 1/8 | FAIL |
| 8 | `order_flow_imbalance_v2` | 44.3 | p61 | -0.77 | 2.05 | 0.95 | 67 | 15.0% | 0/8 | FAIL |
| 9 | `narrow_range` | 44.1 | p55 | -0.51 | 1.48 | 0.97 | 46 | 10.1% | 0/8 | FAIL |
| 10 | `relative_volume` | 43.8 | p50 | -0.99 | 1.72 | 0.92 | 64 | 13.2% | 0/8 | FAIL |
| 11 | `momentum_quality` | 41.8 | p44 | -1.19 | 3.29 | 0.96 | 71 | 15.8% | 1/8 | FAIL |
| 12 | `htf_ema` | 40.0 | p38 | -0.72 | 0.71 | 0.91 | 43 | 11.2% | 0/8 | FAIL |
| 13 | `acceleration_band` | 39.7 | p33 | -0.94 | 2.58 | 0.98 | 44 | 13.0% | 1/8 | FAIL |
| 14 | `cmf` | 39.6 | p27 | -1.23 | 1.29 | 0.88 | 68 | 16.3% | 0/8 | FAIL |
| 15 | `roc_ma_cross` | 38.4 | p22 | -0.91 | 2.77 | 1.00 | 34 | 9.8% | 1/8 | FAIL |
...
| `dema_cross` | sharpe -0.56 < 1.0 (x1), profit_factor 0.91 < 1.5 (x1), mc_p_value 0.614 > 0.1 (우연 가능성) (x1) |
...
| `roc_ma_cross` | sharpe 0.32 < 1.0 (x1), profit_factor 1.08 < 1.5 (x1), mc_p_value 0.389 > 0.1 (우연 가능성) (x1) |
...
_Generated: 2026-06-29T15:24:37.328656Z_
_Symbol: ETH/USDT_
...
| 9 | `dema_cross` | -5.31% | -2.06 | 25.5% | 0.64 | 23 | 8.2% | 0/8 | FAIL |
| 10 | `volatility_cluster` | -5.39% | -1.49 | 33.3% | 0.81 | 42 | 9.4% | 0/8 | FAIL |
...
| 13 | `dema_cross` | 26.9 | p33 | -2.06 | 1.09 | 0.64 | 23 | 8.2% | 0/8 | FAIL |
| 14 | `roc_ma_cross` | 25.7 | p27 | -2.35 | 2.65 | 0.71 | 29 | 10.0% | 0/8 | FAIL |
| 15 | `linear_channel_rev` | 24.3 | p22 | -2.33 | 1.19 | 0.60 | 23 | 7.9% | 0/8 | FAIL |
...
| `dema_cross` | -5.31% | -2.06 | 0.64 | 23 | 0/8 | FAIL |
...
| `roc_ma_cross` | -5.92% | -2.35 | 0.71 | 29 | 0/8 | FAIL |
...
| `dema_cross` | profit_factor 0.58 < 1.5 (x2), sharpe -0.82 < 1.0 (x1), profit_factor 0.82 < 1.5 (x1) |
...
| `roc_ma_cross` | sharpe -5.69 < 1.0 (x1), profit_factor 0.28 < 1.5 (x1), mc_p_value 0.994 > 0.1 (우연 가능성) (x1) |
...
_Generated: 2026-06-29T15:27:52.910256Z_
_Symbol: SOL/USDT_
...
| 2 | `volatility_cluster` | 54.0 | p94 | -0.12 | 1.16 | 1.02 | 41 | 8.7% | 0/8 | FAIL |
| 3 | `lob_maker` | 48.1 | p88 | -0.73 | 0.95 | 0.90 | 56 | 13.0% | 0/8 | FAIL |
| 4 | `relative_volume` | 47.4 | p83 | -0.61 | 2.05 | 0.97 | 50 | 10.7% | 0/8 | FAIL |
| 5 | `momentum_quality` | 45.9 | p77 | -1.18 | 0.96 | 0.85 | 56 | 10.5% | 0/8 | FAIL |
| 6 | `order_flow_imbalance_v2` | 43.3 | p72 | -1.22 | 0.78 | 0.84 | 55 | 12.0% | 0/8 | FAIL |
| 7 | `cmf` | 37.8 | p66 | -1.28 | 0.94 | 0.82 | 44 | 10.3% | 0/8 | FAIL |
| 8 | `volume_breakout` | 36.9 | p61 | -1.45 | 1.33 | 0.82 | 58 | 14.2% | 0/8 | FAIL |
| 9 | `positional_scaling` | 32.4 | p55 | -1.12 | 2.17 | 0.87 | 32 | 8.8% | 0/8 | FAIL |
| 10 | `elder_impulse` | 30.8 | p50 | -1.91 | 3.14 | 0.82 | 36 | 11.6% | 1/8 | FAIL |
| 11 | `acceleration_band` | 29.5 | p44 | -0.80 | 1.82 | 1.00 | 11 | 4.7% | 0/8 | FAIL |
| 12 | `price_action_momentum` | 29.4 | p38 | -1.88 | 0.97 | 0.75 | 47 | 12.3% | 0/8 | FAIL |
| 13 | `htf_ema` | 26.7 | p33 | -1.45 | 1.94 | 0.80 | 30 | 9.0% | 0/8 | FAIL |
| 14 | `frama` | 23.2 | p27 | -1.94 | 1.83 | 0.74 | 42 | 12.6% | 0/8 | FAIL |
| 15 | `price_cluster` | 19.9 | p22 | -2.09 | 0.57 | 0.67 | 32 | 10.4% | 0/8 | FAIL |
...
| `dema_cross` | -6.22% | -2.26 | 0.66 | 27 | 0/8 | FAIL |
| `roc_ma_cross` | -6.35% | -2.13 | 0.67 | 30 | 0/8 | FAIL |
...
| `dema_cross` | sharpe -2.33 < 1.0 (x1), profit_factor 0.64 < 1.5 (x1), mc_p_value 0.859 > 0.1 (우연 가능성) (x1) |
| `roc_ma_cross` | sharpe -1.57 < 1.0 (x1), profit_factor 0.71 < 1.5 (x1), mc_p_value 0.789 > 0.1 (우연 가능성) (x1) |
...
| `roc_ma_cross` | 0 | 121 | 115 | 48.7% |
| `momentum_quality` | 0 | 231 | 215 | 48.2% |
| `dema_cross` | 0 | 112 | 104 | 48.1% |
