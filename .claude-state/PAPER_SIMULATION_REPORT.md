...
_Generated: 2026-06-22T11:10:40.109220Z_
...
_Generated: 2026-06-22T11:14:49.939400Z_
_Symbol: BTC/USDT_
...
|---|------|-----------|-----------|-------|-------|-----------|--------|-------------|------|
| 1 | `roc_ma_cross` | +5.87% | 1.14 | 39.1% | 1.37 | 33 | 6.3% | 2/8 | FAIL |
...
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `roc_ma_cross` | 73.3 | p100 | 1.14 | 1.97 | 1.37 | 33 | 6.3% | 2/8 | FAIL |
| 2 | `price_cluster` | 66.5 | p94 | 0.87 | 1.10 | 1.20 | 41 | 9.8% | 1/8 | FAIL |
| 3 | `frama` | 58.9 | p89 | 0.24 | 1.60 | 1.12 | 40 | 9.4% | 1/8 | FAIL |
| 4 | `lob_maker` | 55.0 | p84 | -0.04 | 1.99 | 1.05 | 75 | 17.0% | 0/8 | FAIL |
| 5 | `positional_scaling` | 48.8 | p78 | -0.38 | 2.82 | 1.09 | 34 | 9.2% | 1/8 | FAIL |
| 6 | `volume_breakout` | 47.8 | p73 | -0.74 | 2.18 | 0.96 | 72 | 15.4% | 0/8 | FAIL |
| 7 | `narrow_range` | 47.2 | p68 | -0.51 | 1.48 | 0.97 | 46 | 10.1% | 0/8 | FAIL |
| 8 | `price_action_momentum` | 47.1 | p63 | -1.08 | 2.79 | 0.97 | 73 | 16.7% | 1/8 | FAIL |
| 9 | `order_flow_imbalance_v2` | 46.8 | p57 | -0.77 | 2.05 | 0.95 | 67 | 15.0% | 0/8 | FAIL |
| 10 | `relative_volume` | 46.4 | p52 | -0.99 | 1.72 | 0.92 | 64 | 13.2% | 0/8 | FAIL |
| 11 | `momentum_quality` | 44.4 | p47 | -1.19 | 3.29 | 0.96 | 71 | 15.8% | 1/8 | FAIL |
| 12 | `htf_ema` | 44.4 | p42 | -0.72 | 0.71 | 0.91 | 43 | 11.2% | 0/8 | FAIL |
| 13 | `acceleration_band` | 44.0 | p36 | -0.94 | 2.58 | 0.98 | 44 | 13.0% | 1/8 | FAIL |
| 14 | `cmf` | 43.5 | p31 | -1.23 | 1.29 | 0.88 | 68 | 16.3% | 0/8 | FAIL |
| 15 | `elder_impulse` | 38.3 | p26 | -1.15 | 1.14 | 0.85 | 42 | 11.5% | 0/8 | FAIL |

## 전체 결과

| Name | AvgReturn | AvgSharpe | AvgPF | AvgTrades | Consistency | Pass |
|------|-----------|-----------|-------|-----------|-------------|------|
| `roc_ma_cross` | +5.87% | 1.14 | 1.37 | 33 | 2/8 | FAIL |
...
|----------|-----------------------------------|
| `roc_ma_cross` | sharpe 0.84 < 1.0 (x1), profit_factor 1.20 < 1.5 (x1), mc_p_value 0.302 > 0.1 (우연 가능성) (x1) |
...
- **전체 20개 균등배분**: -3.03% -> $9,697
- **Top 5 균등배분**: +2.58% -> $10,258
...
_Generated: 2026-06-22T11:18:53.420442Z_
_Symbol: ETH/USDT_
...
| `roc_ma_cross` | -5.39% | -1.95 | 0.71 | 28 | 0/8 | FAIL |
...
| `roc_ma_cross` | profit_factor 0.64 < 1.5 (x2), sharpe -2.39 < 1.0 (x1), profit_factor 0.57 < 1.5 (x1) |
...
_Generated: 2026-06-22T11:22:42.072490Z_
_Symbol: SOL/USDT_
...
| 8 | `roc_ma_cross` | -2.90% | -1.17 | 32.9% | 0.82 | 26 | 7.3% | 0/8 | FAIL |
| 9 | `volatility_cluster` | -3.38% | -0.96 | 31.6% | 0.85 | 39 | 9.2% | 0/8 | FAIL |
| 10 | `linear_channel_rev` | -3.88% | -1.32 | 29.0% | 0.77 | 26 | 6.8% | 0/8 | FAIL |
...
| 10 | `roc_ma_cross` | 41.0 | p52 | -1.17 | 1.68 | 0.82 | 26 | 7.3% | 0/8 | FAIL |
| 11 | `linear_channel_rev` | 40.2 | p47 | -1.32 | 1.00 | 0.77 | 26 | 6.8% | 0/8 | FAIL |
| 12 | `relative_volume` | 38.7 | p42 | -2.36 | 1.28 | 0.72 | 60 | 14.5% | 0/8 | FAIL |
...
| `roc_ma_cross` | -2.90% | -1.17 | 0.82 | 26 | 0/8 | FAIL |
...
| `roc_ma_cross` | sharpe -2.39 < 1.0 (x2), profit_factor 0.58 < 1.5 (x1), mc_p_value 0.886 > 0.1 (우연 가능성) (x1) |
