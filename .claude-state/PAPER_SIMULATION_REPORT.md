...
_Generated: 2026-06-15T15:17:34.625523Z_
...
|---|------|-----------|-----------|-------|-------|-----------|--------|-------------|------|
| 1 | `price_cluster` | +4.50% | 0.59 | 39.4% | 1.18 | 46 | 12.2% | 3/8 | FAIL |
| 2 | `supertrend_multi` | +4.23% | 0.02 | 34.6% | 1.06 | 35 | 9.0% | 2/8 | FAIL |
...
| 2 | `supertrend_multi` | 60.8 | p90 | 0.02 | 2.73 | 1.06 | 35 | 9.0% | 2/8 | FAIL |
| 3 | `roc_ma_cross` | 60.8 | p95 | -0.35 | 2.88 | 1.12 | 40 | 9.6% | 2/8 | FAIL |
...
| 14 | `cmf` | 50.0 | p38 | -1.21 | 1.91 | 0.90 | 72 | 18.4% | 0/8 | FAIL |
| 15 | `momentum_quality` | 49.4 | p33 | -1.31 | 3.52 | 0.96 | 77 | 18.1% | 1/8 | FAIL |
...
| `supertrend_multi` | +4.23% | 0.02 | 1.06 | 35 | 2/8 | FAIL |
...
| `supertrend_multi` | sharpe 0.95 < 1.0 (x1), profit_factor 1.25 < 1.5 (x1), mc_p_value 0.311 > 0.1 (우연 가능성) (x1) |
...
- **전체 22개 균등배분**: -4.28% -> $9,572
- **Top 5 균등배분**: +2.03% -> $10,203
...
_Generated: 2026-06-15T15:29:27.669567Z_
_Symbol: ETH/USDT_
...
| 10 | `roc_ma_cross` | -4.06% | -1.11 | 37.9% | 0.83 | 34 | 9.5% | 0/8 | FAIL |
...
| Rank | Name | Score | Pctl | AvgSharpe | SharpeStd | AvgPF | AvgTrades | AvgMDD | Consist | Pass |
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `momentum_quality` | 58.8 | p100 | -0.45 | 1.19 | 0.97 | 73 | 12.3% | 0/8 | FAIL |
| 2 | `volatility_cluster` | 57.7 | p95 | 0.12 | 1.37 | 1.07 | 51 | 9.1% | 0/8 | FAIL |
| 3 | `narrow_range` | 56.7 | p90 | 0.06 | 1.46 | 1.06 | 51 | 9.9% | 0/8 | FAIL |
| 4 | `dema_cross` | 55.7 | p85 | 0.73 | 2.06 | 1.67 | 14 | 3.5% | 0/8 | FAIL |
| 5 | `cmf` | 54.9 | p80 | -0.94 | 2.43 | 0.94 | 56 | 15.2% | 1/8 | FAIL |
| 6 | `price_action_momentum` | 54.5 | p76 | -0.08 | 1.42 | 1.03 | 51 | 11.3% | 0/8 | FAIL |
| 7 | `value_area` | 41.5 | p71 | -1.51 | 1.23 | 0.81 | 51 | 12.1% | 0/8 | FAIL |
| 8 | `engulfing_zone` | 39.7 | p61 | -1.84 | 3.67 | 0.90 | 27 | 11.3% | 1/8 | FAIL |
| 9 | `relative_volume` | 39.7 | p66 | -2.01 | 2.34 | 0.81 | 70 | 15.6% | 0/8 | FAIL |
| 10 | `roc_ma_cross` | 39.5 | p57 | -1.11 | 1.13 | 0.83 | 34 | 9.5% | 0/8 | FAIL |
| 11 | `lob_maker` | 39.3 | p52 | -1.92 | 1.43 | 0.79 | 70 | 20.8% | 0/8 | FAIL |
| 12 | `elder_impulse` | 38.6 | p47 | -1.52 | 1.81 | 0.81 | 46 | 12.5% | 0/8 | FAIL |
| 13 | `linear_channel_rev` | 36.5 | p42 | -1.25 | 0.72 | 0.78 | 28 | 7.1% | 0/8 | FAIL |
| 14 | `htf_ema` | 35.0 | p38 | -1.43 | 1.68 | 0.78 | 31 | 9.8% | 0/8 | FAIL |
| 15 | `volume_breakout` | 34.1 | p33 | -2.60 | 2.23 | 0.75 | 79 | 20.5% | 0/8 | FAIL |
...
| `supertrend_multi` | -9.15% | -2.39 | 0.70 | 42 | 0/8 | FAIL |
...
| `supertrend_multi` | profit_factor 0.66 < 1.5 (x2), sharpe -6.88 < 1.0 (x1), max_drawdown 20.2% > 20% (x1) |
...
_Generated: 2026-06-15T15:35:10.557308Z_
_Symbol: SOL/USDT_
...
| 9 | `roc_ma_cross` | -2.45% | -1.00 | 38.7% | 0.88 | 32 | 8.0% | 0/8 | FAIL |
| 10 | `dema_cross` | -4.42% | -1.69 | 36.3% | 0.66 | 26 | 7.6% | 0/8 | FAIL |
...
| 2 | `price_action_momentum` | 66.7 | p95 | -0.36 | 2.50 | 1.05 | 48 | 9.3% | 1/8 | FAIL |
| 3 | `elder_impulse` | 66.5 | p90 | 0.34 | 0.86 | 1.07 | 47 | 8.6% | 0/8 | FAIL |
| 4 | `momentum_quality` | 63.7 | p85 | -0.14 | 2.35 | 1.03 | 74 | 13.3% | 0/8 | FAIL |
| 5 | `htf_ema` | 61.2 | p80 | 0.27 | 1.09 | 1.08 | 35 | 7.9% | 0/8 | FAIL |
| 6 | `volatility_cluster` | 60.4 | p76 | -0.17 | 1.57 | 1.01 | 49 | 9.4% | 0/8 | FAIL |
| 7 | `frama` | 48.6 | p71 | -1.41 | 1.26 | 0.81 | 60 | 14.8% | 0/8 | FAIL |
| 8 | `acceleration_band` | 46.6 | p66 | -0.44 | 1.91 | 1.22 | 7 | 3.8% | 0/8 | FAIL |
| 9 | `relative_volume` | 45.7 | p61 | -2.06 | 1.19 | 0.76 | 73 | 16.5% | 0/8 | FAIL |
| 10 | `roc_ma_cross` | 45.0 | p57 | -1.00 | 2.06 | 0.88 | 32 | 8.0% | 0/8 | FAIL |
| 11 | `volume_breakout` | 44.9 | p52 | -1.41 | 2.47 | 0.86 | 58 | 15.2% | 0/8 | FAIL |
| 12 | `narrow_range` | 40.6 | p47 | -1.77 | 2.33 | 0.80 | 48 | 12.1% | 0/8 | FAIL |
| 13 | `cmf` | 39.6 | p42 | -1.98 | 1.74 | 0.75 | 52 | 14.2% | 0/8 | FAIL |
| 14 | `lob_maker` | 39.5 | p38 | -2.20 | 1.57 | 0.75 | 67 | 19.1% | 0/8 | FAIL |
| 15 | `value_area` | 37.9 | p33 | -2.27 | 1.43 | 0.70 | 52 | 12.9% | 0/8 | FAIL |
...
| `roc_ma_cross` | -2.45% | -1.00 | 0.88 | 32 | 0/8 | FAIL |
...
| `price_cluster` | -7.75% | -2.23 | 0.62 | 26 | 0/8 | FAIL |
| `supertrend_multi` | -8.08% | -2.46 | 0.64 | 34 | 0/8 | FAIL |
| `frama` | -8.13% | -1.41 | 0.81 | 60 | 0/8 | FAIL |
| `value_area` | -8.50% | -2.27 | 0.70 | 52 | 0/8 | FAIL |
...
| `roc_ma_cross` | profit_factor 0.63 < 1.5 (x2), sharpe -2.07 < 1.0 (x1), mc_p_value 0.847 > 0.1 (우연 가능성) (x1) |
...
| `price_cluster` | profit_factor 0.44 < 1.5 (x2), sharpe -0.13 < 1.0 (x1), profit_factor 0.97 < 1.5 (x1) |
| `supertrend_multi` | sharpe -0.68 < 1.0 (x1), profit_factor 0.88 < 1.5 (x1), mc_p_value 0.653 > 0.1 (우연 가능성) (x1) |
| `frama` | sharpe -2.57 < 1.0 (x1), max_drawdown 22.3% > 20% (x1), profit_factor 0.65 < 1.5 (x1) |
| `value_area` | sharpe -2.45 < 1.0 (x1), profit_factor 0.69 < 1.5 (x1), mc_p_value 0.896 > 0.1 (우연 가능성) (x1) |
...
|-------------|-------------|
| no trades generated | 8 |
| profit_factor 0.71 < 1.5 | 5 |
| profit_factor 0.97 < 1.5 | 4 |
| profit_factor 0.86 < 1.5 | 4 |
| trades 7 < 15 | 4 |
| profit_factor 0.56 < 1.5 | 4 |
