...
_Generated: 2026-06-12T05:13:54.956313Z_
...
_Generated: 2026-06-12T05:15:15.165966Z_
_Symbol: BTC/USDT_
...
|---|------|-----------|-----------|-------|-------|-----------|--------|-------------|------|
| 1 | `price_cluster` | +7.53% | 3.76 | 53.5% | 2.28 | 12 | 3.9% | 2/8 | FAIL |
...
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `price_cluster` | 72.1 | p100 | 3.76 | 2.52 | 2.28 | 12 | 3.9% | 2/8 | FAIL |
| 2 | `momentum_quality` | 61.3 | p95 | 1.48 | 3.81 | 1.33 | 22 | 5.1% | 1/8 | FAIL |
| 3 | `cmf` | 54.9 | p90 | 0.59 | 3.08 | 1.16 | 23 | 6.9% | 1/8 | FAIL |
| 4 | `relative_volume` | 50.7 | p85 | 0.97 | 3.66 | 1.35 | 18 | 4.8% | 0/8 | FAIL |
| 5 | `lob_maker` | 50.3 | p80 | 0.50 | 3.60 | 1.23 | 21 | 7.6% | 1/8 | FAIL |
| 6 | `linear_channel_rev` | 43.4 | p76 | 1.23 | 3.30 | 2.01 | 6 | 2.3% | 0/8 | FAIL |
| 7 | `supertrend_multi` | 42.8 | p71 | 1.84 | 2.92 | 1.14 | 8 | 2.7% | 1/8 | FAIL |
| 8 | `order_flow_imbalance_v2` | 42.7 | p66 | -1.25 | 6.24 | 1.16 | 19 | 7.6% | 3/8 | FAIL |
| 9 | `value_area` | 42.0 | p61 | -0.50 | 3.63 | 1.10 | 16 | 5.2% | 1/8 | FAIL |
| 10 | `price_action_momentum` | 38.5 | p57 | -1.66 | 5.42 | 0.98 | 24 | 7.7% | 1/8 | FAIL |
| 11 | `htf_ema` | 36.8 | p52 | -0.60 | 4.36 | 1.55 | 11 | 5.0% | 0/8 | FAIL |
| 12 | `positional_scaling` | 33.1 | p47 | -1.15 | 5.73 | 1.67 | 10 | 4.5% | 0/8 | FAIL |
| 13 | `volatility_cluster` | 31.9 | p42 | -1.21 | 5.37 | 1.14 | 14 | 5.5% | 0/8 | FAIL |
| 14 | `elder_impulse` | 31.2 | p38 | -1.56 | 6.42 | 1.48 | 14 | 6.5% | 0/8 | FAIL |
| 15 | `volume_breakout` | 29.0 | p33 | -2.40 | 5.40 | 0.91 | 18 | 7.7% | 1/8 | FAIL |

## 전체 결과

| Name | AvgReturn | AvgSharpe | AvgPF | AvgTrades | Consistency | Pass |
|------|-----------|-----------|-------|-----------|-------------|------|
| `price_cluster` | +7.53% | 3.76 | 2.28 | 12 | 2/8 | FAIL |
...
|----------|-----------------------------------|
| `price_cluster` | trades 11 < 15 (x3), trades 9 < 15 (x1), profit_factor 1.48 < 1.5 (x1) |
...
- **전체 22개 균등배분**: -0.14% -> $9,986
- **Top 5 균등배분**: +3.81% -> $10,381
...
_Generated: 2026-06-12T05:16:33.995810Z_
_Symbol: ETH/USDT_
...
| 7 | `price_cluster` | -2.69% | -2.87 | 25.3% | 0.65 | 6 | 4.8% | 0/8 | FAIL |
...
| Rank | Name | Score | Pctl | AvgSharpe | SharpeStd | AvgPF | AvgTrades | AvgMDD | Consist | Pass |
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `acceleration_band` | 61.7 | p100 | 1.19 | 2.43 | 1.57 | 7 | 2.5% | 0/8 | FAIL |
| 2 | `dema_cross` | 61.5 | p95 | 0.86 | 2.80 | 1.52 | 8 | 2.4% | 0/8 | FAIL |
| 3 | `volatility_cluster` | 59.9 | p90 | -0.70 | 2.30 | 1.01 | 16 | 4.6% | 0/8 | FAIL |
| 4 | `engulfing_zone` | 57.9 | p85 | 0.73 | 2.80 | 1.40 | 7 | 3.1% | 0/8 | FAIL |
| 5 | `frama` | 57.0 | p80 | -2.01 | 1.92 | 0.79 | 22 | 9.0% | 0/8 | FAIL |
| 6 | `momentum_quality` | 51.7 | p76 | -3.01 | 4.02 | 0.76 | 24 | 7.8% | 0/8 | FAIL |
| 7 | `narrow_range` | 50.3 | p71 | -1.92 | 2.85 | 0.81 | 17 | 7.5% | 0/8 | FAIL |
| 8 | `order_flow_imbalance_v2` | 46.5 | p66 | -3.18 | 2.89 | 0.70 | 21 | 9.9% | 0/8 | FAIL |
| 9 | `lob_maker` | 45.2 | p61 | -4.06 | 2.17 | 0.62 | 24 | 11.2% | 0/8 | FAIL |
| 10 | `value_area` | 39.0 | p57 | -4.33 | 3.15 | 0.60 | 17 | 6.9% | 0/8 | FAIL |
| 11 | `price_action_momentum` | 37.4 | p52 | -5.17 | 3.40 | 0.56 | 22 | 9.9% | 0/8 | FAIL |
| 12 | `htf_ema` | 36.8 | p47 | -2.80 | 3.86 | 0.86 | 9 | 5.6% | 0/8 | FAIL |
| 13 | `relative_volume` | 35.1 | p42 | -4.82 | 3.03 | 0.53 | 18 | 8.7% | 0/8 | FAIL |
| 14 | `cmf` | 34.9 | p38 | -4.30 | 4.25 | 0.60 | 17 | 8.6% | 0/8 | FAIL |
| 15 | `wick_reversal` | 32.4 | p33 | -3.44 | 3.94 | 0.64 | 10 | 4.8% | 0/8 | FAIL |
...
| `price_cluster` | -2.69% | -2.87 | 0.65 | 6 | 0/8 | FAIL |
...
| `price_cluster` | trades 6 < 15 (x3), trades 5 < 15 (x2), trades 7 < 15 (x2) |
...
_Generated: 2026-06-12T05:17:52.725558Z_
_Symbol: SOL/USDT_
...
| 5 | `price_cluster` | -2.12% | -3.44 | 22.4% | 0.67 | 6 | 4.6% | 0/8 | FAIL |
| 6 | `value_area` | -2.24% | -2.59 | 37.3% | 1.16 | 17 | 6.7% | 0/8 | FAIL |
...
| `price_cluster` | -2.12% | -3.44 | 0.67 | 6 | 0/8 | FAIL |
...
| `price_cluster` | profit_factor 0.00 < 1.5 (x4), trades 8 < 15 (x2), trades 5 < 15 (x2) |
