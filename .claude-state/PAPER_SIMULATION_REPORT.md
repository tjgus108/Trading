...
_Generated: 2026-06-15T05:14:34.369706Z_
...
_Generated: 2026-06-15T05:20:16.954012Z_
_Symbol: BTC/USDT_
...
| 7 | `frama` | 56.4 | p71 | -0.22 | 1.40 | 1.02 | 42 | 9.8% | 0/8 | FAIL |
| 8 | `htf_ema` | 55.6 | p66 | -0.35 | 1.14 | 0.98 | 45 | 11.4% | 0/8 | FAIL |
| 9 | `order_flow_imbalance_v2` | 55.4 | p61 | -0.83 | 2.13 | 0.95 | 73 | 15.8% | 0/8 | FAIL |
| 10 | `lob_maker` | 55.1 | p57 | -0.91 | 1.91 | 0.94 | 84 | 19.7% | 0/8 | FAIL |
| 11 | `acceleration_band` | 54.2 | p52 | -0.63 | 2.20 | 1.00 | 45 | 12.8% | 1/8 | FAIL |
| 12 | `relative_volume` | 50.3 | p47 | -1.44 | 1.68 | 0.87 | 72 | 15.3% | 0/8 | FAIL |
| 13 | `cmf` | 50.0 | p42 | -1.21 | 1.91 | 0.90 | 72 | 18.4% | 0/8 | FAIL |
| 14 | `momentum_quality` | 49.4 | p38 | -1.31 | 3.52 | 0.96 | 77 | 18.1% | 1/8 | FAIL |
| 15 | `narrow_range` | 47.3 | p33 | -1.42 | 2.30 | 0.90 | 57 | 16.4% | 1/8 | FAIL |
...
| `narrow_range` | -6.87% | -1.42 | 0.90 | 57 | 1/8 | FAIL |
...
| `narrow_range` | sharpe -0.06 < 1.0 (x1), profit_factor 1.02 < 1.5 (x1), mc_p_value 0.479 > 0.1 (우연 가능성) (x1) |
...
_Generated: 2026-06-15T05:26:03.789065Z_
_Symbol: ETH/USDT_
...
| 4 | `price_action_momentum` | -0.38% | -0.08 | 42.5% | 1.03 | 51 | 11.3% | 0/8 | FAIL |
| 5 | `momentum_quality` | -2.35% | -0.45 | 39.9% | 0.97 | 73 | 12.3% | 0/8 | FAIL |
| 6 | `cmf` | -3.48% | -0.94 | 37.4% | 0.94 | 56 | 15.2% | 1/8 | FAIL |
...
| 3 | `narrow_range` | 56.2 | p90 | -1.17 | 2.22 | 0.90 | 59 | 13.8% | 1/8 | FAIL |
| 4 | `cmf` | 55.9 | p85 | -0.94 | 2.43 | 0.94 | 56 | 15.2% | 1/8 | FAIL |
| 5 | `dema_cross` | 55.7 | p80 | 0.73 | 2.06 | 1.67 | 14 | 3.5% | 0/8 | FAIL |
| 6 | `price_action_momentum` | 55.0 | p76 | -0.08 | 1.42 | 1.03 | 51 | 11.3% | 0/8 | FAIL |
...
| `narrow_range` | -4.57% | -1.17 | 0.90 | 59 | 1/8 | FAIL |
...
| `narrow_range` | sharpe -2.61 < 1.0 (x1), profit_factor 0.68 < 1.5 (x1), mc_p_value 0.883 > 0.1 (우연 가능성) (x1) |
...
- **전체 22개 균등배분**: -6.38% -> $9,362
- **Top 5 균등배분**: -0.13% -> $9,987
...
_Generated: 2026-06-15T05:31:33.969472Z_
_Symbol: SOL/USDT_
...
| 12 | `narrow_range` | 44.6 | p47 | -1.60 | 1.97 | 0.82 | 55 | 13.1% | 0/8 | FAIL |
...
| `narrow_range` | -6.85% | -1.60 | 0.82 | 55 | 0/8 | FAIL |
...
| `supertrend_multi` | -11.56% | -3.11 | 0.60 | 48 | 0/8 | FAIL |
...
| `narrow_range` | sharpe -1.17 < 1.0 (x1), profit_factor 0.84 < 1.5 (x1), mc_p_value 0.708 > 0.1 (우연 가능성) (x1) |
...
| `supertrend_multi` | sharpe -2.38 < 1.0 (x1), profit_factor 0.69 < 1.5 (x1), mc_p_value 0.877 > 0.1 (우연 가능성) (x1) |
