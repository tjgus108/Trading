...
_Generated: 2026-07-01T05:33:46.518948Z_
...
_Generated: 2026-07-01T05:38:24.971791Z_
_Symbol: BTC/USDT_
...
| 4 | `dema_cross` | +1.50% | 0.41 | 37.5% | 1.25 | 28 | 6.7% | 1/8 | FAIL |
...
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `price_cluster` | 68.8 | p100 | 0.87 | 1.10 | 1.20 | 41 | 9.8% | 1/8 | FAIL |
| 2 | `roc_ma_cross` | 65.8 | p94 | 0.34 | 2.44 | 1.22 | 36 | 8.1% | 2/8 | FAIL |
| 3 | `frama` | 59.7 | p88 | 0.24 | 1.60 | 1.12 | 40 | 9.4% | 1/8 | FAIL |
| 4 | `dema_cross` | 59.3 | p83 | 0.41 | 1.96 | 1.25 | 28 | 6.7% | 1/8 | FAIL |
| 5 | `lob_maker` | 55.9 | p77 | -0.04 | 1.99 | 1.05 | 75 | 17.0% | 0/8 | FAIL |
| 6 | `positional_scaling` | 47.9 | p72 | -0.38 | 2.82 | 1.09 | 34 | 9.2% | 1/8 | FAIL |
| 7 | `volume_breakout` | 47.3 | p66 | -0.74 | 2.18 | 0.96 | 72 | 15.4% | 0/8 | FAIL |
| 8 | `price_action_momentum` | 46.1 | p61 | -1.08 | 2.79 | 0.97 | 73 | 16.7% | 1/8 | FAIL |
| 9 | `order_flow_imbalance_v2` | 45.9 | p55 | -0.77 | 2.05 | 0.95 | 67 | 15.0% | 0/8 | FAIL |
| 10 | `narrow_range` | 45.7 | p50 | -0.51 | 1.48 | 0.97 | 46 | 10.1% | 0/8 | FAIL |
| 11 | `relative_volume` | 45.2 | p44 | -0.99 | 1.72 | 0.92 | 64 | 13.2% | 0/8 | FAIL |
| 12 | `momentum_quality` | 43.4 | p38 | -1.19 | 3.29 | 0.96 | 71 | 15.8% | 1/8 | FAIL |
| 13 | `acceleration_band` | 41.4 | p33 | -0.94 | 2.58 | 0.98 | 44 | 13.0% | 1/8 | FAIL |
| 14 | `htf_ema` | 41.3 | p27 | -0.72 | 0.71 | 0.91 | 43 | 11.2% | 0/8 | FAIL |
| 15 | `cmf` | 40.8 | p22 | -1.23 | 1.29 | 0.88 | 68 | 16.3% | 0/8 | FAIL |
...
| `dema_cross` | +1.50% | 0.41 | 1.25 | 28 | 1/8 | FAIL |
...
| `dema_cross` | sharpe -0.30 < 1.0 (x1), profit_factor 0.96 < 1.5 (x1), mc_p_value 0.520 > 0.1 (우연 가능성) (x1) |
...
_Generated: 2026-07-01T05:42:39.629591Z_
_Symbol: ETH/USDT_
...
| 4 | `dema_cross` | -4.15% | -1.88 | 29.3% | 0.72 | 22 | 7.3% | 0/8 | FAIL |
...
| 13 | `dema_cross` | 27.9 | p33 | -1.88 | 2.14 | 0.72 | 22 | 7.3% | 0/8 | FAIL |
...
| `dema_cross` | -4.15% | -1.88 | 0.72 | 22 | 0/8 | FAIL |
...
| `dema_cross` | profit_factor 0.92 < 1.5 (x2), sharpe -0.34 < 1.0 (x1), mc_p_value 0.558 > 0.1 (우연 가능성) (x1) |
...
- **전체 19개 균등배분**: -5.66% -> $9,434
- **Top 5 균등배분**: -0.49% -> $9,951
