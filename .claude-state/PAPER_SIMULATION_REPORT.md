...
_Generated: 2026-07-03T15:29:55.731129Z_
...
_Generated: 2026-07-03T15:36:15.913209Z_
_Symbol: BTC/USDT_
...
| 2 | `price_cluster` | +4.53% | 0.66 | 37.6% | 1.27 | 27 | 8.0% | 2/8 | FAIL |
...
| 3 | `price_cluster` | 45.1 | p88 | 0.66 | 1.98 | 1.27 | 27 | 8.0% | 2/8 | FAIL |
...
| `price_cluster` | +4.53% | 0.66 | 1.27 | 27 | 2/8 | FAIL |
...
|----------|-----------------------------------|
| `price_cluster` | sharpe -2.01 < 1.0 (x1), profit_factor 0.65 < 1.5 (x1), mc_p_value 0.824 > 0.1 (우연 가능성) (x1) |
...
- **전체 19개 균등배분**: -2.43% -> $9,757
- **PASS 1개 균등배분**: +6.54% -> $10,654
- **Top 5 균등배분**: +3.20% -> $10,320
...
_Generated: 2026-07-03T15:42:01.977439Z_
_Symbol: ETH/USDT_
...
| 4 | `price_cluster` | -1.55% | -0.93 | 33.3% | 1.00 | 22 | 8.3% | 1/8 | FAIL |
...
| 4 | `lob_maker` | 49.8 | p83 | -0.90 | 1.82 | 0.92 | 58 | 15.6% | 0/8 | FAIL |
| 5 | `cmf` | 47.4 | p77 | -1.14 | 1.40 | 0.85 | 46 | 11.8% | 0/8 | FAIL |
| 6 | `order_flow_imbalance_v2` | 46.7 | p72 | -1.02 | 2.50 | 0.94 | 55 | 14.5% | 0/8 | FAIL |
| 7 | `price_cluster` | 44.9 | p66 | -0.93 | 2.85 | 1.00 | 22 | 8.3% | 1/8 | FAIL |
...
| `price_cluster` | -1.55% | -0.93 | 1.00 | 22 | 1/8 | FAIL |
...
| `price_cluster` | sharpe -1.12 < 1.0 (x1), profit_factor 0.73 < 1.5 (x1), mc_p_value 0.680 > 0.1 (우연 가능성) (x1) |
...
_Generated: 2026-07-03T15:47:33.370239Z_
_Symbol: SOL/USDT_
...
| 6 | `price_cluster` | -2.43% | -0.80 | 35.1% | 0.93 | 22 | 6.9% | 0/8 | FAIL |
...
| 9 | `price_cluster` | 33.7 | p55 | -0.80 | 1.81 | 0.93 | 22 | 6.9% | 0/8 | FAIL |
...
| `price_cluster` | -2.43% | -0.80 | 0.93 | 22 | 0/8 | FAIL |
...
| `price_cluster` | sharpe 0.14 < 1.0 (x1), profit_factor 1.03 < 1.5 (x1), mc_p_value 0.463 > 0.1 (우연 가능성) (x1) |
