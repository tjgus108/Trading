...
_Generated: 2026-06-27T00:15:56.158906Z_
...
_Generated: 2026-06-27T00:21:59.841143Z_
_Symbol: BTC/USDT_
...
|---|------|-----------|-----------|-------|-------|-----------|--------|-------------|------|
| 1 | `roc_ma_cross` | +2.86% | 0.34 | 36.2% | 1.22 | 36 | 8.1% | 2/8 | FAIL |
| 2 | `dema_cross` | +1.74% | 0.37 | 37.5% | 1.26 | 31 | 7.5% | 2/8 | FAIL |
...
| 6 | `narrow_range` | -2.27% | -0.51 | 33.5% | 0.97 | 46 | 10.1% | 0/8 | FAIL |
| 7 | `acceleration_band` | -3.18% | -0.94 | 32.0% | 0.98 | 44 | 13.0% | 1/8 | FAIL |
| 8 | `volume_breakout` | -3.33% | -0.74 | 32.5% | 0.96 | 72 | 15.4% | 0/8 | FAIL |
| 9 | `momentum_quality` | -3.34% | -1.19 | 31.5% | 0.96 | 71 | 15.8% | 1/8 | FAIL |
| 10 | `order_flow_imbalance_v2` | -3.82% | -0.77 | 33.2% | 0.95 | 67 | 15.0% | 0/8 | FAIL |
...
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `roc_ma_cross` | 70.0 | p100 | 0.34 | 2.44 | 1.22 | 36 | 8.1% | 2/8 | FAIL |
| 2 | `dema_cross` | 69.8 | p94 | 0.37 | 2.32 | 1.26 | 31 | 7.5% | 2/8 | FAIL |
| 3 | `frama` | 63.8 | p88 | 0.24 | 1.60 | 1.12 | 40 | 9.4% | 1/8 | FAIL |
| 4 | `lob_maker` | 59.2 | p83 | -0.04 | 1.99 | 1.05 | 75 | 17.0% | 0/8 | FAIL |
| 5 | `positional_scaling` | 51.1 | p77 | -0.38 | 2.82 | 1.09 | 34 | 9.2% | 1/8 | FAIL |
| 6 | `volume_breakout` | 50.0 | p72 | -0.74 | 2.18 | 0.96 | 72 | 15.4% | 0/8 | FAIL |
| 7 | `narrow_range` | 49.0 | p66 | -0.51 | 1.48 | 0.97 | 46 | 10.1% | 0/8 | FAIL |
| 8 | `order_flow_imbalance_v2` | 48.5 | p61 | -0.77 | 2.05 | 0.95 | 67 | 15.0% | 0/8 | FAIL |
| 9 | `price_action_momentum` | 48.1 | p55 | -1.08 | 2.79 | 0.97 | 73 | 16.7% | 1/8 | FAIL |
| 10 | `relative_volume` | 47.7 | p50 | -0.99 | 1.72 | 0.92 | 64 | 13.2% | 0/8 | FAIL |
| 11 | `momentum_quality` | 45.3 | p44 | -1.19 | 3.29 | 0.96 | 71 | 15.8% | 1/8 | FAIL |
| 12 | `htf_ema` | 44.2 | p38 | -0.72 | 0.71 | 0.91 | 43 | 11.2% | 0/8 | FAIL |
| 13 | `acceleration_band` | 43.9 | p33 | -0.94 | 2.58 | 0.98 | 44 | 13.0% | 1/8 | FAIL |
| 14 | `cmf` | 42.7 | p27 | -1.23 | 1.29 | 0.88 | 68 | 16.3% | 0/8 | FAIL |
| 15 | `price_cluster` | 40.5 | p22 | -0.84 | 2.25 | 0.95 | 45 | 12.7% | 0/8 | FAIL |
...
| `dema_cross` | +1.74% | 0.37 | 1.26 | 31 | 2/8 | FAIL |
...
| `price_cluster` | -3.83% | -0.84 | 0.95 | 45 | 0/8 | FAIL |
...
| `dema_cross` | sharpe -0.14 < 1.0 (x1), profit_factor 0.99 < 1.5 (x1), mc_p_value 0.482 > 0.1 (우연 가능성) (x1) |
...
| `price_cluster` | profit_factor 1.13 < 1.5 (x2), sharpe -3.01 < 1.0 (x1), profit_factor 0.63 < 1.5 (x1) |
...
- **전체 19개 균등배분**: -3.14% -> $9,686
- **Top 5 균등배분**: +1.32% -> $10,132
...
_Generated: 2026-06-27T00:27:24.775569Z_
_Symbol: ETH/USDT_
...
| 3 | `order_flow_imbalance_v2` | -4.32% | -1.02 | 33.8% | 0.94 | 55 | 14.5% | 0/8 | FAIL |
| 4 | `acceleration_band` | -4.40% | -2.03 | 25.1% | 0.57 | 13 | 6.0% | 0/8 | FAIL |
| 5 | `volume_breakout` | -4.47% | -0.87 | 34.4% | 0.91 | 61 | 12.5% | 0/8 | FAIL |
| 6 | `lob_maker` | -5.02% | -0.90 | 33.6% | 0.92 | 58 | 15.6% | 0/8 | FAIL |
| 7 | `cmf` | -5.13% | -1.14 | 31.4% | 0.85 | 46 | 11.8% | 0/8 | FAIL |
| 8 | `volatility_cluster` | -5.39% | -1.49 | 33.3% | 0.81 | 42 | 9.4% | 0/8 | FAIL |
| 9 | `dema_cross` | -5.67% | -2.07 | 28.0% | 0.69 | 27 | 8.4% | 0/8 | FAIL |
| 10 | `linear_channel_rev` | -5.71% | -2.33 | 28.3% | 0.60 | 23 | 7.9% | 0/8 | FAIL |
...
| Rank | Name | Score | Pctl | AvgSharpe | SharpeStd | AvgPF | AvgTrades | AvgMDD | Consist | Pass |
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `engulfing_zone` | 68.1 | p100 | 0.44 | 2.56 | 1.30 | 24 | 7.0% | 2/8 | FAIL |
| 2 | `frama` | 67.4 | p94 | 0.51 | 1.55 | 1.18 | 33 | 8.4% | 1/8 | FAIL |
| 3 | `volume_breakout` | 57.1 | p88 | -0.87 | 1.49 | 0.91 | 61 | 12.5% | 0/8 | FAIL |
| 4 | `lob_maker` | 48.9 | p83 | -0.90 | 1.82 | 0.92 | 58 | 15.6% | 0/8 | FAIL |
| 5 | `cmf` | 47.4 | p77 | -1.14 | 1.40 | 0.85 | 46 | 11.8% | 0/8 | FAIL |
| 6 | `order_flow_imbalance_v2` | 45.6 | p72 | -1.02 | 2.50 | 0.94 | 55 | 14.5% | 0/8 | FAIL |
| 7 | `volatility_cluster` | 44.5 | p66 | -1.49 | 1.44 | 0.81 | 42 | 9.4% | 0/8 | FAIL |
| 8 | `relative_volume` | 43.5 | p61 | -1.53 | 2.34 | 0.87 | 54 | 12.7% | 0/8 | FAIL |
| 9 | `elder_impulse` | 40.1 | p55 | -1.60 | 0.86 | 0.76 | 36 | 10.7% | 0/8 | FAIL |
| 10 | `momentum_quality` | 39.6 | p50 | -2.48 | 0.88 | 0.71 | 58 | 14.5% | 0/8 | FAIL |
| 11 | `price_action_momentum` | 35.4 | p44 | -2.32 | 1.51 | 0.71 | 48 | 12.6% | 0/8 | FAIL |
| 12 | `price_cluster` | 30.5 | p38 | -1.93 | 1.83 | 0.75 | 32 | 12.3% | 0/8 | FAIL |
| 13 | `dema_cross` | 29.2 | p33 | -2.07 | 1.58 | 0.69 | 27 | 8.4% | 0/8 | FAIL |
| 14 | `linear_channel_rev` | 24.2 | p27 | -2.33 | 1.19 | 0.60 | 23 | 7.9% | 0/8 | FAIL |
| 15 | `htf_ema` | 21.4 | p22 | -2.83 | 0.81 | 0.56 | 29 | 12.1% | 0/8 | FAIL |
...
| `dema_cross` | -5.67% | -2.07 | 0.69 | 27 | 0/8 | FAIL |
...
| `price_cluster` | -7.48% | -1.93 | 0.75 | 32 | 0/8 | FAIL |
...
| `dema_cross` | profit_factor 0.57 < 1.5 (x2), sharpe 0.69 < 1.0 (x1), profit_factor 1.18 < 1.5 (x1) |
...
| `price_cluster` | sharpe -1.38 < 1.0 (x1), profit_factor 0.77 < 1.5 (x1), mc_p_value 0.745 > 0.1 (우연 가능성) (x1) |
...
- **전체 19개 균등배분**: -6.12% -> $9,388
- **Top 5 균등배분**: -1.37% -> $9,863
...
_Generated: 2026-06-27T00:32:26.296452Z_
_Symbol: SOL/USDT_
...
| 4 | `relative_volume` | -2.03% | -0.61 | 34.2% | 0.97 | 50 | 10.7% | 0/8 | FAIL |
| 5 | `price_cluster` | -2.41% | -0.74 | 33.4% | 0.94 | 32 | 9.6% | 0/8 | FAIL |
...
| 10 | `linear_channel_rev` | -5.34% | -2.40 | 25.4% | 0.61 | 24 | 7.5% | 0/8 | FAIL |
...
| Rank | Name | Score | Pctl | AvgSharpe | SharpeStd | AvgPF | AvgTrades | AvgMDD | Consist | Pass |
|------|------|-------|------|-----------|-----------|-------|-----------|--------|---------|------|
| 1 | `engulfing_zone` | 71.5 | p100 | 0.78 | 2.10 | 1.33 | 26 | 7.0% | 1/8 | FAIL |
| 2 | `volatility_cluster` | 57.5 | p94 | -0.12 | 1.16 | 1.02 | 41 | 8.7% | 0/8 | FAIL |
| 3 | `lob_maker` | 53.5 | p88 | -0.73 | 0.95 | 0.90 | 56 | 13.0% | 0/8 | FAIL |
| 4 | `momentum_quality` | 52.7 | p83 | -1.18 | 0.96 | 0.85 | 56 | 10.5% | 0/8 | FAIL |
| 5 | `relative_volume` | 52.4 | p77 | -0.61 | 2.05 | 0.97 | 50 | 10.7% | 0/8 | FAIL |
| 6 | `order_flow_imbalance_v2` | 50.2 | p72 | -1.22 | 0.78 | 0.84 | 55 | 12.0% | 0/8 | FAIL |
| 7 | `cmf` | 45.1 | p66 | -1.28 | 0.94 | 0.82 | 44 | 10.3% | 0/8 | FAIL |
| 8 | `volume_breakout` | 44.5 | p61 | -1.45 | 1.33 | 0.82 | 58 | 14.2% | 0/8 | FAIL |
| 9 | `price_cluster` | 43.4 | p55 | -0.74 | 2.08 | 0.94 | 32 | 9.6% | 0/8 | FAIL |
| 10 | `elder_impulse` | 39.9 | p50 | -1.91 | 3.14 | 0.82 | 36 | 11.6% | 1/8 | FAIL |
| 11 | `positional_scaling` | 39.2 | p44 | -1.12 | 2.17 | 0.87 | 32 | 8.8% | 0/8 | FAIL |
| 12 | `price_action_momentum` | 38.5 | p38 | -1.88 | 0.97 | 0.75 | 47 | 12.3% | 0/8 | FAIL |
| 13 | `acceleration_band` | 35.0 | p33 | -0.80 | 1.82 | 1.00 | 11 | 4.7% | 0/8 | FAIL |
| 14 | `htf_ema` | 34.7 | p27 | -1.45 | 1.94 | 0.80 | 30 | 9.0% | 0/8 | FAIL |
| 15 | `frama` | 32.6 | p22 | -1.94 | 1.83 | 0.74 | 42 | 12.6% | 0/8 | FAIL |
...
| `price_cluster` | -2.41% | -0.74 | 0.94 | 32 | 0/8 | FAIL |
...
| `dema_cross` | -6.74% | -2.27 | 0.67 | 32 | 0/8 | FAIL |
...
| `roc_ma_cross` | -10.34% | -3.60 | 0.49 | 33 | 0/8 | FAIL |
...
| `price_cluster` | sharpe -0.67 < 1.0 (x1), profit_factor 0.87 < 1.5 (x1), mc_p_value 0.600 > 0.1 (우연 가능성) (x1) |
...
| `dema_cross` | sharpe -2.49 < 1.0 (x1), profit_factor 0.65 < 1.5 (x1), mc_p_value 0.869 > 0.1 (우연 가능성) (x1) |
...
| `roc_ma_cross` | profit_factor 0.48 < 1.5 (x2), mc_p_value 0.973 > 0.1 (우연 가능성) (x2), sharpe -3.14 < 1.0 (x1) |
...
| profit_factor 0.52 < 1.5 | 4 |
| profit_factor 0.87 < 1.5 | 4 |
| profit_factor 0.48 < 1.5 | 4 |
...
| `roc_ma_cross` | 0 | 144 | 117 | 44.8% |

## 포트폴리오 가상 배분

- **전체 19개 균등배분**: -4.72% -> $9,528
- **Top 5 균등배분**: -0.34% -> $9,966
