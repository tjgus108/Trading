...
_Generated: 2026-06-04T20:32:13.582940Z_
...
_Generated: 2026-06-04T20:40:46.798279Z_
_Symbol: BTC/USDT_
...
| 13 | `acceleration_band` | 45.1 | p42 | -0.87 | 2.19 | 0.97 | 45 | 14.5% | 0/8 | FAIL |
| 14 | `cmf` | 43.0 | p38 | -1.36 | 1.76 | 0.86 | 57 | 14.0% | 0/8 | FAIL |
...
| `wick_reversal` | -5.06% | -1.65 | 0.82 | 26 | 0/8 | FAIL |
| `engulfing_zone` | -5.44% | -1.38 | 0.81 | 25 | 0/8 | FAIL |
| `cmf` | -6.95% | -1.36 | 0.86 | 57 | 0/8 | FAIL |
...
| `wick_reversal` | profit_factor 0.36 < 1.5 (x2), sharpe -1.66 < 1.0 (x1), profit_factor 0.70 < 1.5 (x1) |
| `engulfing_zone` | mc_p_value 0.876 > 0.05 (우연 가능성) (x2), sharpe -2.23 < 1.0 (x1), profit_factor 0.65 < 1.5 (x1) |
| `cmf` | sharpe 0.18 < 1.0 (x1), profit_factor 1.05 < 1.5 (x1), mc_p_value 0.409 > 0.05 (우연 가능성) (x1) |
...
_Generated: 2026-06-04T20:49:35.159495Z_
_Symbol: ETH/USDT_
...
| 4 | `cmf` | +0.97% | 0.13 | 37.0% | 1.09 | 45 | 9.0% | 0/8 | FAIL |
| 5 | `price_action_momentum` | +0.85% | 0.20 | 42.8% | 1.08 | 51 | 10.8% | 0/8 | FAIL |
| 6 | `narrow_range` | +0.10% | 0.01 | 42.0% | 1.06 | 51 | 10.9% | 0/8 | FAIL |
| 7 | `wick_reversal` | +0.00% | 0.00 | 0.0% | 0.00 | 0 | 0.0% | 0/8 | FAIL |
| 8 | `engulfing_zone` | -2.17% | -1.30 | 37.7% | 0.98 | 27 | 10.2% | 1/8 | FAIL |
| 9 | `linear_channel_rev` | -3.48% | -1.08 | 36.0% | 0.81 | 28 | 6.8% | 0/8 | FAIL |
| 10 | `roc_ma_cross` | -3.92% | -1.02 | 38.6% | 0.85 | 34 | 9.7% | 0/8 | FAIL |
...
| 6 | `cmf` | 54.6 | p76 | 0.13 | 1.79 | 1.09 | 45 | 9.0% | 0/8 | FAIL |
| 7 | `engulfing_zone` | 45.5 | p71 | -1.30 | 3.43 | 0.98 | 27 | 10.2% | 1/8 | FAIL |
...
| `cmf` | +0.97% | 0.13 | 1.09 | 45 | 0/8 | FAIL |
...
| `cmf` | sharpe -1.77 < 1.0 (x1), profit_factor 0.76 < 1.5 (x1), mc_p_value 0.790 > 0.05 (우연 가능성) (x1) |
...
- **전체 22개 균등배분**: -5.41% -> $9,459
- **Top 5 균등배분**: +1.73% -> $10,173
...
_Generated: 2026-06-04T20:57:57.400354Z_
_Symbol: SOL/USDT_
...
| `cmf` | -7.85% | -2.06 | 0.72 | 42 | 0/8 | FAIL |
...
| `cmf` | profit_factor 0.49 < 1.5 (x2), sharpe -4.17 < 1.0 (x1), mc_p_value 0.978 > 0.05 (우연 가능성) (x1) |
