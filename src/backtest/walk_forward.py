...
DEFAULT_GRIDS: Dict[str, dict] = {
    ...
    # vol_atr_trend_min: 1.3 역효과(Cycle301 D), 1.5~2.0 범위 탐색
    # Cycle304 D(ML): close_window [40,50] → [50,60] 업데이트
    #   close_window=40 역효과 확인(Cycle303 C, Sharpe -61%) → 40 제거, 60 추가
    #   50이 cluster 안정성 최적, 60은 더 긴 price memory 탐색
    "price_cluster": {
